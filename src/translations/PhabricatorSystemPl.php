...
final class PhabricatorSystemPl
  ...
  protected function getTranslations() {
    return array(
  'An Administrator has placed this server into read-only mode.' => 'Administrator przełączył ten serwer w tryb tylko do odczytu.',
...
' => 'Niszczenie %s **%s**...',
  ...
  'This server is currently configured with no writable ("master") database, so it can not write new information anywhere. This server will run in read-only mode until an administrator reconfigures it with a writable database.' => 'Ten serwer jest obecnie skonfigurowany bez zapisywalnej bazy danych ("master"), więc nie może nigdzie zapisywać nowych informacji. Ten serwer będzie działał w trybie tylko do odczytu, dopóki administrator nie skonfiguruje go ponownie z bazą danych otwartą do zapisu.',
  '%d / minute' => '%d / min',
