...
A takaice:! N!
 ...
 Littafin \'classes\' (kamar\'/hanyar/zuwa/misali/PHPExcel/Class\').',
  ...
  'February' => 'Fabrairu',
  'No permission to run "SHOW REPLICA STATUS". Grant this user "REPLICATION CLIENT" permission to allow this server to monitor replica health.' => 'Babu izini don gudanar da "NUNA MATSAYIN BAYI". Ba wa wannan mai amfani "CIN KWALLIYA" izini don ba da damar wannan uwar garken don saka idanu akan lafiyar kwafi.',
