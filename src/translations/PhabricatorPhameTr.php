...
final class PhabricatorPhameTr
  ...
  'Search for blogs with given statuses.' => '',
  'Blog full domain URI.' => 'Tam alan adı URI\'si.',
  ...
  'Search for posts with specific visibility.' => '',
  ...
  'Domain must be unique; another blog already has this domain.' => 'Alan adı benzersiz olmalıdır; başka bir blogda zaten bu alan adı var.',
  ...
  'Post' => 'Gönder',
  'inherit from blog' => 'blogdan devral',
  ...
  'Edit Locked Post' => 'Kilitli Gönderiyi Düzenle',
  ...
  'For custom domains to work, this server must be configured to allow the public access policy. Configure this setting %s, or ask an administrator to configure this setting. The domain can be specified later once this setting has been changed.' => 'Özel alan adlarının çalışabilmesi için, bu sunucunun genel erişim politikasına izin verecek şekilde yapılandırılması gerekir. Bu ayarı %s olarak yapılandırın veya bir yöneticiden bu ayarı yapılandırmasını isteyin. Alan adı, bu ayar değiştirildikten sonra daha sonra belirtilebilir.',
