...
final class PhabricatorOwnersFrFR
  ...
  '%s adjusted package authority rules from %s to %s.' => '%s a ajusté les règles d\'autorité du paquet de %s à %s .',
  ...
  'No active Herald rules add this package as an auditor, reviewer, or subscriber.' => 'Aucune règle Herald active n’ajoute ce paquet en tant qu’auditeur, relecteur ou abonné.',
  ...
  'Overwrite existing package paths with new paths.' => 'Écrase les chemins existants de paquets avec de nouveaux chemins.',
  'Strong' => 'Fort',
...
En général, vous appellerez d\'abord `owners.search` pour obtenir une liste des chemins actuels (qui sont fournis dans le même format), apporterez des modifications, puis les mettrez à jour en appliquant une transaction de ce type.',
  ...
  'Active Packages' => 'Paquets actifs',
  'Exclude' => 'Exclure',
