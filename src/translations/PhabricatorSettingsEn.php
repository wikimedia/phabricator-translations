...
final class PhabricatorSettingsEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Unlink' => 'Unlink',
      'If you have difficulty reading the UI, this setting may help.' => 'If you have difficulty reading the UI, this setting may help.',
    ...
    //You will still receive some administrative email, like password reset email.//' => 'If you disable **Email Notifications**, this server will never send email to notify you about events. This preference overrides all your other settings.
    ...
    This can make mail more useful, but some clients have difficulty threading these messages. Disabling this option may improve threading at the cost of making subject lines less useful.',
      ...
      'If you change your primary address, %s will send all email to %s.' => 'If you change your primary address, %s will send all email to %s.',
      ...
      'DarkConsole is a debugging console for developing and troubleshooting applications. After enabling DarkConsole, press the {nav `} key on your keyboard to toggle it on or off.' => 'DarkConsole is a debugging console for developing and troubleshooting applications. After enabling DarkConsole, press the {nav `} key on your keyboard to toggle it on or off.',
      ...
      'Refresh' => 'Refresh',
      'No allowed editor protocols are configured.' => 'No allowed editor protocols are configured.',
      ...
      'Choose which language you would like the UI to use.' => 'Choose which language you would like the UI to use.',
    ...
    body content can route messages.' => 'Outgoing mail is stamped with labels like `actor(alice)` which can be used to
    write client mail rules to organize mail. By default, these stamps are sent
    in an `X-Phabricator-Stamps` header.
    If you use a client which can not use headers to route mail (like Gmail),
    you can also include the stamps in the message body so mail rules based on
    body content can route messages.',
      'Your browser timezone (%s) differs from your profile timezone (%s). You can adjust your profile setting to match your browser, or ignore this conflict to keep your current profile setting.' => 'Your browser timezone (%s) differs from your profile timezone (%s). You can adjust your profile setting to match your browser, or ignore this conflict to keep your current profile setting.',
      ...
      'Ignore new setting and keep %s' => 'Ignore new setting and keep %s',
      'If you disable **Self Actions**, this server will not notify you about actions you take.' => 'If you disable **Self Actions**, this server will not notify you about actions you take.',
      ...
      'Your browser has not yet granted this server permission to send desktop notifications.' => 'Your browser has not yet granted this server permission to send desktop notifications.',
    ...
    These preferences **only** apply to objects you are connected to (for example, Revisions where you are a reviewer or tasks you are CC\'d on). To receive email alerts when other objects are created, configure [[ /herald/ | Herald Rules ]].',
      ...
      'You can opt to receive plain text email instead of HTML email. Plain text email works better with some clients.' => 'You can opt to receive plain text email instead of HTML email. Plain text email works better with some clients.',
      ...
      'NOTE: You already have an Auth Factor configured. Adding another factor will require you to always provide all Auth Factors instead of selecting one of your Auth Factors.' => 'NOTE: You already have an Auth Factor configured. Adding another factor will require you to always provide all Auth Factors instead of selecting one of your Auth Factors.',
      'Personal Settings' => 'Personal Settings',
      'Some applications use unicode glyphs in page titles to provide a compact representation of the current application. You can substitute plain text instead if these glyphs do not display on your system.' => 'Some applications use unicode glyphs in page titles to provide a compact representation of the current application. You can substitute plain text instead if these glyphs do not display on your system.',
      'Web Only' => 'Web Only',
      ...
      'Your browser has granted this server permission to send desktop notifications.' => 'Your browser has granted this server permission to send desktop notifications.',
    ...
    See the tables below for a list of supported variables and protocols.' => 'Many text editors can be configured as URI handlers for special protocols like `editor://`. If you have installed and configured such an editor, some applications can generate links that you can click to open files locally.
    Provide a URI pattern for building external editor URIs in your environment. For example, if you use TextMate on macOS, the pattern for your machine may look something like this:
    ```name="Example: TextMate on macOS"
    %s
    ```
    ...
    See the tables below for a list of supported variables and protocols.',
      ...
      'This server can send real-time notifications to your web browser or to your desktop. Select where you want to receive these real-time updates.' => 'This server can send real-time notifications to your web browser or to your desktop. Select where you want to receive these real-time updates.',
