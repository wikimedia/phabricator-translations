...
final class TranslatewikiCoreRu
  ...
  'Greek' => 'Греческий',
  'Tarantino' => 'Тарантино',
  'Asturian' => 'Астурийский язык',
  'Belarusian (Belarus)' => 'Беларуский (Беларусь)',
  'Read %s string(s).' => 'Прочесть строку(и) %s',
  'Serbian (Cyrillic script)' => 'Сербский (кириллица)',
  ...
  'Done.' => 'Готово.',
  'Saraiki (Arabic Script)' => 'Сараики (арабское письмо)',
  'PLURAL' => 'МНОЖЕСТВО',
);
  }
