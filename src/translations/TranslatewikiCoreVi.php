...
final class TranslatewikiCoreVi
  ...
  'Dutch' => 'Tiếng Hà Lan',
  'Provide a project name to export strings under with "--as".' => 'Cung cấp tên dự án để xuất chuỗi theo "--as".',
  'Raw strings' => 'Chuỗi thô',
  'Sicilian' => 'Tiếng Sicilia',
  ...
  'Provide a classname with "--class".' => 'Cung cấp tên lớp với "--class".',
  ...
  'Japanese' => 'Tiếng Nhật',
  'Export translation strings from a libphutil library.' => 'Xuất chuỗi bản dịch từ thư viện libphutil.',
  'Danish' => 'Tiếng Đan Mạch',
  'Turkish' => 'Tiếng Thổ Nhĩ Kỳ',
  'Writing data (%s, %s) to "%s"...' => 'Đang dữ liệu (%s, %s) vào "%s"...',
  'Used in:' => 'Được sử dụng trong',
  'English strings' => 'Chuỗi tiếng Anh',
  'Polish' => 'Tiếng Ba Lan',
  'Done.' => 'Xong.',
