...
final class PhabricatorMetaPtBR
  ...
  protected function getTranslations() {
    return array(
  'Completely Break Everything' => 'Quebrar completamente o phabricator',
...
```',
  'Show Enabled Applications' => 'Mostrar aplicativos instalados',
  'Can\'t set non-public capabilities to public.' => 'Não é possível definir políticas não públicas para público.',
  'Launchable' => 'Executável',
  'You cannot enable an enabled application.' => 'Você não pode instalar um aplicativo instalado.',
  'Save Policies' => 'Salvar políticas',
  'Browse Applications' => 'Procurar aplicativos',
  'To manage prototypes, enable them by setting %s in your configuration.' => 'Para gerenciar protótipos, ative-os definindo %s em sua configuração do Phabricator.',
  'Prototype' => 'Protótipo',
  'Edit Policies: %s' => 'Editar políticas: %s',
  'Really Disable Application?' => 'Desinstalar realmente o aplicativo?',
  'Create New Application' => 'Criar novo aplicativo',
  'Extension' => 'Extensão',
  'Validation Failed' => 'Falha ao validar',
  'Really disable the %s application?' => 'Desinstalar realmente o aplicativo de %s?',
  ...
  'This is very unusual and will leave you without any content on the home page. You should only do this if you are certain you know what you are doing.' => 'Isso é muito incomum e o deixará sem conteúdo na home page do Phabricator. Você só deve fazer isso se tiver certeza de que sabe o que está fazendo.',
  'Show Disabled Applications' => 'Mostrar aplicativos desinstalados',
  ...
  'This application is required and cannot be disabled.' => 'Este aplicativo não pode ser desinstalado porque é necessário que o Phabricator funcione.',
  ...
  'Are you absolutely certain you want to disable the Home application?' => 'Tem certeza absoluta de que deseja desinstalar o aplicativo Home?',
