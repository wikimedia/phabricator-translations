...
final class PhabricatorTransactionsKoKR
  ...
  'You can not select this %s policy, because you would no longer be able to %s the object.' => '더 이상 오브젝트를 %2$s할 수 없기 때문에 %s 정책을 선택할 수 없습니다.',
  ...
  '%s added %d subscriber(s): %s.' => '%s님이 구독자 %d명을 추가했습니다: %s.',
  'Engine: Edit' => '엔진: 편집',
  ...
  '%s added %s contributor(s) for %s: %s.' => '%s님이 %3$s에 대해 기여자 %s명을 추가했습니다: %4$s.',
