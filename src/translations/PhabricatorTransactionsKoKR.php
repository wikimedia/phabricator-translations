...
final class PhabricatorTransactionsKoKR
  ...
  '%s changed the edit policy to "%s".' => '%s님이 편집 정책을 "%s"(으)로 변경했습니다.',
...
이 양식은 다음 필드를 지원합니다:',
  ...
  '%s changed the visibility to "%s".' => '%s님이 표시 여부를 "%s"(으)로 변경했습니다.',
...
`template`을 사용하는 경우 다음 필드가 복사됩니다.',
  ...
  'Find out what to do instead' => '대신 무엇을 해야 할지 알아보세요',
  'Mark as "Create" Form' => '"생성" 양식으로 표시',
