...
final class PhabricatorSystemPtBR
  ...
  protected function getTranslations() {
    return array(
      'An Administrator has placed this server into read-only mode.' => 'Um administrador colocou o Phabricator no modo somente leitura.',
      ...
      'Destroying %s **%s**...
    ' => 'Destruindo %s **%s**...',
      'This server has consistently been unable to reach the writable ("master") database while processing recent requests.' => 'O Phabricator tem sido consistentemente incapaz de atingir o banco de dados gravável ("master") ao processar solicitações recentes.',
      ...
      'This server was unable to connect to the writable ("master") database while handling this request, and automatically degraded into read-only mode.' => 'O Phabricator não pôde se conectar ao banco de dados gravável ("master") ao manipular essa solicitação e se degradou automaticamente no modo somente leitura.',
