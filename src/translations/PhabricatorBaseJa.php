...
final class PhabricatorBaseJa
  ...
  protected function getTranslations() {
    return array(
      ...
      'This application is required, so all users must have access to it.' => 'このアプリケーションはPhabricatorが動作するために必要です。したがって、すべてのユーザーはPhabricatorにアクセスする必要があります。',
      ...
      'Email Verification Required, With Exception' => 'メールによる認証が必要。例外あり',
