...
final class PhabricatorMetaPtBr
  ...
  protected function getTranslations() {
    return array(
      ...
      '%s changed the "%s" policy from "%s" to "%s".' => '%s mudou a política "%s" de "%s" para "%s".',
      'Extension' => 'Extensão',
    ...
    ```',
      ...
      '%s changed the "%s" policy for application %s from "%s" to "%s".' => '%s alterou a política "%s" para aplicativo %s de "%s" para "%s".',
