...
final class PhabricatorAuthFrFR
  ...
  protected function getTranslations() {
    ...
    En général, vous ne devriez utiliser cette option que dans un environnement de développement où ssh-keygen ne fonctionne pas et où il est difficile de le réparer, et seulement si vous êtes certain d’en comprendre les risques. Vous ne devez jamais mettre en cache un fichier PKCS8 que vous n’avez pas généré vous-même.',
      ...
      'Specify an OAuth client id with %s.' => 'Spécifier un ID de client OAuth avec %s.',
    ...
    Après avoir achevé la configuration, copiez la **Clé** et le **Secret** dans les champs ci-dessus.',
      ...
      'The email address associated with this external account ("%s") is not a valid email address and can not be used to register a Phabricator account. Choose a different, valid address.' => 'L’adresse de courriel associée avec ce compte externe (« %s ») n’est pas une adresse de messagerie valide et ne peut pas être utilisée pour enregistrer un compte Phabricator. Choisir une adresse différente valide.',
      ...
      'Phabricator base URI should include protocol (like "%s").' => 'L’URI de base de Phabricator doit inclure le protocole (tel que « %s »).',
    ...
    Pour les installations sans activation de l’authentification du mot de passe, les utilisateurs accèdent à ce processus en utilisant le lien «  Envoyer un lien de connexion à votre adresse de messagerie. » sur l’écran de connexion. Ce processus permet aux utilisateurs de récupérer l’accès à leur compte s’il y a un problème avec un service de connexion externe.',
      ...
      'Phabricator already does not trust OAuth client "%s".' => 'Phabricator ne fait pas encore confiance au client OAuth « %s ».',
    ...
    **Configurer votre application**: Trouver l’application que vous venez de créer dans le tableau, et vliquer sur le lien **Configurer** sous **Actions**. Sélectionner **Authentification entrante** et cliquer sur l’onglet **OAuth** (il devrait être sélectionné par défaut). Puis utiliser ces paramètres :
    ...
    Après avoir terminé al configuration, copier le **Client ID** et le **Client Secret** dans les champs ci-dessus (vous devrez générer le secret du client en cliquant d’abord sur \'Nouveau Secret\').',
      ...
      'This private key requires a passphrase, but the wrong passphrase was provided. Check that you supplied the correct key and passphrase.' => 'Cette clé privée exige une phrase de passe, mais la mauvaise phrase de passe a été fournie. Vérifiez que vous avez fourni la clé et la phrase de passe correctes.',
    ...
    Une fois la configuration achevée, copier la **Clé du consommateur** et le **Secret du consommateur** dans les champs ci-dessus.',
      ...
      'This private key could not be opened. This might mean that the key requires a passphrase, or might mean that the key is not formatted correctly. Check that you have supplied the complete text of a valid private key and the correct passphrase.' => 'Cette clé privée ne peut pas être ouverte. Ceci pourrait signifier que la clé nécessite une phrase de passe ou que la clé n’est pas correctement formatée. Vérifiez que vous avez fourni le texte complet de la clé privée et la phrase de passe correcte.',
      ...
      'sn' => 'sn',
      'A passphrase was provided for this private key, but it does not require a passphrase. Check that you supplied the correct key, or omit the passphrase.' => 'Une phrase de passe a été fournie pour cette clé privée, mais elle ne nécessite pas une phrase de passe. Vérifiez que vous avez fourni la clé correcte, ou bien omettez la phrase de passe.',
    ...
    Les jetons temporaires sont utilisés dans le courriel de réinitialisation du mot de passe, le courriel de bienvenue, et par certains autres systèmes comme Git LFS. La révocation des jetons temporaires invalidera les liens existants dans les courriels de réinitialisation du mot de passe et d’invitation qui ont été envoyés avant que la révocation se soit produite.',
      ...
      'This private key requires a passphrase, but no passphrase was provided. Check that you supplied the correct key, or provide the passphrase.' => 'La clé privée exige une phrase de passe, mais aucune n’a été fournie. Vérifiez que vous avez fourni la clé correcte, ou bien fournissez la phrase de passe.',
    ...
    Erreur LDAP nº %s : %s',
      ...
      'This private key could not be opened with the provided passphrase. This might mean that the passphrase is wrong or that the key is not formatted correctly. Check that you have supplied the complete text of a valid private key and the correct passphrase.' => 'Cette clé privée ne peut pas être ouverte. Ceci pourrait signifier que la phrase de passe est incorrecte ou que la clé n’est pas correctement formatée. Vérifiez que vous avez fourni le texte complet de la clé privée et la phrase de passe correcte.',
