...
final class PhabricatorAuthFrFR
  ...
  protected function getTranslations() {
    ...
    Pour les installations sans activation de l’authentification du mot de passe, les utilisateurs accèdent à ce processus en utilisant le lien «  Envoyer un lien de connexion à votre adresse de messagerie. » sur l’écran de connexion. Ce processus permet aux utilisateurs de récupérer l’accès à leur compte s’il y a un problème avec un service de connexion externe.',
      ...
      '%s (%s) MFA Code: %s' => 'Code MFA de Phabricator (%s) : %s',
      ...
      'NOTE: Any user who can browse to this install\'s login page will be able to register an account. To restrict who can register an account, configure [[ %s | %s ]].' => 'NOTE : Tout utilisateur qui peut naviguer jusqu’à cette page de connexion d’installation pourra inscrire un compte Phabricator. Pour restreindre qui peut inscrire un compte, configurer [[ %s | %s ]].',
    ...
    Les clés publiques SSH sont révoquées, pas seulement supprimées. Les utilisateurs devront générer et téléverser de nouvelles clés uniques avant de pouvoir accéder à leurs dépôts ou à d’autres services sur SSH.',
      ...
      'Server name is required.' => 'Le nom de l’instance Phabricator est obligatoire.',
    ...
    Après avoir achevé la configuration, copier le **Client ID** et le **Client Secret** dans les champs ci-dessus.',
      ...
      'Anyone who can browse to this this server will be able to register an account. To add email domain restrictions, configure %s.' => 'Quiconque peut naviguer vers cette installation de Phabricator pourra enregistrer un compte. Pour ajouter des restrictions de domaine de courriel, configurer %s.',
      'Revoked' => 'Révoquée',
