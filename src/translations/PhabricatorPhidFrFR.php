...
final class PhabricatorPhidFrFR
  ...
  '%s class "%s" has an invalid %s property. PHID constants must be a four character uppercase string.' => 'La classe « %2$s » de %s contient une propriété %3$s incorrecte. Les constantes PHID doivent être des chaînes de caractères composées de 4 majuscules.',
