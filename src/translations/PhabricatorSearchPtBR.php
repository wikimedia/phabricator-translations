...
final class PhabricatorSearchPtBR
  ...
  'Use the application-specific Advanced Search for better results and additional search criteria: %s, %s. (%s)' => 'Use a Pesquisa Avançada específica do aplicativo para obter melhores resultados e critérios de pesquisa adicionais: %s, %s, (%s)',
  ...
  'Global Queries' => 'Consultas globais',
  'Link' => 'Link',
  'Enable Query' => 'Ativar consulta',
  ...
  'No results found for this query.' => 'Não foram encontrados resultados para esta pesquisa.',
  'Searched For:' => 'Pesquisado:',
