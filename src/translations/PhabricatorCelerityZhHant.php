...
final class PhabricatorCelerityZhHant
  ...
  'Found %d binary resources.' => '找到%d二進位資源。',
  ...
  'Rebuilding %d resource source(s).' => '重新建置 %d 個資源來源。',
  'Found %d text resources.' => '找到%d文字資源。',
  'Expected file \'%s\' in \'%s\' to be a sprite source ending in \'%s\'.' => '預期於「%2$s」的檔案「%s」為在「%3$s」結尾的 Sprite 來源。',
