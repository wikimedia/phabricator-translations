...
final class PhabricatorSubscriptionsHu
  ...
  'View All %d Subscriber(s)' => 'Összes (%d) feliratkozó megtekintése',
  ...
  'All %d subscribers removed by %s' => 'Összes (%d) feliratkozó eltávolítva %s által',
  ...
  'Declined to resubscribe %s target(s) because they previously unsubscribed: %s.' => array(
    '%s cél nem lett feliratkoztatva, mivel korábban már leiratkozott: %s.',
    '%s cél nem lett feliratkoztatva, mivel korábban már leiratkoztak: %s.',
  ),
  ...
  'All %d subscribers added by %s' => 'Összes (%d) feliratkozó hozzáadva %s által',
  'Add me as a subscriber' => 'Saját magam feliratkoztatása',
  'Mute Notifications' => 'Értesítések elnémítása',
  '%s automatically subscribed target(s) were not affected: %s.' => '%s automatikusan feliratkozott cél nem érintett: %s.',
