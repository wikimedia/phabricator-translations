...
final class TranslatewikiCoreCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'Pass --clean to the underlying extractor to drop caches before extracting strings and do a full clean rebuild. Slow!' => 'Passa --clean a l\'extractor subjacent per deixar anar la memòria cau abans d\'extreure les cadenes i fer una reconstrucció neta completa.  A poc a poc!',
      'Done.' => 'Fet.',
