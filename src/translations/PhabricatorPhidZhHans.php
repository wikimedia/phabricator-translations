...
final class PhabricatorPhidZhHans
  ...
  protected function getTranslations() {
    return array(
      ...
      'Restricted %s' => '受限制的%s',
      'Trying to mutate a %s, but this is not permitted; handle lists are immutable.' => '试图变异%s，但这是不允许的；处理列表是不可变的。',
      ...
      'Attempting to load PHID "%s", but it was not requested by any handle list.' => '试图加载PhiD“%s”，但它不是由任何处理清单要求。',
      ...
      'Look up objects by name.' => '查找对象的名字。',
      ...
      'Replaced by \'phid.query\'.' => '取而代之的\'phid.query\'。',
      ...
      'Can not generate PHID with no type.' => '不会产生PhiD没有类型。',
    );
  }
