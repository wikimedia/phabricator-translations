...
final class PhabricatorNotificationCa
  ...
  protected function getTranslations() {
    ...
    %s',
      ...
      'This server is configured to use a notification server, but is not able to connect to it.' => 'Phabricator està configurat per utilitzar un servidor de notificacions, però no pot connectar-s\'hi.',
