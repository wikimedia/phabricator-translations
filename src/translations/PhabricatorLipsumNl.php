...
final class PhabricatorLipsumNl
  ...
  'OOPS' => 'OEPS',
  'This command generates synthetic test data, including user accounts. It is intended for use in development environments so you can test features more easily. There is no easy way to delete this data or undo the effects of this command. If you run it in a production environment, it will pollute your data with large amounts of meaningless garbage that you can not get rid of.' => 'Deze opdracht maakt synthetische testgegevens aan, waaronder gebruikersaccounts. Het is bedoeld voor gebruik in ontwikkelomgevingen, zodat u functies gemakkelijker kunt testen. Er is geen eenvoudige manier om deze gegevens te verwijderen of de effecten van deze opdracht ongedaan te maken. Als u deze opdracht in een productieomgeving uitvoert, zal uw data vervuild raken met grote hoeveelheden nutteloze rommel die u niet kunt verwijderen.',
