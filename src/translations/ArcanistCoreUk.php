...
final class ArcanistCoreUk
  ...
  protected function getTranslations() {
    return array(
      ...
      'Shortening of %s' => 'Скорочення %s',
      'Should throw on empty input' => 'Має згенерувати помилку, якщо відсутні вхідні дані',
    ...
    Для отримання додаткової інформації див. інструкції в розділі «%s».',
      ...
      'Phage does not target Windows.' => 'Phage не націлений на Windows.',
      'Pick' => 'Виберіть',
      ...
      'Basic Checksums' => 'Основні контрольні суми',
      'Exception raised by unloadable edges.' => 'Виняток піднято незавантаженими краями.',
      '**bookmarks**' => '**закладки**',
      ...
      'Order: Global' => 'Замовлення: глобальне',
      'Expected JSON response from Slack.' => 'Очікувана відповідь JSON від Slack.',
      'The library map is out of date. Rebuild it with `%s`.
    These entries differ: %s.' => 'Мапа бібліотеки застаріла. Оновіть його за допомогою «%s».
    Ці записи відрізняються: %s.',
      ...
      'These tests should either fail or skip.' => 'Ці тести слід або провалити, або пропустити.',
      ...
      'SHELL' => 'ОБОЛОНКА',
      'Set locale to en_GB.' => 'Встановіть мову en_GB.',
    ...
    Використовуйте \'%s\', щоб обрати версію.',
      ...
      'Conversion from ISO-8859-1.' => 'Перетворення з ISO-8859-1.',
    ...
    Використайте \'%s\', щоб вибрати одну з них, або \'%s\', щоб створити нову версію.',
      ...
      'Arg alias \'%s\'.' => 'Виберіть псевдонім «%s».',
    ...
    %s' => '%s: конфігурація захопила групу захоплення \'%s\' під назвою \'%s\'. Вихід сценарію:
     %s',
      ...
      'Argument name \'%s\'.' => 'Назва аргументу «%s».',
    ...
    than the one created by tools like __cat__.' => 'Надійно об\'єднайте два або більше файлів разом. Отримане з’єднання набагато потужніше, ніж з’єднання, створене за допомогою таких інструментів, як __cat__.',
      ...
      'Version' => 'Версія',
      '%s with combining' => '%s з комбінуванням',
      'REVISION' => 'РЕВІЗІЯ',
      ...
      'Lint rendering for "%s".' => 'Візуалізація Lint для "%s".',
      'With Path' => 'З шляхом',
      ...
      'Expected "~~~~~~~~~~" delimiter in test "%s".' => 'Очікуваний роздільник "~~~~~~~~~~" у тесті "%s"',
      ...
      'November' => 'Листопад',
      'Byte Sequences' => 'Послідовності байтів',
      ...
      'Email: %s + %s -> %s' => 'Електронна пошта: %s + %s -> %s',
    ...
    про статус перегляду.',
      ...
      'Order: Project' => 'Замовлення: Проєкт',
    ...
    ' => '    %s (%s) %s',
      ...
      'Console Length of %s' => 'Довжина консолі %s',
      ...
      'Aug' => 'Сер',
      'Thursday' => 'Четвер',
      '%s invalid on %s' => '%s недійсний на %s',
      'Title' => 'Назва',
    ...
    (Технічно: база злиття вибраної версії та HEAD використовується, щоб визначити початок діапазону фіксації.)',
      ...
      'File "%s"' => 'Файл «%s»',
      'Test Case: "%s" vs "%s"' => 'Тестовий приклад: «%s» проти «%s»',
