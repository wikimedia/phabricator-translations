...
Ви не можете перезаписати поведінку вбудованих робочих процесів, включаючи сам "alias", і якщо ви встановите новий робочий процес, він матиме пріоритет над будь-якими існуючими псевдонімами з такою ж назвою.',
  'Arrays should use the short array syntax.' => 'Масиви повинні використовувати синтаксис коротких масивів.',
...
Для отримання додаткової інформації див. інструкції в розділі «%s».',
  ...
  $ %s
' => 'Якщо файл не є текстовим, позначте його як двійковий за допомогою: 
 ...
 $ %s',
  ...
  'You stand in the middle of a small clearing.' => 'Ви стоїте посеред невеличкої галявини.',
...
' => '    **extract-symbols-with-php-parser.php** [__options__] __path.php__
  ...
  'Call to "posix_setsid()" failed!' => 'Виклик "posix_setsid()" не вдався!',
  ...
  'Lint does not currently support %s in SVN.' => 'Lint наразі не підтримує %s у SVN.',
...
Використайте \'%s\', щоб вибрати одну з них, або \'%s\', щоб створити нову версію.',
  ...
  'Working Copy State' => 'Стан Робочої Копії',
...
Вам може знадобитися оновити автозаповнення оболонки, якщо:
 ...
 - ви оновлюєте це програмне забезпечення, і нова версія виправляє помилки автозаповнення оболонки.',
  ...
  'Command-Line Input' => 'Введення з Командного Рядка',
  'NOT REVISION AUTHOR' => 'НЕ АВТОР ВЕРСІЇ',
...
%s' => '%s: конфігурація захопила групу захоплення \'%s\' під назвою \'%s\'. Вихід сценарію:
 %s',
  ...
  'Modified' => 'Змінені',
  'Do you want to edit the message?' => 'Ви хочете відредагувати повідомлення?',
  ...
  'Config: Reading user configuration file "%s"...' => 'Конфігурація: Читання файлу конфігурації користувача "%s"...',
  ...
  'Constants should be uppercase.' => 'Сталі повинні бути написані великими літерами.',
  'Named arguments are not available before PHP 8.0.' => 'Іменовані аргументи недоступні до версії PHP 8.0.',
  ...
  'Workflow has no name!' => 'Робочий процес не має назви!',
  'The "arc anoid" workflow requires "python3" to be available in your $PATH.' => 'Для робочого процесу "arc anoid" потрібно, щоб "python3" був доступний у вашому $PATH.',
  'Argument "%s" conflicts with argument "%s"%s' => 'Аргумент "%s" конфліктує з аргументом "%s"%s',
  'FETCHED' => 'ОТРИМАНО',
  '%s may only write strings!' => '%s може записувати лише рядки!',
  'LOAD STATE' => 'СТАН ЗАВАНТАЖЕННЯ',
  '(Run `%s` for more details.)' => '(Запустіть «%s» для отримання детальнішої інформації.)',
  'Diff URI:' => 'Посилання URI на відмінність між версіями:',
  'MERGE' => 'ОБ\'ЄДНАТИ',
  'Revision %s' => 'Версія %s',
  'Unknown signature method \'%s\'!' => 'Невідомий метод підпису \' %s\'!',
  'Working Copy: Path "%s" is not in any working copy.' => 'Робоча Копія: Шлях "%s" відсутній у всіх робочих копіях.',
  ...
  'rebuild the library map file' => 'відновити файл карти бібліотеки',
  'Bookmark "%s"' => 'Закладка «%s»',
  'Use of Removed Function "each()"' => 'Використання Видаленої Функції "each()"',
  ...
  'Language for the paste.' => 'Мова для вставки.',
  ...
  'CHECKOUT' => 'ПЕРЕВІРЯТИ',
  'There should be no whitespace before the object operator.' => 'Перед оператором об\'єкта не повинно бути пробілів.',
  'Failed to update library: %s' => 'Не вдалося оновити бібліотеку: %s',
  'File Error' => 'Помилка файлу',
  'Avoid the use of inner functions.' => 'Уникайте використання внутрішніх функцій.',
  'None of the configured binaries can be located.' => 'Жоден із налаштованих бінарних файлів не знайдено.',
  'Start rule \'%s\' does not appear in the rules for the grammar. Use %s to choose a different start rule, or add a rule named \'%s\'.' => 'Початкове правило \'%s\' не відображається в правилах граматики. Використайте %s щоб вибрати інше початкове правило, або додайте правило з назвою \'%s\'.',
  'IP address "%s" is not properly formatted. Expected an IPv4 address like "%s".' => 'IP-адреса "%s" має неправильний формат. Очікується IPv4-адреса, на кшталт "%s".',
  ...
  'Install PHPCS with `%s`.' => 'Встановіть PHPCS за допомогою `%s`.',
  'Install Golint using `%s`.' => 'Встановіть Golint за допомогою `%s`.',
  'Command %s failed: %s' => 'Команда %s не вдалася: %s',
  'These %s path(s) will NOT be committed. Commit this revision anyway?' => array(
    'Цей шлях НЕ буде зафіксовано. Зафіксувати цю версію все одно?',
    'Ці шляхи НЕ буде зафіксовано. Зафіксувати цю версію все одно?',
  ),
  ...
  'Argument "%s" requires a parameter.' => 'Аргумент "%s" потребує параметра.',
  ...
  'Enter a brief description of the changes included in this update.' => 'Введіть короткий опис змін, включених до цього оновлення.',
  ...
  'Describe the changes in this new revision.' => 'Опишіть зміни в цій новій версії.',
  'NEW BOOKMARK' => 'НОВА ЗАКЛАДКА',
  'Install JSCS using `%s`.' => 'Встановити JSCS за допомогою `%s`.',
  'Invalid Octal Numeric Scalar' => 'Недійсний Вісімковий Числовий Скаляр',
  'Configuration value "%s" is empty.' => 'Значення конфігурації "%s" пусте.',
  'Invalid command "%s". Did you mean:' => 'Недійсна команда "%s". Ви мали на увазі:',
  'Deleted key "%s" from %s config.' => 'Видалено ключ "%s" з налаштувань %s.',
  'TO INSTALL: %s' => 'ВСТАНОВИТИ: %s',
  'Choose a workflow!' => 'Виберіть робочий процес!',
  '`%s` Operator' => 'Оператор «%s»',
  '%s %s' => '%s %s',
  'No working copy to write config into!' => 'Немає робочої копії для запису налаштувань!',
  ...
  'No lint messages.' => 'Жодних повідомлень lint.',
  'REBASE CONFLICT' => 'КОНФЛІКТ ПЕРЕБАЗУВАННЯ',
  ...
  'Command to use to invoke a web browser.' => 'Команда, яка використовується для виклику веббраузера.',
  'Value "%s" is not valid, specify a JSON list: %s' => 'Значення "%s" недійсне, вкажіть список JSON: %s',
  'Specify at most one revision name.' => 'Вкажіть щонайбільше одну назву версії.',
  'You have untracked files in this working copy.' => 'У цій робочій копії є невідстежувані файли.',
  'JSON Lint' => 'JSON Lint',
  'Arguments with default values must be at the end of the argument list.' => 'Аргументи зі значеннями за замовчуванням повинні бути в кінці списку аргументів.',
  ...
  'Wrote PHP definition.' => 'Написано визначення PHP.',
  'Version' => 'Версія',
  'REVISION' => 'РЕВІЗІЯ',
  ...
  'Incomplete implementation: %s!' => 'Незавершена реалізація: %s!',
  ...
  'Array Separator' => 'Роздільник Масивів',
  ...
  'IMMUTABLE WORKING COPY' => 'НЕЗМІННА РОБОЧА КОПІЯ',
...
дайте відповідь "y*" або "y!", щоб зберегти свою відповідь.',
  ...
  'In module `%s`, declaration `%s`.' => 'У модулі `%s`, оголошення `%s`.',
  'Space After Unary Prefix Operator' => 'Пробіл Після Одинарного Префіксного Оператора',
  'Stashing uncommitted changes. (You can restore them with `%s`).' => 'Зберігання незафіксованих змін. (Ви можете відновити їх за допомогою `%s`).',
  'Call %s to build the graph out before calling %s.' => 'Викличте %s для побудови графіка перед викликом %s.',
  'Unrecognized symbol name.' => 'Нерозпізнана назва символу.',
...
. Символи поділяються на символи "have" (символи, які оголошує файл
 ...
 (500 мс+ для файлів помірно великих розмірів).',
  ...
  'Argument position specified with "--current" ("%s") is greater than the number of arguments provided ("%s").' => 'Позиція аргументу, вказана за допомогою "--current" ("%s") є більшою за кількість наданих аргументів ("%s").',
  'No tasks found.' => 'Завдань не знайдено.',
  '%s' => '%s',
  'Choose an object to inspect:' => 'Виберіть об\'єкт для перевірки:',
  'Invalid EditorConfig property.' => 'Недійсна властивість EditorConfig.',
  'Use **%s** __command__ for a detailed command reference.' => 'Використовуйте **%s** __command__ для детального опису команд.',
  ...
  'Failed to upload binary "%s".' => 'Не вдалося завантажити двійковий файл "%s".',
  'ARGV' => 'ARGV',
  'Conflicts in working copy:' => 'Конфлікти в робочій копії:',
  '%s submodule(s) have uncommitted or untracked changes:' => array(
    ' Підмодуль має незафіксовані або невідстежені зміни:',
    'Підмодулі мають незафіксовані або невідстежені зміни:',
  ),
  'Expected file \'%s\' to begin `%s`.' => 'Очікується файл \'%s\', щоб почати `%s`.',
  ...
  'File "%s" does not exist, or you do not have permission to view it.' => 'Файл "%s" не існує, або у вас немає дозволу на його перегляд.',
  'Configuration (%s)' => 'Конфігурація (%s)',
  'This file contains a syntax error: %s' => 'Цей файл містить синтаксичну помилку: %s',
  ...
  'Single lined arrays should not have a trailing comma.' => 'Однорядкові масиви не повинні мати кінцевої коми.',
  'Unsafe Usage of Dynamic String' => 'Небезпечне Використання Динамічного Рядка',
  '%s can not be used with %s.' => '%s не можна використовувати разом з %s.',
  'Merge conflicts in working copy:' => 'Конфлікти об\'єднання в робочій копії:',
  ...
  '**version**' => '**версія**',
  'Broken' => 'Зламано',
  'Length must be larger than 0!' => 'Довжина має бути більшою за 0!',
  ...
  'Expected JSON response from Asana.' => 'Очікувана відповідь JSON від Asana.',
  'Space Around Comma' => 'Пробіли Навколо Коми',
  'PHP Syntax Error!' => 'Помилка синтаксису PHP!',
  'INVALID CREDENTIALS' => 'НЕДІЙСНІ ОБЛІКОВІ ДАНІ',
  'Attempting to rebase changes.' => 'Спроба перебазування змін.',
  ...
  '%s called with no messages!' => '%s викликано без повідомлень!',
  ...
  'Requested path \'%s\' is not a directory.' => 'Шлях \'%s\', стосовно якого зроблено запит, не є каталогом.',
  'Command failed with error #%d!' => 'Команда не виконана з помилкою #%d!',
  'Unexpected data type in request data: %s.' => 'Неочікуваний тип даних у даних запиту: %s.',
  ...
  'Unnecessary Final Modifier' => 'Непотрібний Кінцевий Модифікатор',
  ...
  'Usage Exception:' => 'Виняток використання:',
  'User "%s"' => 'Користувач «%s»',
  'Installing certificate for \'%s\'...' => 'Встановлення сертифіката для \'%s\'...',
  ...
  'AMBIGUOUS MARKER' => 'НЕОДНОЗНАЧНИЙ МАРКЕР',
  ...
  'Deleted' => 'Видалено',
  'The HTTP method \'%s\' is not supported. Supported HTTP methods are: %s.' => 'Метод HTTP \'%s\' не підтримується. Методи HTTP, що підтримуються: %s.',
  ...
  'Unable to determine repository for this change.' => 'Не вдалося визначити репозиторій для цієї зміни.',
  'Provided path \'%s\' is not a %s library.' => 'Наданий шлях \'%s\' не є бібліотекою %s.',
  'Downloading binary data...' => 'Завантаження двійкових даних...',
  'Unable to access %s or `%s` on this system to get system memory information.' => 'Не вдається отримати доступ до %s або `%s` на цій системі для отримання інформації про системну пам\'ять.',
  ...
  'Use of Close Tag `%s`' => 'Використання Тегу Закриття `%s`.',
...
про статус перегляду.',
  'Use `%s` to instantiate the current class.' => 'Використайте `%s` для створення екземпляра поточного класу.',
  'Specify a key and a value.' => 'Вкажіть ключ і значення.',
  ...
  'Do not run lint.' => 'Не запускайте lint.',
  ...
  'Specify at most one URI.' => 'Вкажіть щонайбільше один URI.',
  'Shows the current version.' => 'Показує поточну версію.',
  ...
  '`%s` class `%s` has an invalid ID constant. ID must be an integer.' => 'Клас `%s` `%s` має недійсну сталу ID. ID має бути цілим числом.',
  'UPDATE' => 'ОНОВЛЕННЯ',
  'With %s, use uglier (but more efficient) formatting.' => 'За допомогою %s використовуйте незграбніше (але ефективніше) форматування.',
  'Message begins:' => 'Початок повідомлення:',
  ...
  'Discard these changes before running "arc upgrade".' => 'Скасуйте ці зміни перед запуском "arc upgrade".',
  'Failed to copy file from "%s" to "%s": %s' => 'Не вдалося скопіювати файл із "%s" до "%s": %s',
  ...
  'Invalid Default Parameter' => 'Недійсний Параметр За Замовчуванням',
  ...
  'Not a symlink!' => 'Не символічне посилання!',
  ...
  'Submitting changes to "%s".' => 'Надсилання змін до "%s".',
  'Downloading binary data for \'%s\'...' => 'Завантаження двійкових даних для \'%s\'...',
  ...
  'DATA' => 'ДАНІ',
  'You can not use "--current" when generating rules.' => 'Ви не можете використовувати "--current" під час створення правил.',
  ...
  '---' => '---',
  'Failed to write %d bytes to \'%s\'.' => 'Не вдалося записати %d байт до \'%s\'.',
  ...
  'Call to "curl_setopt(...)" returned "false".' => 'Виклик "curl_setopt(...)" повернув значення "false".',
  ...
  'Unsupported base85 encoding mode "%s".' => 'Непідтримуваний режим кодування base85 "%s".',
  ...
  'Install CoffeeLint using `%s`.' => 'Встановіть CoffeeLint, використовуючи `%s`.',
  'Your \'%s\' file is not a valid JSON file.' => 'Ваш файл \'%s\' не є дійсним файлом JSON.',
  'Use __%s__ to show additional options.' => 'Використайте __ %s __, щоб показати додаткові опції.',
  ...
  'Two workflows with name \'%s!' => 'Два робочі процеси з назвою \'%s!',
  'Class symbol "%s" should be written as "%s".' => 'Символ класу "%s" слід записувати як "%s".',
  'Accepted' => 'Прийнято',
  ...
  'Working Copy: Project root is at "%s".' => 'Робоча копія: Кореневий каталог проекту знаходиться за адресою "%s".',
  '(DEPRECATED) Obsolete, use "--types path" instead.' => '(ЗАСТАРІЛЕ) Застаріло, використовуйте натомість "--types path".',
  '    %s (%s) %s
' => '    %s (%s) %s',
  'This is just an example function!' => 'Це тільки приклад функції!',
  ...
  'Use the full form of the PHP open tag, `%s`.' => 'Використовуйте повну форму вілкритого тегу PHP, `%s`.',
  ...
  'Specify a file to download.' => 'Вкажіть файл для завантаження.',
  'Expected a list or dictionary!' => 'Очікувався список або словник!',
  ...
  'Use `%s` single-line comments, not `%s`.' => 'Використовуйте однорядкові коментарі `%s`, а не `%s`.',
  ...
  'Status: %s' => 'Статус: %s',
  'Argument index is not a scalar.' => 'Індекс аргументу не є скаляром.',
  'The test passed.' => 'Тест пройдено.',
  'Received error from Twitch: %s' => 'Отримано помилку від Twitch: %s',
  'Rewrite this code to use an array. Variable variables are unclear and hinder static analysis.' => 'Перепишіть цей код, щоб використовувати масив. Змінні змінні незрозумілі та перешкоджають статичному аналізу.',
  'Missing files in working copy:' => 'Відсутні файли в робочій копії:',
  ...
  'Begin or resume work.' => 'Почати або відновити роботу.',
  'Jun' => 'Чер',
  '%s failed: %s' => 'невдача %s: %s',
  ...
  'Possible Spelling Mistake' => 'Ймовірна Орфографічна Помилка',
  'Moved Away' => 'Переміщено Звідси',
  '%s is not compatible with the installed version of pylint. Minimum version: %s; installed version: %s.' => '%s несумісний із встановленою версією pylint. Мінімальна версія: %s; встановлена версія: %s.',
  'Use of Undeclared Variable' => 'Використання Неоголошеної Змінної',
  ...
  'Cannot find the %s equivalent of %s.' => 'Не вдається знайти еквівалент %2$s %s.',
  'Maximum value must be an integer.' => 'Максимальне значення має бути цілим числом.',
  ...
  'Report results in JSON format.' => 'Звітувати про результати у форматі JSON.',
  ...
  'Expected %s to return array, got %s.' => 'Очікувалося, що поверне масив %s, отримано %s.',
  '<%s> %s' => '<%s> %s',
  'Unable to read file permissions for "%s"!' => 'Не вдалося прочитати дозволи файлу для "%s"!',
  ...
  'Unexpected `%s` value in `%s` method.' => 'Неочікуване значення `%s` у методі `%s`.',
  'Disconnected' => 'Роз\'єднано',
  'Unresolved merge conflict' => 'Невирішений конфлікт злиття',
  'Encountered a merge conflict.' => 'Виник конфлікт злиття.',
  ...
  'Use of `%s` Properties' => 'Використання Властивостей `%s`',
...
Коли "arc work" створює гілку або закладку, вона використовуватиме **--start** як точку філії, якщо вона надається. В іншому випадку поточний стан робочої копії буде слугувати початковою точкою.',
  'Open a file or object in a local web browser.' => 'Відкрийте файл або об\'єкт у місцевому веббраузері.',
  ...
  'Unable to move %s to %s.' => 'Неможливо перемістити %s до %s .',
...
(Технічно: база злиття вибраної версії та HEAD використовується, щоб визначити початок діапазону фіксації.)',
  ...
  'Checks for syntax errors in PHP files.' => 'Перевіряє наявність синтаксичних помилок у PHP-файлах.',
  'HTTP Basic Auth is not supported by %s.' => 'Базова Автентифікація HTTP не підтримується %s.',
  'Local Config File' => 'Локальний файл конфігурації',
  'Did you mean:' => 'Ти мав на увазі:',
  'This software is now up to date.' => 'Це програмне забезпечення тепер оновлено.',
  'Message has unresolved errors.' => 'Повідомлення містить невиправлені помилки.',
  'Error' => 'Помилка',
  'PayPal API call failed: %s' => 'Помилка виклику PayPal API: %s',
  'TODO: Support merge strategies' => 'ЗАВДАННЯ: Підтримка стратегій об\'єднання',
  ...
  '`%s` Should Be `%s`' => '`%s` Має Бути `%s`',
  'ACTUAL VALUE' => 'ДІЙСНЕ ЗНАЧЕННЯ',
  'Unable to upload file: path "%s" does not exist.' => 'Неможливо завантажити файл: шляху "%s" не існує.',
  'LOAD ERROR' => 'ПОМИЛКА ЗАВАНТАЖЕННЯ',
  'Failed to decode JSON object.' => 'Не вдалося розкодувати об\'єкт JSON.',
  '%s runs all tests.' => '%s запускає всі тести.',
  ...
  'Priority' => 'Пріоритет',
  'Unnecessary Semicolon' => 'Непотрібна Крапка з комою',
  ...
  'Semicolon Spacing' => 'Інтервал Між Крапкою Та Комою',
  'ID' => 'ID',
  ...
  'Diff for \'%s\' with context is %s bytes in length. Generally, source changes should not be this large.' => array(
    ...
    array(
      'Відмінність між версіями для \'%s\' з контекстом має довжину %s байти. Зазвичай, зміни у вихідному коді не повинні бути такими великими.',
      'Відмінність між версіями для \'%s\' з контекстом має довжину %s байтів. Зазвичай, зміни у вихідному коді не повинні бути такими великими.',
    ),
  ),
  ...
  'Certificate installed.' => 'Сертифікат встановлено.',
  ...
  'Unexpected `%s` Value' => 'Неочікуване Значення `%s`',
 ...
 Revision:\', як зазначено "%s" у вашій  конфігурації \'base\' %s.',
  ...
  'Install `%s` from <%s>.' => 'Встановити `%s` з <%s>.',
...
%sВи можете використати це повідомлення або відкинути його.',
  ...
  'Show detailed information about options.' => 'Показати детальну інформацію про опції.',
  '%s argument to %s must not be empty' => 'Аргумент %s для %s не повинен бути порожнім',
  '%s %s -> %s %s %s' => '%s %s -> %s %s %s',
  'Expected %s for %%P conversion.' => 'Очікувалося %s для конверсії %%P.',
  'Common causes are:
...
оновлювали
 ...
 - Цей символ визначено у зовнішній бібліотеці.
  ...
  'Expected exactly one change.' => 'Очікувалася рівно одна зміна.',
  'Class Not `%s` Or `%s`' => 'Клас Не `%s` Або `%s`',
  ...
  'Script and Regex' => 'Сценарій та регулярний вираз',
  ...
  'CLEANUP' => 'ОЧИСТКА',
  'LibXML Error' => 'Помилка LibXML',
  'HOLD CHANGES' => 'УТРИМУВАТИ ЗМІНИ',
  'The cURL library raised an error while making a request. You may be able to find more information about this error (error code: %d) on the cURL site: %s' => 'Бібліотека cURL викликала помилку під час виконання запиту. Ви можете знайти більше інформації про цю помилку (код помилки: %d) на сайті cURL: %s',
  'P4 MODE' => 'РЕЖИМ P4',
  ...
  'Merge Conflicts' => 'Конфлікти Злиття',
  '<none>' => '<жоден>',
  ...
  'Checking out "%s".' => 'Перевірка "%s".',
  'There is no **%s** workflow.' => 'Немає робочого процесу ** %s **.',
  ...
  'Protocol channel expected %s-character, zero-padded numeric frame length, got something else ("%s"). Full buffer (of length %s) begins: %s' => 'Очікувався канал протоколу %s -символьний, довжина числового кадру доповнена нулями, отримано щось інше (" %s "). Повний буфер (довжиною %s)  починається на: %s',
 ...
 Revision:\', як і зазначено \'%s\' у вашій  конфігурації \'base\' %s.',
  ...
  'Writing \'%s\' to \'%s\'...
' => 'Запис від «%s» до «%s»…',
  'Download a file to local disk.' => 'Завантажити файл на місцевий диск.',
  'Related configuration:' => 'Пов\'язані налаштування:',
  'Working Copy: Path "%s" is part of `%s` working copy "%s".' => 'Робоча Копія: Шлях "%s" є частиною робочої копії `%s` "%s".',
  '"%s" is not an exact quantity.' => '"%s" не є точним значенням.',
  ...
  'Comment Style' => 'Стиль Коментарів',
  ...
  'Expected rule \'%s\' in state \'%s\' in %s to have 2-4 elements (regex, token, [next state], [options]), got %d.' => 'Очікувалося, що правило \'%s\' у стані \'%s\' у %s матиме 2-4 елементи (регулярний вираз, токен, [наступний стан], [опції]), але отримано %d.',
  ...
  'TODO: Ambiguous ref.' => 'ЗАВДАННЯ: Неоднозначне посилання.',
  '<paths = %s>' => '<paths = %s>',
  ...
  'Rebase onto %s failed!' => 'Перебазування на %s не вдалося!',
  ...
  'STRATEGY' => 'СТРАТЕГІЯ',
  'Duplicate key in array initializer. PHP will ignore all but the last entry.' => 'Дубльований ключ в ініціалізаторі масиву. PHP ігноруватиме всі записи, крім останнього.',
  ...
  'Failed to write to buffer.' => 'Не вдалося записати в буфер.',
...
' => 'Створити завдання %s: «%s» на %s',
  'Status' => 'Статус',
  'Formatted String' => 'Форматований Рядок',
  ...
  'Unnecessary `%s` modifier in `%s` class.' => 'Непотрібний модифікатор `%s` у класі `%s`.',
  ...
  'One Class Per File' => 'Один Клас На Файл',
  'Mar' => 'Бер',
  ...
  'Parameter has invalid type.' => 'Параметр має недійсний тип.',
  ...
  'Confirms creation of a new library.' => 'Підтверджує створення нової бібліотеки.',
  'Server' => 'Сервер',
  '%s Value' => 'Значення %s',
  'instance of %s' => 'приклад %s',
  'URI' => 'URI',
...
' => 'Оскільки в Differential немає версій, які б відповідали цій робочій копії, нова версія буде **створена**, якщо ви запустите "%s".',
  ...
  '(Message saved to %s.)' => '(Повідомлення збережено в %s.)',
  ...
  'Upgrade arc now?' => 'Оновити arc зараз?',
  '%s: %s' => '%s: %s',
  ...
  'Creating new library in \'%s\'.' => 'Створення нової бібліотеки в \'%s\'.',
  'AWS Request Failed' => 'Помилка запиту AWS',
  'PREVIEW' => 'ПОПЕРЕДНІЙ ПЕРЕГЛЯД',
  '`elseif` Usage' => 'Використання `elseif`',
  ...
  'Install PyLint using `%s`.' => 'Встановіть PyLint за допомогою `%s`.',
  ...
  'Disabled' => 'Вимкнено',
  'Specify file by ID, e.g. %s.' => 'Вкажіть файл за ідентифікатором, наприклад, %s.',
  ...
  'Message should be %s.' => 'Повідомлення має бути %s.',
...
(У рідкісних випадках це може бути тому, що ви намагаєтеся запустити одну копію цього програмного забезпечення з паралельно з іншою копією цього програмного забезпечення. Ця операція не підтримується.)',
  ...
  'YOU NEED TO __INSTALL A CERTIFICATE__ TO LOG IN' => 'ВАМ ПОТРІБНО __ВСТАНОВИТИ СЕРТИФІКАТ__ ЩОБ УВІЙТИ',
);
  }
