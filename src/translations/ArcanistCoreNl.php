...
Deze versie toch bijwerken?',
  ...
  'Unable to write log "%s" to path "%s" because the path is not writable.' => 'Kan logboek "%s" niet schrijven naar pad "%s" omdat het pad niet schrijfbaar is.',
...
%sU kunt dit bericht gebruiken of verwerpen.',
  ...
  'Revision %s does not exist.' => 'Versie %s bestaat niet.',
  'Unable to write log "%s" to path "%s". The containing directory ("%s") does not exist or is not readable, and could not be created.' => 'Kan logboek "%s" niet schrijven naar pad "%s". De bevattende map ("%s") bestaat niet of is niet leesbaar, en kon niet worden aangemaakt.',
  'INFO' => 'INFO',
