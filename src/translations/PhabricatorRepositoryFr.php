...
final class PhabricatorRepositoryFr
  ...
  protected function getTranslations() {
    ...
    ' => array(
      ...
      'Specify --all or a list of repositories, but not both.' => 'Spécifiez « --all » ou une liste de dépôts, mais pas les deux.',
      ...
      '%s changed autoclose branches from %s to %s.' => '%s a modifié les branches autofermantes de %s à %s.',
      'SSH' => 'SSH',
