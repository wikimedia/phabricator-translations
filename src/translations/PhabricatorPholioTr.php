...
final class PhabricatorPholioTr
  ...
  '%s added %d image(s): %s.' => '%s, %d resim ekledi: %s.',
  ...
  '%s removed %s task(s) for %s: %s.' => '%s, %3$s için %s görevini kaldırdı: %4$s.',
  '%s created this mock.' => '%s bu sahteyi oluşturdu',
  'Pholio Mocks' => 'Pholio Sahteleri',
  '%s removed %d image(s): %s.' => '%s, %d resim kaldırdı: %s.',
  'Mock image titles must not be longer than %s character(s).' => 'Sahte görüntü adları %s karakterden uzun olmamalıdır.',
  ...
  'The author of a mock can always view and edit it.' => 'yazar of a mock always görüntüleme and düzenleme it.',
  ...
  '%s added %s task(s) for %s: %s.' => '%s, %3$s için %s görev ekledi: %4$s.',
  ...
  '%s edited image(s), added %d: %s; removed %d: %s.' => '%s resim düzenledi, %d eklendi: %s; %d kaldırıldı: %s.',
