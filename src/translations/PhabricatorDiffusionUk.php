...
This password applies to all repositories available over HTTP.' => 'Щоб отримати доступ до сховищ, розміщених на цьому сервері через HTTP, необхідно встановити пароль контролю версій. Цей пароль має бути унікальним.
