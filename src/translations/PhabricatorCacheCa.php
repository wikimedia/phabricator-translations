...
final class PhabricatorCacheCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'APC User Cache' => 'Caché d\'usuari APC',
      'OPcache Config' => 'Configuració d\'OPcache',
      'Adjust APC settings to quiet unnecessary errors.' => 'Ajusteu els paràmetres de l\'APC per silenciar els errors  no necessaris.',
      ...
      'The "%s" setting is currently enabled in your PHP configuration. In production mode, "%s" should be disabled. This will improve performance slightly.' => 'El paràmetre «%s» està habilitat actualment en la configuració de PHP. En mode producció, cal desactivar "%s". Això millorarà lleugerament el rendiment.',
      ...
      'Some versions of APC may emit unnecessary errors into the error log under the current APC settings. To resolve this, enable "%s" and disable "%s" in your PHP configuration.' => 'Algunes versions de l\'APC poden emetre errors innecessaris al registre d\'errors sota els paràmetres actuals de l\'APC. Per resoldre això, activeu «%s» i desactiveu «%s» en la vostra configuració de PHP.',
      'The "%s" setting is currently disabled in your PHP configuration, but Phabricator is running in development mode. This option should normally be enabled in development so you do not need to restart anything after making changes to the code.' => 'La configuració de «%s» està desactivada actualment en la configuració de PHP, però Phabricator s\'està executant en mode de desenvolupament. Aquesta opció normalment s\'ha d\'activar en el desenvolupament de manera que no cal reiniciar res després de fer canvis al codi.',
