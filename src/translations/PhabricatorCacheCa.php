...
final class PhabricatorCacheCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'The "%s" setting is currently enabled in your PHP configuration. In production mode, "%s" should be disabled. This will improve performance slightly.' => 'La configuració de «%s» està habilitada actualment en la configuració de PHP. En mode producció, cal desactivar "%s". Això millorarà lleugerament el rendiment.',
