...
final class PhabricatorConpherenceEsES
  ...
  protected function getTranslations() {
    return array(
  '%s edited participant(s), added %d: %s; removed %d: %s.' => '%s editó la lista de participantes, añadidos %d: %s; retirados %d: %s.',
  ...
  'Apply transactions to create a new room or edit an existing one.' => 'Aplicar las transacciones para crear una nueva sala o para editar una sala existente.',
  ...
  'Topic' => 'Asunto',
  'Participants in this room can take this action.' => 'Los participantes de esta sala pueden realizar esta acción.',
  'Create New Room' => 'Crear nueva sala',
  'Conpherence Rooms' => 'Salas de Conpherence',
  'Room' => 'Sala',
