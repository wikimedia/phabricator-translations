...
final class PhabricatorPhidCa
  ...
  '%s class "%s" has an invalid %s property. PHID constants must be a four character uppercase string.' => 'La classe "%2$s" de %s conté una propietat de %3$s no vàlida. Els PHID constants han de ser cadenes de caràcters formades per 4 lletres majúscules.',
