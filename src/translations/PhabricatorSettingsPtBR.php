...
final class PhabricatorSettingsPtBR
  ...
  'Unlink' => 'Desvincular',
  'If you have difficulty reading the UI, this setting may help.' => 'Se você tiver dificuldade para ler a interface do usuário, essa configuração pode ajudar.',
...
//Você ainda receberá alguns e-mails administrativos, como o e-mail de redefinição de senha.//',
  ...
  'DarkConsole is a debugging console for developing and troubleshooting applications. After enabling DarkConsole, press the {nav `} key on your keyboard to toggle it on or off.' => 'O console escuro é um console de depuração para desenvolvimento e solução de problemas de aplicativos. Depois de ativar o console escuro, pressione a tecla {nav `} no teclado para ativá-lo ou desativá-lo.',
  ...
  'No allowed editor protocols are configured.' => 'Nenhum protocolo de editor permitido está configurado.',
  ...
  'Choose the default behavior of the global search in the main menu.' => 'Escolha o comportamento padrão da pesquisa global no menu principal.',
  'Hypertext Transfer Protocol' => 'Protocolo de transferência de hipertexto',
  'Diffusion Blame' => 'Responsabilidade de comunicação',
  'Choose which language you would like the UI to use.' => 'Escolha o idioma que você deseja que a interface do usuário use.',
  ...
  'Supported Protocol' => 'Protocolo compatível',
...
Estas preferências **apenas** aplicam-se a objetos aos quais você está conectado (por exemplo, Revisões em que você é um revisor ou tarefas em que você está usando o CC). Para receber alertas de email quando outros objetos são criados, configure [[ /herald/ | Regras Herald  ]].',
  ...
  'Replaced With' => 'Substituído por',
  'Send HTML Email' => 'Enviar email em HTML',
  'Translation' => 'Tradução',
  'Settings %d' => 'Configurações %d',
  ...
  'External Editor URI Variables' => 'Variáveis de URI do editor externo',
  ...
  'Your browser has granted this server permission to send desktop notifications.' => 'Seu navegador concedeu permissão a este servidor para enviar notificações de desktop.',
  ...
  'Supported Editor Protocols' => 'Protocolos de editor suportados',
