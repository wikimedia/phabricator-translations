...
final class PhabricatorTransactionsSv
  ...
  '%s removed %d subscriber(s): %s.' => '%s tog bort %d prenumerant(er): %s.',
  ...
  '%s added %d subscriber(s): %s.' => '%s lade till %d prenumerant(er): %s.',
  ...
  '%s edited subscriber(s), added %d: %s; removed %d: %s.' => '%s redigerade prenumerant(er), lade till %d: %s; tog bort %d: %s.',
