...
final class PhabricatorFilesSl
  ...
  protected function getTranslations() {
    return array(
  'Found no template resource (for emblem "%s") with dimensions %dx%d.' => 'Ni najdenega vira predloge (za emblem »%s«) z merami %d × %d.',
  ...
  'Found no background template resource for dimensions %dx%d.' => 'Ni najdenega vira predloge ozadja za mere %d × %d.',
