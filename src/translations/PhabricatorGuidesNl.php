...
final class PhabricatorGuidesNl
  ...
  protected function getTranslations() {
    return array(
  'Create a Repository' => 'Een repository aanmaken',
  'If you are here for code review, let\'s set up your first repository.' => 'Als u hier bent voor een codereview, laten we dan uw eerste repository opzetten.',
  'You\'ve configured at least one setting from the web interface.' => 'U hebt ten minste één instelling via de webinterface geconfigureerd.',
  'You\'ve created at least one task.' => 'U hebt minstens één taak aangemaakt.',
  ...
  'Change the name and add your company logo, just to give it a little extra polish.' => 'Verander de naam en voeg uw logo toe om het net wat professioneler te maken.',
  'You\'ve set up a real-time notification server.' => 'U hebt een realtime meldingenserver ingesteld.',
  'You have some unresolved setup issues to take care of.' => 'Er zijn nog enkele onopgeloste installatieproblemen die u moet verhelpen.',
  'Create some work for the interns in Maniphest.' => 'Geef de stagiairs wat werk in Maniphest.',
  ...
  'You\'ve created at least one project.' => 'U hebt minstens één project aangemaakt.',
  'It looks amazing, good work. Home Sweet Home.' => 'Het ziet er fantastisch uit, goed gedaan. Thuis is waar het hart ligt.',
  'Two guidance extensions generated guidance with the same key ("%s"). Each piece of guidance must have a unique key.' => 'Twee richtlijnuitbreidingen richtlijnen met dezelfde sleutel gemaakt ("%s"). Elk stuk richtlijn moet een unieke sleutel hebben.',
  'Notification Server' => 'Meldingenserver',
