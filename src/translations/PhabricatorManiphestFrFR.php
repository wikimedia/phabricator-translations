...
Pour plus de détails sur l\'ajout de champs personnalisés à Maniphest, voir [[ %s | %s ]] dans la documentation.',
  ...
  'Parameter "%s" is no longer supported. Use method "%s" with the "%s" constraint instead.' => 'Le paramètre « fullText » n’est plus pris en charge. Utilisez à la place la méthode « maniphest.search » avec la contrainte « query ».',
