...
final class PhabricatorManiphestFrFR
  ...
  protected function getTranslations() {
    ...
    Si vous spécifiez une priorité invalide, la commande est ignorée. Cette commande n’a aucun effet si vous ne spécifiez pas de priorité.',
      ...
      'Type a username or "none"...' => 'Entrez un nom d\'utilisateur ou « none »…',
      ...
      '%s assigned %s to %s.' => '%s a attribué %s à %s',
      ...
      'Changed Status' => 'Statut changé',
      '%s renamed this task from %s to %s.' => '%s a renommé cette tâche de %s à %s',
