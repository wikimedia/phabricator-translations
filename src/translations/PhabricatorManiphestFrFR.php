...
final class PhabricatorManiphestFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'project must be a valid phid or hashtag.' => 'le projet doit être un PHID ou un mot-dièse valide.',
      'Finished' => 'Terminé',
    ...
    Si vous spécifiez une priorité non valide, la commande est ignorée. Cette commande n’a aucun effet si vous ne spécifiez pas de priorité.',
      ...
      'Task' => 'Tâche',
      'This method is new and unstable.' => 'Cette méthode est nouvelle et instable.',
    ...
    Si vous omettez le nom d’utilisateur ou si le nom d’utilisateur n\'est pas valide, cela se comporte comme `%s` et la tâche vous est affectée à la place.',
      ...
      'Retrieve Maniphest task transactions for tasks that are now
         or were previously in a given project.' => 'Récupérer les transactions de tâche Maniphest pour les tâches qui sont maintenant
         ou étaient auparavant dans un projet donné.',
      ...
      'Validation of "%s"' => 'Validation de « %s »',
    ...
    Pour fermer rapidement une tâche, voir `%s`.',
      ...
      'Open Duplicate' => 'Ouvrir le doublon',
      ...
      'Duplicate Special' => 'Page spéciale en doublon',
