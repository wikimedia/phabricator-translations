...
final class ArcanistCoreBeTarask
  ...
  'Ref "%s" does not exist in remote "%s".' => 'Спасылка „%s“ ня існуе ў аддаленым „%s“.',
  ...
  'Do not call %s or %s directly on a %s. Instead, call %s or %s.' => 'Не выклікаць %s або %s наўпрост на %s. Наўзамен выклікайце %s або %s.',
  'A linter for Composer related files.' => 'Linter для файлаў, зьвязаных з Composer',
  'Saved "%s" as "%s".' => 'Захаванае „%s“ як „%s“.',
  'Not parsing!' => 'Не апрацоўваем!',
  'File Symbol "%s"' => 'Сымбаль файлу „%s“',
  ...
  'Task Symbol "%s"' => 'Сымбаль заданьня „%s“',
  ...
  'Path \'%s\' is not readable.' => 'Шлях „%s“ нечытэльны.',
  ...
  'Empty certificate in credentials.' => 'Пусты сэртыфікат у пасьведчаньнях.',
  ...
  'Rule \'%s\' in state \'%s\' in %s defines an invalid regular expression (\'%s\'): %s' => 'Правіла „%s“ у стане „%s“ у %s вызначае хібны рэгулярны выраз („%s“): %s',
  'In most cases, arc can be upgraded automatically.' => 'У большасьці выпадкаў arc можа быць абноўлены аўтаматычна.',
  'Throwing Exception in `%s` Method' => 'Кідаем вынятак ў мэтадзе «%s»',
  ...
  'Load a library.' => 'Ладаваць бібліятэку.',
...
' => '    %s %s',
  ...
  'LOAD STATE' => 'ЛАДУЕЦЦА СТАН',
  'Diff URI:' => 'URI-адрас розьніцы:',
  'MERGE' => 'ЗЬЯДНАЦЬ',
  'Revision %s' => 'Вэрсія %s',
  'File Error' => 'Памылка файлу',
  'Avoid the use of inner functions.' => 'Унікайце ўжываньня ўнутраных функцыяў.',
  ...
  'LOAD STASH' => 'ЛАДУЕЦЦА СХОЎКА',
  '<default>' => '<перадвызначана>',
  'DATA' => 'ЗЬВЕСТКІ',
  'EXCEPTION' => 'ВЫНЯТАК',
  'Argument Error' => 'Памылка аргумэнту',
