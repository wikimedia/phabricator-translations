...
%s',
  ...
  'Notification server configuration is invalid: it describes the same host and port ("%s") multiple times. Each host and port combination should appear only once in the list.' => 'De instelling van de meldingenserver is incorrect: dezelfde host en poort ("%s") worden meerdere keren beschreven. Elke combinatie van host en poort mag slechts één keer in de lijst voorkomen.',
