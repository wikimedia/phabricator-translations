...
final class PhabricatorMetaRu
  ...
  protected function getTranslations() {
    return array(
      ...
      'This application cannot be uninstalled, because it is required for Phabricator to work.' => 'Это приложение нельзя удалить, поскольку оно требуется для работы Phabricator.',
      'Syntax' => 'Синтаксис',
      ...
      'Launcher' => 'Лаунчер',
      'To manage prototypes, enable them by setting %s in your Phabricator configuration.' => 'Чтобы управлять прототипами, включите их, установив %s в конфигурации Phabricator.',
      ...
      'Completely Break Phabricator' => 'Полностью сломать Фабрикатор',
