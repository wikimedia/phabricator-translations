...
final class PhabricatorMetaRu
  ...
  protected function getTranslations() {
    return array(
  'Completely Break Everything' => 'Полностью сломать всё',
...
```',
  'Show Enabled Applications' => 'Показать установленные приложения',
  'Can\'t set non-public capabilities to public.' => 'Нельзя сделать частные правила общедоступными.',
  'Launchable' => 'Запускаемое',
  'You cannot enable an enabled application.' => 'Вы не можете установить установленное приложение.',
  ...
  'Really Disable Application?' => 'Действительно удалить приложение?',
  'Create New Application' => 'Создать новое приложение',
  'Extension' => 'Расширение',
  'Validation Failed' => 'Проверка провалилась',
  'Really disable the %s application?' => 'Действительно удалить приложение %s?',
  ...
  'Show Disabled Applications' => 'Показать удаленные приложения',
  ...
  'This application is required and cannot be disabled.' => 'Это приложение нельзя удалить, поскольку оно требуется для работы Phabricator.',
  ...
  'Are you absolutely certain you want to disable the Home application?' => 'Вы полностью уверены, что хотите удалить домашнее приложение?',
