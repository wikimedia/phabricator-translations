...
final class PhabricatorCalendarSl
  ...
  'Change the end time of the event.' => 'Sprememba končnega časa dogodka.',
  ...
  'Change the start time of the event.' => 'Sprememba začetnega časa dogodka.',
  ...
  'Invalid iteration interval ("%d"), must be at least 1.' => 'Neveljaven interval iteracije (»%d«), biti mora vsaj 1.',
