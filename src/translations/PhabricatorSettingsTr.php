...
final class PhabricatorSettingsTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'Choose which language you would like the Phabricator UI to use.' => 'Phabricator kullanıcı arayüzünün hangi dili kullanmasını istediğinizi seçin.',
    ...
    //Parola sıfırlama e-postası gibi yine bir yönetim e-postası alacaksınız.//',
      ...
      'Phabricator is not configured to allow any editor protocols.' => 'Phabricator, herhangi bir editör protokolüne izin vermek için yapılandırılmadı.',
      '⚫ Email' => '⚫ E-posta',
