...
final class PhabricatorSearchTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'This menu item is very important, and can not be disabled.' => 'Bu menü maddesi çok önemlidir ve devre dışı bırakılamaz.',
      ...
      'Export Format Not Available' => 'Dışa Aktarma Biçimi Müsait Değil',
      'Readable' => 'Okunabilir',
      ...
      'To configure the search engines, edit [[ %s | `%s` ]] configuration. See **[[ %s | %s ]]** for documentation.' => 'Arama motorlarını yapılandırmak için [[%s | `%s`]] yapılandırma. Belgeler için bkz. **[[ %s | %s]]**.',
      ...
      'Cats will often bring you their prey because they feel sorry for your inability to hunt.' => 'Kediler size avlarını sık sık getirecektir çünkü avlanamadığınız için üzgünüz.',
      ...
      'Edit Menu Item: %s' => 'Menü Öğesini Düzenle: %s',
      ...
      'Indexing %d object(s) of type %s.' => '%s türündeki %s nesne(lerin) indekslenmesi.',
      ...
      'Failed to update search index for document "%s": %s' => '"%s" dokümanı için arama dizini güncellenemedi: %s',
      ...
      'SearchEngines must render a "%s" object, but this engine (of class "%s") rendered something else.' => 'SearchEngines bir "%s" nesnesi oluşturmalıdır, fakat bu motor ("%s" sınıfında) başka bir şey yarattı.',
      ...
      'Document Status' => 'Döküman Durumu',
      'Engine: Search' => 'Motor: Ara',
      'Profile Menu Item' => 'Profil Menü Öğesi',
      '"2022-12-25" or "7 days ago"...' => '"2022-12-25" ya da "7 gün önce"...',
      ...
      'Query Overheated' => 'Sorgu Aşırı Isındı',
      ...
      'NOTE' => 'NOT',
      '"%s" must be a date before "%s".' => '"%s", "%s" den önceki bir tarih olmalıdır.',
      ...
      'Most objects matching your query are not visible to you, so filtering results is taking a long time. Refine your query to find results more quickly.' => 'Sorgunuzla eşleşen nesnelerin çoğu sizin için görünmez; bu nedenle sonuçları filtrelemek uzun zaman alıyor. Sonuçları daha hızlı bulmak için sorgunuzu düzeltin.',
      ...
      '(Restricted/Invalid Dashboard)' => '(Sınırlı/Geçersiz Gösterge Tablosu)',
      ...
      'Resetting common ngrams for "%s".' => '"%s" için genel ngramları sıfırlamak.',
      ...
      'Ferret Fulltext Engine' => 'Gelincik Tam Metin Motoru',
      ...
      'Link' => 'Bağlantı',
      'Enable Query' => 'Sorgu Etkinleştir',
      ...
      'Specify either --reset or --threshold, not both.' => 'Her ikisini de değil, --reset veya --threshold\'ı belirtin.',
      ...
      'No results found for this query.' => 'Bu sorgu için sonuç bulunamadı.',
      'Searched For:' => 'Aranan:',
      ...
      'DEV: Overheated State' => 'DEV: Aşırı Isınmış Devlet',
      'Not Defaultable' => 'Varsayılan Değil',
      'Really Delete Query?' => 'Gerçekten Sorguyu Silinsin mi?',
      'Query offset is too large. offset+limit=%s (max=%s)' => 'Sorgu sapması çok büyük. ofset+limit=%s (en fazla=%s)',
      ...
      'Unknown search function "%s". Supported functions are: %s.' => 'Bilinmeyen arama işlevi "%s". Desteklenen işlevler: %s.',
