...
Si vous spécifiez un RSVP non valide, la commande est ignorée. Cette commande est sans effet si vous ne spécifiez pas de RSVP.',
  ...
  'Invalid iteration interval ("%d"), must be at least 1.' => 'Intervalle d’itération (« %d ») non valide, doit être au moins 1.',
...
%s',
  ...
  'Private User %d' => 'Utilisateur privé %d',
