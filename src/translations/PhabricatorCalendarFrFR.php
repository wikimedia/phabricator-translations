...
final class PhabricatorCalendarFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'Expected exception for floating time with no viewer timezone.' => 'Une exception était attendue pour un horaire flottant sans indication du fuseau horaire de visualisation.',
    ...
    Si vous spécifiez un RSVP non valide, la commande est ignorée. Cette commande est sans effet si vous ne spécifiez pas de RSVP.',
      ...
      'Hourly event with BYHOUR.' => 'Événement récurrent toutes les heures avec « BYHOUR ».',
      ...
      'Expected exception parsing "%s", got none.' => 'Une exception d’analyse « %s » était attendue, mais aucune n’a été retournée.',
      ...
      'Expected no exception parsing "%s", got: %s' => 'Aucune exception n’était attendue lors de l’analyse de « %s », mais %s a été obtenu.',
      ...
      'Correct event indexes with start date.' => 'Corriger les indices d’événement avec la date de début.',
      ...
      'Set with empty list source.' => 'Définir avec une source de liste vide.',
      ...
      'Expected one exception parsing "%s", got a different one: %s' => 'Une exception d’analyse « %s » était attendue, mais une exception différente a été détectée : %s',
      'No Imported Events' => 'Aucun événement importé',
    ...
    %s',
      ...
      'Simple daily event.' => 'Événement quotidien simple.',
      ...
      'Weekly recurring event.' => 'Événement hebdomadaire récurrent.',
      ...
      'Multiple lists, time window.' => 'Listes multiples, fenêtre de temps.',
