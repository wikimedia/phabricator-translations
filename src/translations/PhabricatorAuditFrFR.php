...
final class PhabricatorAuditFrFR
  ...
  '(This commit affected more than %d files. Only %d are shown here and additional ones are truncated.)' => '(Cette validation a affecté plus de %d fichiers. Seuls %d d’entre eux sont affichés ici et les autres sont tronqués.)',
  ...
  'Deleting audit %d...' => 'Suppression de l’audit %d...',
