...
final class PhabricatorAuditFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'USERS' => 'UTILISATEURS',
      'Find commits with particular identifiers (usually, hashes). Supports full or partial identifiers (like "abcd12340987..." or "abcd1234") and qualified or unqualified identifiers (like "rXabcd1234" or "abcd1234").' => 'Trouver les validations avec des identifiants particuliers (en général, des hachages). Supporte les identifiants complets ou partiels (comme « abcd12340987… » ou « abcd1234 ») et les identifiants qualifiés ou non (comme « rXabcd1234 » ou « abcd1234 »).',
      ...
      'Show Only Unpublished Commits' => 'Afficher seulement les validations non publiées',
      ...
      'No synchronization changes for "%s".' => 'Pas de modification de synchronisation pour « %s ».',
      ...
      'Update commits to make their summary audit state reflect the state of their actual audit requests. This can fix inconsistencies in database state if audit requests have been mangled accidentally (or on purpose).' => 'Mettre à jour les validations pour que le résumé de leur état d’audit reflète l’état de leurs requêtes d’audit réelles. Cela peut corriger des incohérences dans l’état de la base de données si des requêtes d’audit ont été détruites accidentellement (ou délibérément).',
      'Find or exclude unpublished commits which are not ancestors of any permanent branch, tag, or ref.' => 'Trouver ou exclure les validations non publiées qui ne sont pas ancêtres d’une branche, balise ou ref permanente.',
      ...
      'Find commits authored by particular users.' => 'Trouver des validations faites par certains utilisateurs.',
      'Really delete these %s audit(s)? They will be permanently deleted and can not be recovered.' => 'Vraiment supprimer ces %s audit(s) ? Ils le seront de façon définitive et ne pourront pas être récupérés.',
      ...
      'This is a dry run, so no changes will be made.' => 'Ceci est un test à blanc, donc aucune modification ne sera faite.',
      'Hide Unpublished Commits' => 'Masquer les validations non publiées',
      'Audits' => 'Audits',
