...
final class PhabricatorAuthSv
  ...
  'LDAP Port' => 'LDAP-port',
  'Expected \'%s\' to be \'%s\'!' => 'Förväntade "%s" att vara "%s"!',
  ...
  'Unable to connect to LDAP server (%s:%d).' => 'Det gick inte att ansluta till LDAP-servern (%s:%d).',
  ...
  'LDAP' => 'LDAP',
  'LDAP Username' => 'LDAP-användarnamn',
  'LDAP Exception: %s' => 'LDAP-undantag: %s',
