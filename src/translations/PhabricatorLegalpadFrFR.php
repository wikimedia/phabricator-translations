...
final class PhabricatorLegalpadFrFR
  ...
  protected function getTranslations() {
    ...
    Vous pouvez relire le document ici :
      ...
      'Only admins may require signature.' => 'Seuls les admins peuvent réclamer une signature.',
