...
final class PhabricatorNotificationEn
  ...
  protected function getTranslations() {
    ...
    %s' => 'This server is configured to use a notification server, but is unable to connect to it. You should resolve this issue or disable the notification server. It may be helpful to double check your configuration or restart the server using the command below.
    %s',
    ...
    %s',
      ...
      'This server is configured to use a notification server, but is not able to connect to it.' => 'This server is configured to use a notification server, but is not able to connect to it.',
