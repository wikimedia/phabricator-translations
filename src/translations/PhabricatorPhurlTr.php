...
final class PhabricatorPhurlTr
  ...
  '%s changed the alias of %s from %s to %s.' => '%s, %s diğer adını %s ile %s değiştirdi.',
  ...
  'CHANGES TO PHURL DESCRIPTION' => 'PHURL AÇIKLAMASINDAKİ DEĞİŞİKLİKLER',
  ...
  'The alias can be no longer than %d characters.' => 'Diğer ad, %d karakterden uzun olamaz.',
  'Create URL' => 'URL oluştur',
  '%s changed the name of the URL from %s to %s.' => '%s, URL\'nin adını %s ile %s değiştirdi.',
