...
final class PhabricatorCelerityTr
  ...
  'Unable to render resource "%s", which has unknown type "%s".' => '"%2$s" türü bilinmeyen kaynak "%s" oluşturulamıyor.',
  'Writing map "%s".' => 'Harita yazılıyor "%s".',
  'Done generating sprites - updating map...' => '',
  'Use High Contrast Colors' => 'Yüksek Kontrast Renkleri Kullan',
  'Use Larger Font Size' => 'Daha Büyük Yazı Tipi Boyutu Kullan',
  'Found %d binary resources.' => '%d ikili kaynak bulundu.',
  'No resource with symbol "%s" exists in source "%s"!' => '"%2$s" sembolünde hiçbir kaynak "%s" kaynağında mevcut değil!',
  'Celerity' => 'Sürat',
  ...
  'Rebuilding %s resource source(s).' => '%s kaynak kaynağı yeniden oluşturuluyor.',
  'Rebuilt "%s" syntax CSS.' => '"%s" sözdizimini CSS\'yi yeniden oluştur.',
  '`%s` not found in PATH.' => '`%s` not bulundu in PATH.',
  ...
  'Found %d text resources.' => '%d metin kaynağı bulundu.',
  'Expected file \'%s\' in \'%s\' to be a sprite source ending in \'%s\'.' => '\'%3$s\' ile biten bir sprite kaynağı olması için \'%2$s\' içindeki \'%s\' dosyası bekleniyordu.',
