...
final class PhabricatorManiphestHu
  ...
  '%s changed the point value for this task from %s to %s.' => '%s megváltoztatta a feladat pontértékét %s pontról %s pontra.',
  ...
  'Select and reorder task fields.' => 'Feladatmezők kiválasztása és átrendezése.',
  ...
  '%s edited %s revision(s), added %s: %s; removed %s: %s.' => '%s szerkesztett %s változatot, hozzáadva %s: %s; eltávolítva %s: %s.',
  'Assign task to me' => 'Feladat hozzám rendelése',
  ...
  'Search...' => 'Keresés…',
  'Task Graph' => 'Feladatdiagram',
  'Parent IDs' => 'Szülőazonosítók',
  ...
  '%s assigned %s to %s.' => '%s a(z) %s felelősévé tette %s-t.',
  'Low' => 'Alacsony',
  ...
  '%s removed %s parent task(s) for %s: %s.' => '%s eltávolította %3$s %s szülőfeladatát: %4$s.',
  ...
  'Assign to' => 'Felelős',
  '%s edited %s revision(s) for %s, added %s: %s; removed %s: %s.' => '%s szerkesztette %3$s %s változatát, hozzáadva %4$s: %5$s; eltávolítva %6$s: %7$s.',
  ...
  '%s changed the subtype of this task from "%s" to "%s".' => '%s megváltoztatta a feladat altípusát „%s” altípusról „%s” altípusra.',
