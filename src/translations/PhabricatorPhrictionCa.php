...
final class PhabricatorPhrictionCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'Overwrite Changes' => 'Sobreescriu els canvis',
      'Edit Notes' => 'Edita les notes',
      ...
      'Create This Document' => 'Crea aquest document',
      '%s deleted this document.' => '%s ha eliminat aquest document.',
      '<%s>' => '<%s>',
      'No previous change' => 'Sense canvis anteriors',
      '%s by %s' => '%s per %s',
      ...
      'Show Change' => 'Mostra el canvi',
      'Edit Conflict' => 'Edita el conflicte',
      ...
      'Hierarchy' => 'Jerarquia',
      'Edit Current Version' => 'Edita la versió actual',
