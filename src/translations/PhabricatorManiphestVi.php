...
final class PhabricatorManiphestVi
  ...
  protected function getTranslations() {
    return array(
      ...
      'NOTE: This table reflects tasks currently in the project. If a task was opened in the past but added to the project recently, it is counted on the day it was opened, not the day it was categorized. If a task was part of this project in the past but no longer is, it is not counted at all. This table may not agree exactly with the chart above.' => 'LƯU Ý: Bảng này phản ánh các nhiệm vụ hiện đang nằm trong dự án. Nếu một nhiệm vụ được tạo từ trước nhưng chỉ mới được thêm vào dự án gần đây, thì nó sẽ được tính vào ngày tạo chứ không phải ngày phân loại. Nếu một nhiệm vụ từng thuộc dự án này nhưng hiện không còn nữa, thì sẽ không được tính vào. Do đó, bảng này có thể không hoàn toàn khớp với biểu đồ bên trên.',
