...
final class PhabricatorDrydockTr
  ...
  'Repository Operation %d' => 'Depo Çalışması %d',
  'Failed to acquire slot locks: %s.' => 'Slot kilitleri alınamadı: %s.',
  'Waiting For Reclamation' => 'Geri Alma Bekleniyor',
  ...
  'Trying to acquire lease ("%s") on a resource ("%s") in the wrong status ("%s").' => 'Yanlış bir durumda ("%3$s") bir kaynakta ("%2$s") kira ("%s") almaya çalışıyor.',
  'Drydock Authorization %d' => 'Drydock Yetkilendirme %d',
  ...
  'Activation complete. Leases are permanent until manually released with:' => '',
  'Via:' => 'Üzerinden:',
  ...
  'Leases activated in %sms.' => 'Kiralar %sms içinde etkinleştirildi.',
  ...
  'Release all resources. Dangerous!' => 'Tüm kaynakları serbest bırak. Tehlikeli!',
  ...
  'Blueprints allow to lease fresh working copies of repositories, on your Drydock devices, when needed by CI/CD workflows, and more. Blueprints lease services defined in your Almanac.' => 'Planlar kiralamaya izin verir yeni çalışma kopyaları depoların, Drydock cihazlarınızda, gerektiğinde by CI/CD workflows, and more. Blueprints lease services defined in your Almanac.',
  'Lease Released' => 'Kira Yayınlandı',
  ...
  'Execute a query with identifiers before getting the identifier map.' => '',
  ...
  'No leases selected for release.' => '',
  ...
  'Waiting for daemons to activate leases...' => '',
  ...
  'Can not issue a query with an empty identifier list.' => 'Can not issue a sorgu with an boş identifier liste.',
  ...
  'No resources selected for release.' => '',
  ...
  'Blueprint "%s" (of type "%s") is not properly implemented: it built a resource of type "%s" to satisfy a lease requesting a resource of type "%s".' => 'Plan "%s" ("%s" türünde) düzgün bir şekilde uygulanmıyor: "%4$s" türünde bir kaynak talep eden bir kiralama işlemini karşılamak için "%s" türünde bir kaynak oluşturdu.',
  ...
  'Landing revision into %s on %s...' => '%2$s üzerinden %s iniş revizyonu veriliyor...',
  'Authorized' => 'Yetkilendirildi',
  'A nautical adventure.' => 'Denizcilik macerası.',
  'Search for disabled or enabled blueprints.' => 'Şunu arayın: devre dışı or etkin blueprints.',
  ...
  'When this diff was generated, the server was running an older version of the software which did not support staging areas for this version control system, so the change was not pushed to staging. Changes must be pushed to staging before they can be landed from the web.' => '',
  ...
  'Trying to activate lease ("%s") on a resource ("%s") in the wrong status ("%s").' => 'Bir kaynakta ("%2$s") yanlış durumda ("%3$s") kiralamayı ("%s") etkinleştirmeye çalışılıyor.',
  'No such lease "%s"!' => 'Böyle bir kira "%s" yok!',
  'No Repository Automation' => 'Depo Otomasyonu Yok',
  'Specify a resource type with "--type".' => 'Belirtin a resource tür with "--tür".',
