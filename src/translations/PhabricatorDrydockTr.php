...
final class PhabricatorDrydockTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'Release a lease.' => 'Bir kira yayınla.',
      ...
      'Allows Drydock to lease existing hosts defined in an Almanac service pool.' => 'Drydock\'un bir Almanac servis havuzunda tanımlanmış mevcut konakçıları kiralamasına izin verir.',
      ...
      'Release Resource' => 'Kaynağı Yayınla',
      ...
      'Drydock resource ("%s") has no Almanac binding PHID, so its binding can not be loaded.' => 'Drydock kaynağında ("%s") Almanac bağlayıcı PHID yoktur, bu nedenle bağlanması yüklenemez.',
      ...
      'Release Lease' => 'Kiralamayı Yayınla',
