...
final class PhabricatorCelerityCa
  ...
  'Found %d binary resources.' => 'S\'han trobat %d recursos binaris.',
  ...
  'Rebuilding %s resource source(s).' => 'Reconstruint %s font/s de recursos.',
  ...
  'Resource "%s" must %s at most one Celerity target.' => 'El recurs "%s" ha de tenir %s com a màxim un objectiu Celerity.',
  ...
  'Found %d text resources.' => 'S\'han trobat %d recursos de text.',
