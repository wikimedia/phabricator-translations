...
final class PhabricatorCacheJa
  ...
  protected function getTranslations() {
    return array(
      ...
      'The PHP "Zend OPcache" extension is installed, but not enabled in your PHP configuration. Enabling it will dramatically improve performance. Edit the "%s" setting to enable the extension.' => 'PHPの「Zend OPcache」拡張機能はインストールされていますが、PHPの設定では有効になっていません。これを有効にすると、パフォーマンスが大幅に向上します。「%s」設定を編集して拡張機能を有効にします。',
