...
final class PhabricatorDiffusionEn
  ...
  protected function getTranslations() {
    ...
    ',
      ...
      'Failed to parse `%s` output in %s: %s' => 'Failed to parse `%s` output in %s: %s',
    ...
    ',
      ...
      'Callsign is the monogram rXXXX for this repository. It cannot contain spaces.' => 'Callsign is the monogram rXXXX for this repository. It cannot contain spaces.',
      ...
      'Short Name is part of the URI paths for this repository. It cannot contain spaces.' => 'Short Name is part of the URI paths for this repository. It cannot contain spaces.',
    ...
    Commit rules can send email, flag commits, trigger audits, and run build plans.',
      ...
      'Copy of Repository URI failed.' => 'Copy of Repository URI failed.',
    ...
    ',
      ...
      'Copy repository URI' => 'Copy repository URI',
    ...
    ',
      ...
      'Regular expression to link external bug tracker. See https://tortoisesvn.net/docs/release/TortoiseSVN_en/tsvn-dug-bugtracker.html for further explanation.' => 'Regular expression to link external bug tracker. See https://tortoisesvn.net/docs/release/TortoiseSVN_en/tsvn-dug-bugtracker.html for further explanation.',
    ...
    Edit the repository configuration before making dangerous changes.',
      ...
      'Submodule' => 'Submodule',
      'Repository URI copied.' => 'Repository URI copied.',
    ...
    This repository ("%s") is configured with a touched files limit that caps the maximum number of paths any single commit may affect. You are pushing a change ("%s") which exceeds this limit: it affects %s paths, but the largest number of paths any commit may affect is %s paths.',
      ...
      '%s edited revision(s), added %s: %s; removed %s: %s.' => '%s edited revision(s), added %s: %s; removed %s: %s.',
      ...
      'Unexpected line count from `%s` in %s!' => 'Unexpected line count from `%s` in %s!',
      ...
      'Unexpected object type `%s` from `%s` in %s: %s' => 'Unexpected object type `%s` from `%s` in %s: %s',
    ...
    | `https://example.com/repository.git`',
      ...
      'Git-LFS Authentication required' => 'Git-LFS Authentication required',
