...
final class PhabricatorDiffusionEn
  ...
  protected function getTranslations() {
    ...
    ',
      ...
      '%s added %s reverting commit(s) for %s: %s.' => '%s added %s reverting commit(s) for %s: %s.',
      ...
      '%s edited reverting commit(s), added %s: %s; removed %s: %s.' => '%s edited reverting commit(s), added %s: %s; removed %s: %s.',
    ...
    Transcript: %s',
      ...
      '%s removed %s reverting commit(s): %s.' => '%s removed %s reverting commit(s): %s.',
    ...
    Commit rules can send email, flag commits, trigger audits, and run build plans.',
      ...
      'Autoclose?' => 'Autoclose?',
      '%s edited reverted commit(s), added %s: %s; removed %s: %s.' => '%s edited reverted commit(s), added %s: %s; removed %s: %s.',
      'Display' => 'Display',
    ...
    IMPORTANT: This feature is new, experimental, and not supported. Use it at your own risk.',
      ...
      'This password is extremely weak: it is one of the most common passwords in use. Choose a stronger password.' => 'This password is extremely weak: it is one of the most common passwords in use. Choose a stronger password.',
      ...
      '%s removed %s reverted commit(s): %s.' => '%s removed %s reverted commit(s): %s.',
    ...
    > tagged(engineering)',
      ...
      '%s removed %s reverted commit(s) for %s: %s.' => '%s removed %s reverted commit(s) for %s: %s.',
    ...
    Consider using SSH for authenticated access to repositories instead of HTTP.',
      ...
      '%s edited reverting commit(s) for %s, added %s: %s; removed %s: %s.' => '%s edited reverting commit(s) for %s, added %s: %s; removed %s: %s.',
      ...
      'The raw text of this change is enormous (larger than %d bytes). Herald can not process it.' => 'The raw text of this change is enormous (larger than %s bytes). Herald can not process it.',
    ...
    Edit the repository configuration before making dangerous changes.',
      ...
      '%s added %s reverted commit(s) for %s: %s.' => '%s added %s reverted commit(s) for %s: %s.',
      ...
      '%s added %s reverted commit(s): %s.' => '%s added %s reverted commit(s): %s.',
      ...
      'Waiting up to %s second(s) for a cluster read lock on "%s"...' => 'Waiting up to %s second(s) for a cluster read lock on "%s"...',
      ...
      'This password is the same as another password associated with your account. You must use a unique password for VCS access.' => 'This password is the same as another password associated with your account. You must use a unique password for VCS access.',
      'This repository has no tags.' => 'This repository has no tags.',
      'Pusher projects' => 'Pusher projects',
    ...
    | `https://example.com/repository.git`',
      ...
      'Not Found' => 'Not Found',
      '%s edited reverted commit(s) for %s, added %s: %s; removed %s: %s.' => '%s edited reverted commit(s) for %s, added %s: %s; removed %s: %s.',
      ...
      'Failed to load blame information for this file in %s second(s).' => 'Failed to load blame information for this file in %s second(s).',
    ...
    ' => '# Push received by "%s", forwarding to cluster host.
    ',
      '%s removed %s reverting commit(s) for %s: %s.' => '%s removed %s reverting commit(s) for %s: %s.',
      ...
      'On' => 'On',
      'Push %d' => 'Push %s',
      '%s added %s reverting commit(s): %s.' => '%s added %s reverting commit(s): %s.',
    ...
    ',
      ...
      'This commit is enormous, and affects more than %d files. Changes are not shown.' => 'This commit is enormous, and affects more than %s files. Changes are not shown.',
    ...
    You **MUST** specify the root of the repository, not a subdirectory.',
      ...
      'This file is larger than %s, so blame is disabled.' => 'This file is larger than %s, so blame is disabled.',
