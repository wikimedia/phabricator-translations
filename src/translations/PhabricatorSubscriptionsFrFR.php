...
final class PhabricatorSubscriptionsFrFR
  ...
  'Remove subscribers.' => 'Retirer des abonnés.',
  ...
  'View All %d Subscriber(s)' => 'Afficher tous les %d abonné(s)',
  ...
  'Unmute' => 'Démasquer',
  'All %d subscribers removed by %s' => 'Tous les %d abonnés enlevés par %s',
  ...
  'All %d subscribers added by %s' => 'Tous les %d abonnés ajoutés par %s',
