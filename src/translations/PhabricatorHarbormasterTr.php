...
final class PhabricatorHarbormasterTr
  ...
  'Attempt to load log bytes (%d - %d) failed: failed to load a single contiguous range. Actual ranges: %s.' => 'Günlük baytlarını yükleme girişimi (%d - %d) başarısız oldu: tek bir bitişik aralık yüklenemedi. Gerçek aralıklar: %s.',
...
' => '',
  ...
  'Build Target %d' => 'Hedef %d Oluşturun',
