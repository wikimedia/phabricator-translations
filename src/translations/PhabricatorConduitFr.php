...
final class PhabricatorConduitFr
  ...
  protected function getTranslations() {
    return array(
      ...
      'No user or device is associated with that public key.' => 'Aucun utilisateur ni appareil n’est associé avec cette clé publique.',
    ...
    Vérifiez votre syntaxe. La valeur était : %s.',
      ...
      'Conduit API Tokens' => 'Jetons d’API de Conduit',
