...
final class PhabricatorHarbormasterNl
  ...
  'Log Not Finalized' => 'Logboek niet afgerond',
  ...
  'Choose a build target to attach the log to with "--target".' => 'Kies een builddoel om het logboek aan te koppelen met "--target".',
...
\\',
  ...
  'Rebuilding log "%s"...' => 'Logboek "%s" opnieuw opbouwen...',
  ...
  'Limit the rate at which the log is written, to test live log streaming.' => 'De snelheid waarmee het logboek wordt geschreven beperken, om live logboek-streamen te testen.',
...
\\',
  ...
  'Logs must be fully written and processed before they can be downloaded. This log is still being written or processed.' => 'Logboeken moeten volledig geschreven en verwerkt zijn voordat ze kunnen worden gedownload. Dit logboek wordt nog geschreven of verwerkt.',
  '%s restarted this build.' => '%s heeft deze build herstart.',
  'Harbormaster Buildables' => 'Harbormaster-buildables',
  'Sleep' => 'Wachten',
  'Writing log, slowly...' => 'Logboek wordt langzaam geschreven...',
  ...
  'Fragment' => 'Fragment',
  'Build target this log is attached to.' => 'Builddoel waaraan dit logboek is gekoppeld.',
  ...
  'Rebuild the file and summary for a log. This is primarily intended to make it easier to develop new log summarizers.' => 'Het bestand en de samenvatting voor een logboek opnieuw opbouwen. Dit is voornamelijk bedoeld om het gemakkelijker te maken nieuwe logboeksamenvattingen te ontwikkelen.',
...
```',
  ...
  'This older log is missing required rendering data. To rebuild rendering data, run: %s' => 'Dit oudere logboek mist vereiste weergavegegevens. Voer het volgende uit om weergavegegevens opnieuw op te bouwen: %s',
...
| `HARBORMASTER_BUILD_TARGET_PHID` | PHID van het builddoel. |',
  ...
  'Length of the log in bytes.' => 'Lengte van het logboek in bytes.',
...
Als u **Wachten op bericht** selecteert, pauzeert het buildplan voor onbepaalde tijd zodra deze stap is voltooid. Om de build te hervatten moet een extern systeem `harbormaster.sendmessage` aanroepen met de builddoel-PHID, en `"pass"` of `"fail"` om het resultaat voor deze stap aan te geven. Nadat het resultaat is vastgelegd, wordt het buildplan hervat.',
  ...
  'Build Target ID to attach the log to.' => 'Builddoel-ID om het logboek aan te koppelen.',
