...
final class PhabricatorOwnersTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'Group sections of a codebase into packages for re-use in other areas of Phabricator, like Herald rules.' => 'Bir kod tabanının bölümlerini, Herald kuralları gibi Phabricator\'ın diğer alanlarında yeniden kullanılmak üzere paketler halinde gruplayın.',
      'Review Changes With Non-Owner Author' => 'Sahibi Olmayan Yazarla Değişiklikleri İncele',
      '%s renamed this package from %s to %s.' => '%s bu paketi %s ile %s yeniden adlandırdı.',
      ...
      'The repository callsign is not recognized.' => 'Depo çağrı işareti tanınmıyor.',
      ...
      'Provide one of a single owner phid (user/project), a single affiliated user phid (user), or a repository/path.' => 'Tek bir sahip sahibi phid (kullanıcı/proje), tek bir bağlı kullanıcı phid (kullanıcı) veya bir depo/yol sağlayın.',
      '[Package]' => '[Paket]',
      ...
      'Obsolete; use "owners.search" instead.' => 'Eski; bunun yerine "owners.search" kullanın.',
      'Strong' => 'Güçlü',
    ...
    %s',
      ...
      'Expected user/project PHID for owner, got %s.' => 'Beklenen kullanıcı/proje sahibi PHID, %s aldı.',
      ...
      'Package %d' => 'Paket %s',
      'Query for Owners packages. Obsoleted by "owners.search".' => 'Sahipleri paketleri için sorgu. "owners.search" tarafından iptal edildi.',
