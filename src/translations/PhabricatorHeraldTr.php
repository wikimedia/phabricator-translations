...
final class PhabricatorHeraldTr
  ...
  'Affected Objects' => 'Etkilenen Nesneler',
  ...
  'Back to Content Types' => 'İçerik Türlerine Dön',
  ...
  'Unknown view key "%s".' => 'Unknown görüntüleme anahtar "%s".',
  'A personal rule can only be edited by its author.' => 'Kişisel bir kural yalnızca yazarı tarafından düzenlenebilir.',
  ...
  'Herald Transcript %s' => 'Herald Transkripti %s',
  ...
  'This server is running in silent mode, so it will not publish webhooks. To adjust this setting, see @{config:phabricator.silent} in Config.' => 'Bu sunucu sessiz modda çalıştığı için webhook\'ları yayımlamayacaktır. Bu ayarı düzenlemek için Yapılandırma\'daki @{config:phabricator.silent} bakın.',
  ...
  'Two HeraldFields (of classes "%s" and "%s") have the same field key ("%s") after expansion for an object of class "%s" inside adapter "%s". Each field must have a unique field key.' => 'İki HeraldFields ("%s" ve "%s" sınıfları), "%5$s" adaptöründe "%4$s" sınıfı bir nesne için genişletmeden sonra aynı alan anahtarına ("%s") sahiptir. Her alanın benzersiz bir alan anahtarı olması gerekir.',
  ...
  'Webhook Request %d' => 'Webhook İsteği %d',
  ...
  'No field with key "%s" is available to Herald adapter "%s".' => 'Herald adaptör "%2$s" için "%s" anahtarlı alan yok.',
  ...
  'This rule has a recursive dependency on itself and can not be evaluated.' => '',
  ...
  'Apply changes to this rule.' => 'Bu kurala değişiklikleri uygula.',
  'false' => 'false',
  ...
  'An unknown error occurred while evaluating this condition. No additional information is available.' => '',
  ...
  'Make a total of __N__ copies of the call.' => 'Çağrının toplam __N__ kopyasını oluştur.',
  ...
  'Many requests to this webhook have failed recently (at least %s errors in the last %s seconds). New requests are temporarily paused.' => 'Bu webhook\'a yapılan birçok istek son zamanlarda başarısız oldu (son %2$s\'de en az %s hata). Yeni istekler geçici olarak duraklatıldı.',
  'Call webhooks' => 'Webhook\'ları arayın',
  'Another Herald rule' => 'Başka bir Herald kuralı',
  'include none of' => 'hiçbirini dahil etme',
  ...
  'No action with key "%s" is available to Herald adapter "%s".' => '"%2$s" anahtar kelimesi Herald bağdaştırıcısı için "%s" anahtar kelimesiyle işlem yapılamaz.',
  ...
  'Herald Actions' => 'Kural İşlemleri',
  'No active Herald rules call this webhook.' => '',
  ...
  'Already Applied' => 'Zaten Uygulandı',
  ...
  'Rule failed automatically because it is a personal rule and its author is invalid or disabled.' => 'Rule başarısız automatically because it a personal kural and its yazar ingeçerli or devre dışı.',
  ...
  'This rule has a dependency cycle and can not be evaluated:' => '',
  ...
  'An exception occurred executing Herald rule %s: "%s" Review the Herald transcripts and correct or disable the problematic rule.' => '',
  ...
  'This rule was created with a newer version of Herald. You can not view or edit it in this older version. Upgrade your software.' => 'Bu kural, Herald\'ın daha yeni bir sürümü ile oluşturuldu. Bu eski sürümde görüntüleyemez veya düzenleyemezsiniz. Yazılımınızı yükseltin.',
  'Called By Herald Rules' => 'Kurallar Tarafından Çağrılan',
  ...
  'Herald rule "%s" already has an evaluation result.' => 'Herald kural "%s" already an evaluation sonuç.',
  'This rule will no longer activate.' => 'Bu kural artık aktif olmayacak.',
  'Specify a rule to edit with "--rule <id|monogram>".' => 'Belirtin a kural to düzenleme with "--kural <id|monogram>".',
  'is false' => 'yanlış',
