...
final class PhabricatorCelerityNl
  ...
  'Found %d binary resources.' => array(
    'Er is %d binaire bron gevonden.',
    'Er zijn %d binaire bronnen gevonden.',
  ),
  ...
  'Rebuilding %s resource source(s).' => array(
    'Herbouwen van %s bron.',
    'Herbouwen van %s bronnen.',
  ),
  ...
  'Found %d text resources.' => array(
    'Er is %d tekstbron gevonden.',
    'Er zijn %d tekstbronnen gevonden.',
  ),
  ...
  'Found %d packages.' => array(
    '%d pakket gevonden.',
    '%d pakketten gevonden.',
  ),
);
  }
