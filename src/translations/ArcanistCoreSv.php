...
final class ArcanistCoreSv
  ...
  protected function getTranslations() {
    return array(
      ...
      'Night has fallen. The moon overhead is waxing, and provides just enough light that you can make out your surroundings. It is quite cold.' => 'Natten har fallit. Månen ovanför vaxar och ger precis tillräckligt med ljus för att man ska kunna urskilja sin omgivning. Det är ganska kallt.',
    ...
    Använd \'%s\' för att välja en ändring.',
      ...
      'Load a library.' => 'Läs in ett bibliotek.',
      ...
      'List of command aliases.' => 'Lista över kommandalias.',
    ...
    ' => '    %s %s',
      ...
      'Constants should be uppercase.' => 'Konstanter bör vara i versaler.',
      ...
      'Updating library: %s' => 'Uppdatera bibliotek: %s',
      'File Error' => 'Filfel',
