...
final class ArcanistCoreSv
  ...
  'Call to "posix_getpgid(...)" failed!' => 'Anrop till "posix_getpgid(...)" misslyckades!',
  'The "squash" strategy collapses multiple local commits into a single commit when publishing. It produces a linear published history (but discards local checkpoint commits). This is the default strategy.' => 'Strategin "squash" komprimerar flera lokala commits till en enda commit vid publicering. Den genererar en linjär publiceringshistorik (men ignorerar lokala checkpoint-commits). Detta är standardstrategin.',
  '"%s" (%s)' => '"%s" (%s)',
...
Använd \'%s\' för att välja en version.',
  ...
  'HTTP Status Code: %d' => 'HTTP-statuskod: %d',
...
' => '    %s (%s) %s',
  ...
  'Unable to connect socket! Error #%d: %s' => 'Kunde inte ansluta socket! Fel nr. %d: %s',
...
' => 'Skriver "%s" till "%s"...',
  ...
  'Data has fewer than %d lines.' => 'Data har förre än %d rader.',
