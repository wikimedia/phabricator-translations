...
final class ArcanistCoreSv
  ...
  protected function getTranslations() {
    return array(
      ...
      'Shortening of %s' => 'Nedkortning av %s',
    ...
    För mer information, se instruktionerna i "%s".',
      ...
      'Set locale to en_GB.' => 'Ändra språk till en_GB.',
    ...
    Använd \'%s\' för att välja en ändring.',
      ...
      'This test doesn\'t work on Windows.' => 'Det här testet fungerar inte på Windows.',
    ...
    ' => '    %s %s',
      ...
      'Argument name \'%s\'.' => 'Argumentnamn "%s".',
