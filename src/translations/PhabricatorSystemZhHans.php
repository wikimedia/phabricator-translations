...
final class PhabricatorSystemZhHans
  ...
  protected function getTranslations() {
    ...
    ' => '正在销毁%s **%s**...',
      ...
      '%d / hour' => '%s/小时',
      'This may happen if there is a temporary network anomaly on the server side, like cosmic radiation or spooky ghosts. If this failure was caused by a transient service interruption, Phabricator will recover momentarily.' => '如果服务器端出现暂时性的网络异常，比如受到宇宙辐射或幽灵的影响，则可能会出现这种情况。如果这种故障是由短暂的服务中断造成的，Phabricator会马上恢复。',
    ...
    这些破损的边缘是破坏物体的预期后果，Phabricator上游无法帮助您修复它们。 我们强烈建议您禁用或存档对象。',
      ...
      'Phabricator will periodically retry the connection and recover once service is restored. Most causes of persistent service interruption will require administrative intervention in order to restore service.' => 'Phabricator将定期重试连接，一旦服务恢复后将恢复正常。大多数持续服务中断的原因都需要管理员干预才能恢复服务。',
