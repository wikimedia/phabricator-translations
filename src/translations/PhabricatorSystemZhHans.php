...
' => '正在销毁%s **%s**...',
  ...
  'Object ("%s") does not implement interface "%s", so this type of object can not be unlocked.' => '对象“%s”未实现接口“%s”，因此此类对象无法解锁。',
...
这些副作用是销毁对象的预期后果，上游无法帮助您修复它们。我们强烈建议您改为禁用或存档对象。',
  ...
  'Object owner can not be unlocked: the unlocking engine ("%s") for this object does not implement an owner unlocking mechanism.' => '对象所有者无法解锁：该对象的解锁引擎（“%s”）未实现所有者解锁机制。',
  ...
  'This mode is active because no database has a "%s" role in the configuration option "%s".' => '此模式已激活，因为在配置选项“%2$s”中没有数据库有“%s”角色。',
  ...
  'Object view policy can not be unlocked because this object does not have a mutable view policy.' => '对象视图策略无法解锁，因为该对象不具备可变视图策略。',
