...
final class PhabricatorPeopleTr
  ...
  'Approves a user.' => 'Bir kullanıcıyı onaylar.',
  'View Activity Log' => 'Etkinlik Günlüğünü Görüntüle',
  'Send Invitations' => 'Davetiye Gönder',
  'Confirm Approval' => 'Onayı Onayla',
  'MediaWiki username.' => 'MediaWiki kullanıcıad.',
  'User account to act on.' => 'İşlemin yapılacağı kullanıcı hesabı.',
  '[%s] Account Login Link' => '[%s] Hesap Giriş Bağlantısı',
  ...
  'Musician' => 'Müzisyen',
  '[%s] Account Password Link' => '[%s] Hesap Parolası Bağlantısı',
  'Make real names required' => 'Gerekli gerçek isimleri yap',
  'Already Approved' => 'Zaten Onaylandı',
  'Authored Commits' => 'Yazılan Commitler',
...
' => 'Hesabınızda bir şifre belirlemek için bu bağlantıyı kullanabilirsiniz:
  ...
  '[%s] Username Changed' => '[%s] Kullanıcı Adı Değiştirildi',
  'Create Mailing List User' => 'Posta Listesi Kullanıcısı Oluştur',
  '[%s] Primary Address Changed' => '[%s] Birincil Adres Değiştirildi',
...
%s',
  ...
  'After you have set a password, you can log in again in the future by going here:' => 'Parolanızı belirledikten sonra, ileride tekrar oturum açmak için şuraya gidebilirsiniz:',
...
%s' => '',
  ...
  'Send "Welcome to %s" email with login instructions.' => 'Giriş talimatlarını içeren "%s Sitesine Hoş Geldiniz" e-posta gönder.',
  ...
  '[%s] Welcome to %s' => '[%s] %s Sitesine Hoş Geldiniz',
  'Email: Remove Address' => 'E-posta: Adresi Kaldır',
  'New username cannot be the old username.' => 'New kullanıcıad cannot be the old kullanıcıad.',
  ...
  'Received Badges' => 'Alınan Rozetler',
...
Bununla birlikte, bu işlevi kullanarak bir sorguyu kaydederseniz ve başka birine gönderirseniz, yazılanlar //kendi// kullanıcı adları gibi çalışır. Bu, onlara bakan kullanıcıya her zaman ilgili bilgileri gösteren pano panelleri oluşturmak için yararlı olabilir.',
  ...
  'Enable %s? They will be able to access this server and receive email again.' => '%s etkinleştirilsin mi? Bu sunucuya erişebilecek ve tekrar e-posta alabilecekler.',
  ...
  'It is generally safe to rename users, but changing usernames may create occasional minor complications or confusion with text that contains the old username.' => 'Kullanıcı adlarını değiştirmek genellikle güvenlidir, ancak eski kullanıcı adını içeren metinlerde küçük komplikasyonlara veya karışıklığa neden olabilir.',
  'User Profile' => 'Kullanıcı Profili',
  'You can use this login link to regain access to your account:

  %s
' => 'Hesabınıza tekrar erişmek için bu giriş bağlantısını kullanabilirsiniz:
  ...
  'To log in, follow this link and set a password:' => 'Oturum açmak için bu bağlantıyı takip edin ve bir parola belirleyin:',
  'Remove %s as an administrator? They will no longer be able to perform administrative functions on this server.' => '%s yönetici olarak kaldırılsın mı? Bu sunucuda artık idari işlevleri gerçekleştiremeyecekler.',
  ...
  'message' => 'mesaj',
  'This email address (%s) is no longer your primary email address. Going forward, all email will be sent to your new primary email address (%s).' => 'Bu e-posta adresi (%s) artık birincil e-posta adresiniz değil. Bundan sonra tüm e-postalar yeni birincil e-posta adresinize (%s) gönderilecektir.',
  'The user will receive an email notifying them that you changed their username.' => 'Kullanıcı, kullanıcı adının değiştirildiğine dair bir e-posta bildirimi alacaktır.',
  ...
  '%s renamed this user.' => '%s readd this kullanıcı.',
  ...
  'This is now your primary email address (%s). Going forward, all email will be sent here.' => 'Bu şimdi birincil e-posta adresinizdir (%s). Bundan sonra tüm e-postalar buraya gönderilecek.',
  ...
  '[%s] Email Verification' => '[%s] E-posta Doğrulama',
  'Empower %s as an administrator? They will be able to create users, approve users, make and remove administrators, delete accounts, and perform other administrative functions on this server.' => '%s bir yönetici olarak yetkilendirilsin mi? Bu sunucuda kullanıcılar oluşturabilir, kullanıcıları onaylayabilir, yöneticileri yapıp kaldırabilir, hesapları silebilir ve diğer yönetim işlevlerini gerçekleştirebilirler.',
  ...
  'Authored Revisions' => 'Yazılan Revizyonlar',
  ...
  %s
' => 'Parolanızı sıfırlamak için bu bağlantıyı kullanabilirsiniz:
  ...
  'Your %s account (%s) has been approved by %s. You can login here:' => '%s hesabınız (%s) %s tarafından onaylandı. Buradan oturum açabilirsiniz:',
  ...
  'To invite users, enter their email addresses below. Separate addresses with commas or newlines.' => 'Kullanıcıları davet etmek için e-posta adreslerini aşağıya girin. Adresleri virgül veya yeni satırlarla ayırın.',
  'If you rename this user, the old username will no longer be tied to the user account. Anything which uses the old username in raw text (like old commit messages) may no longer associate correctly.' => 'Bu kullanıcının adını değiştirirseniz, eski kullanıcı adı artık bu hesaba bağlı olmayacaktır. Eski kullanıcı adını düz metin olarak kullanan her şey (eski commit mesajları gibi) artık doğru şekilde ilişkilendirilemeyebilir.',
  'Activity Log %d' => 'Etkinlik Günlüğü %d',
...
Botlar normalde e-posta almasalar da, e-posta adresi gerektiren diğer sistemlerle etkileşime girebilirler. Örnekler şunları içerir:
  ...
  - Hesap adına bu sunucuya e-posta gönderirseniz, adres göndereni tanımlayabilir.
...
Adres otomatik olarak doğrulanacaktır, bu nedenle bu adreste posta alabilmeniz gerekmez ve eğer istersen `bot@yourcompany.com` gibi bazı geçersiz veya var olmayan (ancak doğru biçimlendirilmiş) bir adres girebilirsiniz.',
  'No authored tasks.' => 'Yazılan görev yok.',
...
%s',
  ...
  '%s Account "%s" Approved' => '%s Hesabı "%s" Onaylandı',
  'Find users whose usernames or real names contain a substring.' => 'Find kullanıcıs whose kullanıcıads or real ads contain a subdize.',
  ...
  'Hide Disabled Accounts' => 'Devre Dışı Bırakılmış Kullanıcıları Gizle',
  'Disable Account' => 'Kullanıcıyı Devre Dışı Bırak',
  ...
  'Activity Log ID: #%d' => 'Etkinlik Günlüğü IDsi: #%d',
  ...
  'Allow %s to access this server?' => '%s bu sunucuya erişmesine izin verilsin mi?',
  ...
  'Create a standard user account. These users can log in, use the web interface and API, and receive email.' => 'Standart bir kullanıcı hesabı oluşturun. Bu kullanıcılar oturum açabilir, web arayüzünü ve API\'yi kullanabilir ve e-posta alabilir.',
  ...
  'Select a user account to act on with "--user <username>".' => 'Seçin a kullanıcı account to act on with "--kullanıcı <kullanıcıad>".',
  'Hi %s' => 'Merhaba %s',
...
documentation.' => 'List of özel alans for kullanıcı prodosyas.

For details on adding new alans, see [[ %s | %s ]] in the
belgeation.',
  ...
  'After you set up your account, you can log in again in the future by going here:' => 'Hesabınızı oluşturduktan sonra, gelecekte buraya tıklayarak tekrar oturum açabilirsiniz:',
  'Approve Account' => 'Hesabı Onayla',
  'Email has not been created yet!' => 'E-posta henüz oluşturulmadı!',
  'Disable User Account?' => 'Kullanıcıyı Devre Dışı Bırakılsın mı?',
...
%s',
  ...
  'User Account is Disabled' => 'Kullanıcı Devre Dışı',
  ...
  'Disable %s? They will no longer be able to access this server or receive email.' => '%s devre dışı bırakılsın mı? Artık bu sunucuya erişemeyecek veya e-posta alamayacaklar.',
  'Invites' => 'Davetler',
  ...
  'Show Only Disabled Accounts' => 'Yalnızca Engelli Kullanıcıları Göster',
  ...
  '%s (%s) has changed your %s username.' => '%s (%s), %s kullanıcı adınızı değiştirdi.',
