...
' => 'Hesabınıza tekrar erişmek için bu giriş bağlantısını kullanabilirsiniz:
  ...
  'Usernames must contain only numbers, letters, period, underscore, and hyphen, and can not end with a period. They must have no more than %d characters.' => 'Kullanıcı adları yalnızca rakam, harf, nokta, alt çizgi ve kısa çizgi içermeli ve nokta ile bitemez. %d\'dan fazla karakter içermemelidir.',
