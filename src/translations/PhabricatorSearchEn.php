...
final class PhabricatorSearchEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Query: %s' => 'Query: %s',
      'Query is too long (%s bytes, maximum is %s bytes). Please use more specific search criteria.' => 'Query is too long (%s bytes, maximum is %s bytes). Please use more specific search criteria.',
    ...
    This API endpoint supports these constraints:',
      ...
      'Use the application-specific Advanced Search for better results and additional search criteria: %s, %s. (%s)' => 'Use the application-specific Advanced Search for better results and additional search criteria: %s, %s. (%s)',
    ...
    These attachments are available:',
      'Excluding Search' => 'Excluding Search',
      ...
      'Query has too many search tokens (%s tokens, maximum is %s tokens). Please use more specific search criteria.' => 'Query has too many search tokens (%s tokens, maximum is %s tokens). Please use more specific search criteria.',
      ...
      'Browse Item Types' => 'Browse Item Types',
      'NOTE' => 'NOTE',
    ...
    These low-level columns are available:',
      ...
      'System Saved Queries' => 'System Saved Queries',
