...
final class PhabricatorSearchEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Compilation of query: %s' => 'Compilation of query: %s',
      'Readable' => 'Readable',
    ...
    This API endpoint supports these constraints:',
      ...
      'Corpus stem of: %s' => 'Corpus stem of: %s',
    ...
    These are the fields available on this object type:',
      ...
      'Stemmed compilation of query: %s' => 'Stemmed compilation of query: %s',
    ...
    These builtin orders are available:',
      ...
      'Token stem of "%s".' => 'Token stem of "%s".',
