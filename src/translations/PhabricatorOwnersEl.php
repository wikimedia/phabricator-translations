...
final class PhabricatorOwnersEl
  ...
  protected function getTranslations() {
    return array(
      ...
      'Parameter should be a phid.' => 'Η παράμετρο πρέπει να είναι ένα phid.',
      ...
      'Review Changes' => 'Θεώρηση αλλαγών',
      ...
      'Obsolete; use "owners.search" instead.' => 'Απαρχαιωμένο, χρησιμοποιήστε το "owners.search" αντί γι\'αυτού.',
      'Strong' => 'Δυνατό',
      ...
      'Subscribe to Changes' => 'Συνδρομή στις αλλαγές',
