...
final class PhabricatorTransactionsFr
  ...
  protected function getTranslations() {
    return array(
      ...
      'Export the data selected by this query.' => 'Exporter les données sélectionnées par cette requête.',
      ...
      'Output path already exists. Use "--overwrite" to overwrite it.' => 'Le chemin de sortie existe déjà. Utiliser «  --overwrite  » pour le substituer.',
      ...
      'Specify a search engine class to export data from with "--class".' => 'Spécifiez une classe de moteurs de recherche pour en faire l\'exportation avec « --class ».',
      ...
      'SearchEngine class ("%s") is unknown.' => 'La classe de moteur de recherche (« %s ») est inconnue.',
      ...
      'Specify a query to export with "--query".' => 'Spécifier une requête pour exporter avec « --query ».',
      ...
      'Failed to load saved query ("%s").' => 'Echec au chargement de requête sauvegardée (« %s »).',
      ...
      'Flag "--overwrite" has no effect without "--output".' => 'L\'option « --overwrite » n\'a pas d\'effet sans  « --output ».',
