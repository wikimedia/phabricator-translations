...
%s',
  ...
  'Account Email %d' => 'Correu electrònic del compte %d',
  'Ready' => 'Preparat',
...
Podeu utilitzar les claus de prova per afegir aquest proveïdor en mode de prova, o les claus en directe per acceptar pagaments en directe.',
  ...
  'You can view this account because you control %d merchant(s) it has a relationship with: %s.' => 'Podeu veure aquest compte perquè controleu %d venedors amb: %s.',
