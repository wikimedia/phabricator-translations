...
final class PhabricatorPholioEl
  ...
  '%s added %d image(s): %s.' => 'Ο %s πρόσθεσε %d εικόνα(-ες): %s.',
  ...
  '%s removed %d image(s): %s.' => 'Ο %s αφαίρεσε %d εικόνα(-ες): %s.',
  'Undo' => 'Αναίρεση',
  'Pholio' => 'Pholio',
  ...
  '%s edited image(s), added %d: %s; removed %d: %s.' => 'Ο %s επεξεργάστηκε τις εικόνα(-ες), πρόσθεσε τις: %d, %s, αφαίρεσε τις: %d, %s.',
);
  }
