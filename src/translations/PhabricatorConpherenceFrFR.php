...
final class PhabricatorConpherenceFrFR
  ...
  protected function getTranslations() {
    return array(
  '%s edited participant(s), added %d: %s; removed %d: %s.' => '%s participant(s) modifié(s) ; %d ajouté(s) : %s ; %d retiré(s) : %s.',
  ...
  '%s added %d participant(s): %s.' => array(
    ...
    array(
      '%s a ajouté %d participant : %s.',
      '%s a ajouté %d participants : %s.',
    ),
  ),
  ...
  '%s removed %d participant(s): %s.' => array(
    ...
    array(
      '%s a retiré %d participant : %s.',
      '%s a retiré %d participants : %s.',
    ),
  ),
