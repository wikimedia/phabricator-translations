...
final class PhabricatorPhrictionTr
  ...
  protected function getTranslations() {
    return array(
      'The path to the document.' => 'Belge yolu',
      'No such document.' => 'Böyle bir belge yok.',
      'Edit Older Version %s...' => 'Eski Sürümü Düzenle %s...',
      'DOCUMENT DIFF' => 'BELGE FARKI',
      'This document was moved from %s.' => 'Bu doküman %s\'dan taşındı.',
      ...
      'Version %d of %d: ' => '%s\'den %s sürümü:',
      'DOCUMENT CONTENT' => 'BELGE İÇERİĞİ',
      'EDIT NOTES' => 'DÜZENLEME NOTLARI',
      'Missing Ancestor' => 'Kayıp Ata',
      'This document has been moved to %s. You can edit it to put new content here, or use history to revert to an earlier version.' => 'Bu doküman %s’e taşındı. Buraya yeni içerik koymak için düzenleyebilir veya önceki bir sürüme dönmek için geçmişi kullanabilirsiniz.',
      'Retrieve information about a Phriction document.' => 'Bir Phriction dokümanı hakkında bilgi edinin.',
      ...
      'Can Not Delete Document!' => 'Belgeyi Silemiyor!',
      'No parent/ancestor paths specified.' => 'Üst/ata yolu belirtilmedi.',
      'Unknown URI type \'%s\'!' => 'Bilinmeyen URI türü \'%s\'!',
      'Document path "%s" is not a valid path. The normalized form of this path is "%s".' => '"%s" belge yolu geçerli bir yol değil. Bu yolun normalleştirilmiş formu "%s"\'dir.',
      'Stubbed' => 'Taslaklandı',
      'There is no document here, but you may create it.' => 'Burada belge yok, ancak oluşturabilirsiniz.',
      'Edit Notes' => 'Düzenleme Notları',
      'Phriction Wiki Document' => 'Phriktion Wiki Belgesi',
      ...
      'To edit a wiki document, you must also be able to view all of its ancestors.' => 'Bir wiki belgesini düzenlemek için, tüm atalarını görüntüleyebilmelisiniz.',
      ...
      'Edit this Document' => 'Bu Dokümanı Düzenle',
      'Document History: %s' => 'Belge Geçmişi: %s',
      'Ancestor Paths' => 'Ata Yolları',
      'To view a wiki document, you must also be able to view all of its ancestors. The most-restrictive view policy of this document\'s ancestors is "%s".' => 'Bir wiki belgesini görüntülemek için, tüm atalarını da görüntüleyebilmeniz gerekir. Bu belgenin atalarının en kısıtlayıcı görünümü politikası "%s"\'dir.',
      'Wiki Documents' => 'Wiki Belgeleri',
      ...
      'Document this content is for.' => 'Bu içeriğin belgesini',
      ...
      '%s published a new version of %s.' => '%s, %s\'in yeni bir versiyonunu yayınladı.',
      'No such document exists.' => 'Böyle bir belge yok.',
      'Edit Existing Document?' => 'Mevcut Belgeyi Düzenlensin mi?',
      'Read information about Phriction documents.' => 'Phriction belgeleriyle ilgili bilgileri okuyun.',
      ...
      'CHANGES TO DOCUMENT CONTENT' => 'BELGE İÇERİĞİ DEĞİŞİR',
      '%s moved %s from %s' => '%s, %s’yi %s’e taşıdı',
      ...
      '%s moved %s to %s.' => '%s, %s\'den %s\'e taşındı.',
      ...
      'The path you entered (%s) is not a valid wiki document path. Paths may not contain spaces or special characters.' => 'Girdiğiniz yol (%s) geçerli bir wiki belgesi yolu değil. Yollar boşluk veya özel karakterler içeremez.',
      'View Draft Version' => 'Taslak Sürümü Görüntüle',
      'Edit Conflict' => 'Çakışmayı Düzenle',
      ...
      'Version %s vs %s' => 'Sürüm %s vs %s',
      '%s edited the content of this document.' => '%s, bu dokümanın içeriğini düzenledi.',
      ...
      'Parent Paths' => 'Ana Yollar',
      '%s published a new version of this document.' => '%s, bu dokümanın yeni bir versiyonunu yayınladı.',
      ...
      '%s changed the title from %s to %s.' => '%s, başlığı %s\'den %s\'e değiştirdi.',
      'Publish Older Version?' => 'Eski Sürüm Yayınlansın mı?',
      '%s moved this document from %s' => '%s, bu belgeyi %s\'den taşıdı',
      'Hierarchy' => 'Hiyerarşi',
      ...
      'Read information about Phriction document history.' => 'Phriction belge geçmişi hakkında bilgi okuyun.',
      'Test rules which run when a wiki document is created or updated.' => 'Bir wiki belgesi oluşturulduğunda veya güncellendiğinde çalışan test kuralları.',
      ...
      'You are viewing an older version of this document, as it appeared on %s.' => '%s’de göründüğü gibi, bu dokümanın daha eski bir sürümünü görüntülüyorsunuz.',
      'Status information about the document.' => 'Belge ile ilgili durum bilgisi.',
      'React to wiki documents being created or updated.' => 'Oluşturulan veya güncellenen wiki belgelerine tepki verin.',
      ...
      'This document has been deleted. You can edit it to put new content here, or use history to revert to an earlier version.' => 'Bu doküman silindi. Buraya yeni içerik koymak için düzenleyebilir veya önceki bir sürüme dönmek için geçmişi kullanabilirsiniz.',
      'Wiki Document %d' => 'Wiki Belgesi %s',
      'Move Away' => 'Uzaklaş',
    );
  }
