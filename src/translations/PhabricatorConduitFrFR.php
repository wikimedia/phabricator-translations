...
final class PhabricatorConduitFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'Use form-encoded data to submit parameters to Conduit endpoints. Sending a JSON-encoded body and setting \'Content-Type\': \'application/json\' is not currently supported.' => 'Utilisez les données encodées de formulaire pour soumettre les paramètres aux points de terminaison de Conduit. L\'envoi d\'un contenu encodé JSON avec \'Content-Type\': \'application/json\' n\'est pas pris en charge actuellement.',
