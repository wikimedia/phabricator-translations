...
final class PhabricatorConduitFrFR
  ...
  protected function getTranslations() {
    ...
    Vérifiez votre syntaxe. La valeur était : %s.',
      ...
      'Caller' => 'Appelant',
      'This request originates from outside of the cluster address range. Requests signed with cluster API tokens must originate from within the cluster.' => 'Cette requête provient d’en dehors de la plage d’adresses de la grappe Phabricator. Les requêtes signées avec les jetons de l’API de a grappe doivent provenir de l’intérieur de la grappe.',
      ...
      'Your \'%s\' client version is \'%d\', which is newer than the server version, \'%d\'. Upgrade your server.' => 'Votre version de client \'%s\' est \'%s\', qui est plus récente que la version du serveur, \'%s\'. Mettez à jour votre installation de Phabricator.',
      ...
      'This request originates from outside of the cluster address range. Requests signed with trusted device keys must originate from within the cluster.' => 'Cette requête provient d’une adresse en dehors de la plage d’adresses de la grappe de Phabricator. Les requêtes signées avec des clés de confiance d’appareil  doivent provenir de l’intérieur de la grappe.',
      ...
      'Show old methods which will be deleted in a future version of this software.' => 'Afficher les anciennes méthodes qui seront supprimées dans une prochaine version de Phabricator.',
    );
  }
