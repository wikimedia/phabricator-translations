...
final class PhabricatorConduitFrFR
  ...
  protected function getTranslations() {
    ...
    Vérifiez votre syntaxe. La valeur était : %s.',
      ...
      'Your \'%s\' client version is \'%d\', which is newer than the server version, \'%d\'. Upgrade your server.' => 'La version de votre client « %s » est « %s », qui est plus récente que la version du serveur, « %s ». Mettez à niveau votre serveur.',
