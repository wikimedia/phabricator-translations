...
final class PhabricatorSearchEsES
  ...
  protected function getTranslations() {
    return array(
      ...
      'INDEXING' => 'INDEXANDO',
      'Query: %s' => 'Consulta: %s',
      'Personal Saved Queries' => 'Consultas personales guardadas',
      'Queries' => 'Consultas',
      'No services need initialization.' => 'Ningún servicio necesita inicializarse.',
      'Add New Menu Item...' => 'Agregar nuevo elemento del menú...',
      ...
      'Edit Menu Item: %s' => 'Editar elemento del menú: %s',
      ...
      'Configure Menu' => 'Configuración del menú',
      ...
      'Current Menu Items' => 'Elementos del menú actual',
      ...
      'No saved queries.' => 'No hay consultas guardadas.',
      ...
      'SELECT' => 'SELECCIONAR',
      'This menu currently has no items.' => 'Este menú actualmente no tiene elementos.',
