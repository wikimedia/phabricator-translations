...
final class PhabricatorPackagesEl
  ...
  protected function getTranslations() {
    return array(
      ...
      'This engine is used to edit Packages versions.' => 'Αυτή η μηχανή χρησιμοποιείται για την επεξεργασία εκδόσεων Πακέτων.',
      ...
      'This engine is used to edit Packages packages.' => 'Αυτή η μηχανή χρησιμοποιείται για την επεξεργασία πακετών Πακέτων.',
      'You must select a package when creating a version' => 'Πρέπει να επιλέξετε ένα πακέτο όταν δημιουργείτε μια έκδοση',
      ...
      'Unique key to identify the publisher.' => 'Μοναδικό κλειδί για την αναγνώριση του εκδότη.',
      'Search for versions by name substring.' => 'Αναζήτηση για εκδόσεις ανά υποσυμβολοσειρά ονόματος.',
