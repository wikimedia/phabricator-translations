...
final class PhabricatorSettingsNb
  ...
  protected function getTranslations() {
    return array(
      ...
      'Your new password is too short.' => 'Den nye passordet er for kort.',
      'Minimum password length: %d characters.' => 'Minste passordlengde: %s tegn.',
      ...
      'Edit Settings (%s)' => 'Redigeringsinnstillinger (%s)',
      ...
      'Your new password is very weak: it is one of the most common passwords in use. Choose a stronger password.' => 'Det nye passordet ditt er veldig svakt: det er et av de vanligste passordene som brukes. Velg et sterkere passord.',
      'User Preferences' => 'Brukerinnstillinger',
      'No Sounds' => 'Ingen lyder',
      'Two settings panels share the same panel key (\'%s\'): %s, %s.' => 'To innstillingspaneler har samme panelnøkkel («%s»): %s, %s.',
      'Unknown Account ("%s")' => 'Ukjent konto («%s»)',
