...
final class PhabricatorSubscriptionsCa
  ...
  'View All %d Subscriber(s)' => 'Mostra el(s) %d subscriptor(s)',
  ...
  'All %d subscribers removed by %s' => 'Tots els subscriptors %d s\'han eliminat per %s',
  ...
  'All %d subscribers added by %s' => 'Tots els subscriptors %d afegits per %s',
...
Users who are CC\'d on the email itself are also automatically subscribed if their addresses are associated with a known account.' => 'Afegeix un o més subscriptors a l\'objecte. Pots afegir usuaris proporcionant els seus noms d\'usuari, o afegir projectes afegint els seus hashtags. Per exemple, utilitza `%s` per afegir l\'usuari `alincoln` i el projecte amb el hashtag `#ios` com a subscriptors.
