...
final class PhabricatorSpacesTr
  ...
  protected function getTranslations() {
    return array(
      ...
      '(This error generally indicates that %s is enabled, but there are no spaces with a "%s" view policy. These settings are contradictory and imply a misconfiguration.)' => '(Bu hata genellikle %s’in etkin olduğunu gösterir, ancak "%s" görünüm politikasına sahip hiçbir boşluk yoktur. Bu ayarlar çelişkilidir ve yanlış bir yapılandırma anlamına gelir.)',
      'Spaces User Guide' => 'Kullanıcı Alan Kılavuzu',
      ...
      '%s renamed space %s from %s to %s.' => '%s, %s\'dan %s\'e kadar %s alan değiştirdi.',
      ...
      'CHANGES TO SPACE DESCRIPTION' => 'AÇIKLAMA ALANINDA DEĞİŞİR',
      ...
      '%s created this space.' => '%s bu alanı yarattı.',
      'Space %s: %s' => 'Alan %s: %s',
      'No Access to Spaces' => 'Alanlara Erişim Yok',
      '%s renamed this space from %s to %s.' => '%s, bu alanı %s ile %s arasında yeniden adlandırdı.',
