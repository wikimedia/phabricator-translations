...
final class PhabricatorProjectTr
  ...
  protected function getTranslations() {
    return array(
      'Browse Not Tagged With Any Projects' => 'Herhangi Bir Projeyle Etiketlenmemiş Gözat',
      ...
      '%s set this project\'s color to %s.' => '%s bu projenin rengini %s olarak ayarlardı.',
      '%s created this column.' => '%s bu sütunu oluşturdu.',
      'Type any(<project>) or not(<project>)...' => 'Herhangi bir(<proje>) veya yazmayın(<proje>)...',
      '%s added %s member(s) for %s: %s.' => '%s, %3$s: %4$s için %2$s üye ekledi.',
      ...
      'Find results with only the specified tags.' => 'Sadece belirtilen etiketlerle sonuçları bulun.',
      'Find results in any of a user\'s projects.' => 'Bir kullanıcının projelerinden herhangi birinde sonuçları bulun.',
      '%s added %d project hashtag(s): %s.' => '%s, %s projesi hashtag ekledi: %s.',
      ...
      '%s updated the image for %s from %s to %s.' => '%s, görüntüyü %s\'den %s\'den %s\'e güncelledi.',
      ...
      '%s changed %s hashtag(s), added %d: %s; removed %d: %s.' => '%s, %s hashtag değiştirdi, %s: %s ekledi; %s: %s kaldırıldı.',
      ...
      'Additional project slugs.' => 'Ek proje sluglar.',
      ...
      '%s edited project(s), added %s: %s; removed %s: %s.' => '%s düzenlenmiş proje, %s ekledi: %s; %s kaldırıldı: %s.',
      ...
      'Browse User Projects' => 'Kullanıcı Projelerine Göz Atın',
    ...
    Detaylar için [[ %s | Projeler Kullanım Kılavuzu]] bakınız. Bu işlem geri alınamaz.',
      'Parent' => 'Üst',
      ...
      'Project membership changes.' => 'Proje üyeliği değişiyor.',
      ...
      'Removed %s project(s): %s.' => '%s proje kaldırıldı: %s.',
      ...
      'Edit Project: %s' => 'Proje Düzenle: %s',
      'Joinable By' => 'Eklenebilir',
      ...
      'Source Workboard Has No Columns' => 'Kaynak Tezgahı Sütun Yok',
      ...
      'Parent Projects' => 'Ortak Projeler',
      'Type a user, project name, or function...' => 'Bir kullanıcı, proje adı veya işlev yazın...',
      '%s set the color for %s to %s.' => '%s, rengi %s\'den %s olarak ayarlar.',
      'Browse Members' => 'Üyelere Göz At',
      'Show Only Archived Projects' => 'Sadece Arşivlenmiş Projeleri Göster',
      ...
      '%s added %s project(s) to %s: %s.' => '%s, %s projeyi %s\'e eklendi: %s.',
    ...
    Bu, başka herhangi bir proje etiketi ile sonuçlanmayacaktır.',
      ...
      'Engineering Only' => 'Sadece Mühendislik',
      ...
      '%s added %s project(s) for %s: %s.' => '%s, %s için %s proje eklendi: %s.',
      ...
      '%s removed %s member(s) for %s: %s.' => '%s, %s üye için %s kaldırıldı: %s.',
      '%s set the image for %s to %s.' => '%s, görüntüyü %s\'den %s\'e ayarlandı.',
      'Added %s project(s): %s.' => '%s proje eklendi: %s.',
      'Import Columns' => 'Sütunları İçe Aktar',
      '%s edited %s project(s) for %s, added %s: %s; removed %s: %s.' => '%s, %3$s karşılığında %2$s proje düzenledi, %s eklendi: %s; %s kaldırıldı: %s.',
      'Workboard' => 'Çalışma Tablosu',
      ...
      'Workboard Columns' => 'Çalışma Masası Sütunları',
    ...
    > ios, not(bug)',
      ...
      '%s renamed this project from %s to %s.' => '%s bu projeyi %s\'den %s\'e değiştirdi.',
      ...
      '%s activated this project.' => '%s bu projeyi aktifleştirdi.',
      'Information about the project icon.' => 'Proje ikonu hakkında bilgi.',
      '%s changed point limit for this column from %s to %s.' => '%s bu sütun için  puan sınırı %s\'den %s\'e değiştirdi',
      'Parent Project' => 'Ortak Proje',
      ...
      'Current Viewer\'s Projects' => 'Güncel İzleyici Projeleri',
    ...
    %s',
      'Choose a parent project to create a new milestone for.' => 'İçin yeni bir dönüm noktası oluşturmak üzere bir üst proje seçin.',
      ...
      '%s set the point limit for this column to %s.' => '%s, bu sütun için puan limitini %s olarak ayarladı.',
      'In Any: Invalid Project' => 'Herhangi Biri: Geçersiz Proje',
      'Manage Project' => 'Projeyi Yönet',
      '%s updated this project\'s image from %s to %s.' => '%s, bu projenin resmini %s\'den %s\'e güncelledi.',
    ...
    Varsayılan olarak, birkaç proje girerseniz, sonuçlar yalnızca girdiğiniz tüm projelere aitse döndürülür. Yani, bu sorgu yalnızca //both// projelerde ki sonuçları döndürür:
    > ios, android
    Herhangi bir projede sonuç bulmak istiyorsanız `any()` işlevini kullanabilirsiniz. Örneğin //either// proje içinde bulunan sonuçları bulmak için bu sorguyu kullanabilirsiniz:
    > any(ios), any(android)
    Sonuçları düzeltmek için `any()` işlevini normal proje belirteçleriyle birleştirebilirsiniz. Örneğin, //either// iOS veya Android\'deki hataları bulmak için bu sorguyu kullanın:
    > bug, any(ios), any(android)',
      'You can not create a subproject or milestone under this parent because it would nest projects too deeply. The maximum nesting depth of projects is %s.' => 'Projeleri çok derinden içereceği için bu ebeveynin altında bir alt proje veya kilometre taşı oluşturamazsınız. Projelerin maksimum yuva derinliği %s\'dir.',
      '%s removed %s project(s) from %s: %s.' => '%s, %s için %s proje kaldırdı: %s.',
      ...
      'Only Match Other Constraints' => 'Sadece Diğer Kısıtlamaları Eşleştir',
      ...
      '%s removed %s project(s): %s.' => '%s, %s proje kaldırdı: %s.',
      'Members: ...' => 'Üyeler: ...',
    ...
    Geçersiz veya tanınmayan projeler göz ardı edilir. Herhangi bir proje belirtmezseniz bu komutun etkisi olmaz.',
      'Join Project' => 'Projeye Katılın',
      'This project has subprojects.' => 'Bu projenin alt projeleri var.',
      'Remove projects: %s.' => 'Projeleri kaldır: %s.',
      ...
      '%s removed %s project(s) for %s: %s.' => '%s, %s için %s proje kaldırdı: %s.',
    ...
    %s',
      ...
      '%s added %d %s hashtag(s): %s.' => '%s, %s için %s kare eklendi: %s.',
      'Adjust project icons.' => 'Proje simgelerini ayarlayın.',
      '%s edited member(s) for %s, added %s: %s; removed %s: %s.' => '%s için %s üye düzenlendi, %s eklendi: %s; %s kaldırıldı: %s.',
      'Bugs' => 'Hatalar',
      'Add Members' => 'Üye Ekle',
    ...
    Bu normalde projeleriniz anlamına gelir, ancak bu işlevi kullanarak bir sorguyu kaydederseniz ve başka birine gönderirseniz, çalıştırdıkları zaman (mevcut görüntüleyici olurlar) bu onların projeleri anlamına gelir. Bu, pano panelleri oluşturmak için faydalı olabilir.',
      ...
      'Unable to find object "%s" in column "%s" on board "%s".' => '"%s" nesnesi, "%3$s" üzerindeki "%2$s" sütununda bulunamadı.',
      ...
      '%s edited project(s) for %s, added %s: %s; removed %s: %s.' => '%s için %s proje düzenlendi, %s eklendi: %s; %s kaldırıldı: %s.',
      ...
      '%s set this project\'s image to %s.' => '%s bu projenin resmini %s olarak ayarlardı.',
      'Natural' => 'Doğal',
      ...
      '%s set the icon for %s to %s.' => '%s, simgesini %s\'den %s\'e arasında ayarlandı.',
      ...
      'Browse Only' => 'Sadece Göz At',
      '%s removed %d %s hashtag(s): %s.' => '%s, %s için %s kare kaldırıldı: %s.',
      '%s edited %s project(s), added %s: %s; removed %s: %s.' => '%s düzenlenmiş proje, %s ekledi: %s; %s; %s kaldırıldı: %s.',
