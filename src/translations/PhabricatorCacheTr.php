...
final class PhabricatorCacheTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'The PHP "Zend OPcache" extension is installed, but not enabled in your PHP configuration. Enabling it will dramatically improve Phabricator performance. Edit the "%s" setting to enable the extension.' => 'PHP "Zend OPcache" uzantısı yüklü, ancak PHP yapılandırmanızda etkin değil. Bunu etkinleştirmek, Phabricator performansını önemli ölçüde artıracaktır. Uzantıyı etkinleştirmek için "%s" ayarını düzenleyin.',
      ...
      'The APC or APCu PHP extensions are installed, but not enabled in your PHP configuration. Enabling these extensions will improve Phabricator performance. Edit the "%s" setting to enable these extensions.' => 'APC veya APCu PHP uzantıları yüklü, ancak PHP yapılandırmanızda etkin değil. Bu uzantıların etkinleştirilmesi Phabricator performansını artıracaktır. Bu uzantıları etkinleştirmek için "%s" ayarını düzenleyin.',
