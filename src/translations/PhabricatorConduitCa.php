...
final class PhabricatorConduitCa
  ...
  'This request originates from outside of the cluster address range. Requests signed with cluster API tokens must originate from within the cluster.' => 'Aquesta petició s\'origina des de fora del rang d\'adreces del clúster de Phabricator. Les sol·licituds signades amb testimonis API en clúster han d\'originar-se dins del clúster.',
  ...
  'Your \'%s\' client version is \'%d\', which is newer than the server version, \'%d\'. Upgrade your server.' => 'La vostra versió de client «%s» és «%d», que és posterior a la versió del servidor, «%d». Actualitza la instal·lació de Phabricator.',
  ...
  'A new version of arc is available! You need to upgrade to connect to this server (you are running version %d, the server is running version %d).' => 'Hi ha disponible una nova versió d\'arc. Heu d’actualitzar per connectar-vos a aquest servidor (esteu executant la versió %d, el servidor està executant la versió %d).',
  ...
  'This request originates from outside of the cluster address range. Requests signed with trusted device keys must originate from within the cluster.' => 'Aquesta sol·licitud prové de fora de l\'interval d\'adreces del clúster de Phabricator. Les sol·licituds signades amb claus de dispositiu de confiança han de provenir del clúster.',
  ...
  'Epoch timestamp must be larger than 0, got %d.' => 'El segell de temps d\'època ha de ser més gran que 0, s\'ha obtingut %d.',
  ...
  'Show old methods which will be deleted in a future version of this software.' => 'Mostra els mètodes antics que se suprimiran en una futura versió de Phabricator.',
);
  }
