...
final class PhabricatorextCoreFrFR
  ...
  protected function getTranslations() {
    ...
    `mediawiki`, `mediawiki.masociete` ou `mediawiki.ingenierie` sont des noms raisonnables.',
      ...
      'If something is serious enough to warrant a rollback then you should bring it to the attention of deployers on the [[ https://www.mediawiki.org/wiki/MediaWiki_on_IRC | #wikimedia-operations IRC channel ]].' => 'Si quelque chose est assez grave pour justifier une restauration, vous devriez alors la porter à l’attention des développeurs sur le [[ https://www.mediawiki.org/wiki/Special:MyLanguage/MediaWiki_on_IRC | canal IRC #wikimedia-operations ]].',
