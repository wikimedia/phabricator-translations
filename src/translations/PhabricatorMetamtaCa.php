...
final class PhabricatorMetamtaCa
  ...
  'Queued message #%d for resend.' => 'Missatge a la cua #%d per tornar-lo a enviar.',
  ...
  'Ignoring email with "Message-ID" hash "%s" that has been seen %d times, including this message.' => 'Ignorant el correu electrònic amb l\'etiqueta "ID de missatge" "%s" que s\'ha vist %d vegades, inclòs aquest missatge.',
