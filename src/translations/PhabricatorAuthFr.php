...
final class PhabricatorAuthFr
  ...
  protected function getTranslations() {
    ...
    Phabricator',
      ...
      'Specify the credential type to revoke with "--type" or specify "--everything".' => 'Spécifier le type de certificat à révoquer avec « --type », ou spécifier « --everything »',
    ...
    **Configurer votre application**: Trouver l’application que vous venez de créer dans le tableau, et vliquer sur le lien **Configurer** sous **Actions**. Sélectionner **Authentification entrante** et cliquer sur l’onglet **OAuth** (il devrait être sélectionné par défaut). Puis utiliser ces paramètres :
    ...
    Cliquer sur **Enregistrer** dans JIRA. L’authentification devrait maintenant être configurée, et ce fournisseur fonctionner correctement.',
      ...
      'Recover access to an administrative account if you have locked yourself out of Phabricator.' => 'Récupérer l’accès à un compte administratif si vous avez verrouillé le vôtre hors de Phabricator.',
    ...
    ' => 'Vous pouvez utiliser ce lien pour réinitialiser votre mot de passe Phabricator :
      ...
      'A keypair has been generated, and the public key has been added as a recognized key. Use the button below to download the private key.' => 'Une paire de clés a été générée, et la clé publique a été ajoutée comme une clé reconnue. Utiliser le bouton ci-dessous pour télécharger la clé privée.',
      'Login validation is missing expected parameter ("%s").' => 'La validation de la connexion n’a pas le paramètre obligatoire (« %s »).',
      'Next Step' => 'Étape suivante',
      'The key "%s" will be permanently deactivated, and you will no longer be able to use the corresponding private key to authenticate.' => 'La clé « %s » sera désactivée de façon permanente, et vous ne pourrez plus utiliser la clé privée correspondante pour vous authentifier.',
    ...
    Après avoir terminé la configuration, copier le **Client ID** et le **Client Secret** dans les champs ci-dessus (vous devrez peut-être générer le secret client en cliquant d’abord sur \'Nouveau Secret\').',
      ...
      'Deactivate SSH Key' => 'Désactiver la clé SSH',
    ...
    Une fois l’application créée, copiez le **Client ID** et le **Client Secret** dans les champs ci-dessus.',
      ...
      'You can only recover administrator accounts, but %s is not an administrator. Recoverable administrator accounts are: %s.' => 'Vous ne pouvez récupérer que les comptes administrateur, mais %s n’est pas un administrateur. Les comptes administrateur récupérables sont : %s.',
    ...
    Après avoir achevé la configuration, copier le **Client ID** et le **Client Secret** dans les champs ci-dessus.',
      ...
      'This Phabricator installation has no recoverable administrator accounts. You can use `%s` to create a new administrator account or make an existing user an administrator.' => 'Cette installation de Phabricator n’a pas de comptes administrateur récupérable. Vous pouvez utiliser `%s` pour créer un nouveau compte administrateur ou faire d’un utilisateur existant un administrateur.',
    ...
    (NOTE) Vous pouvez sélectionner une longueur minimale de mot de passe en mettant `%s` dans la configuration.',
      ...
      'No such user "%s". Recoverable administrator accounts are: %s.' => 'Pas d’utilisateur « %s ». Les comptes administrateur récupérables sont : %s.',
    ...
    Après avoir terminé la configuration, copier le **Client ID** et le **Client Secret** dans les champs ci-dessus.',
      ...
      'Deactivated SSH keys can not be edited or reactivated.' => 'Les clés SSH désactivées ne peuvent pas être modifiées ou réactivées.',
    ...
    Une fois la configuration achevée, copier la **Clé du consommateur** et le **Secret du consommateur** dans les champs ci-dessus.',
      ...
      'Deactivate SSH Public Key' => 'Désactiver la clé publique SSH',
      ...
      'Revoke credentials for the specified user.' => 'Annuler les éléments d\'identification de l\'utilisateur spécifique.',
      ...
      'Deactivate Public Key' => 'Désactiver la clé publique',
    ...
    Choisir un nom permanent pour l’instance du serveur OAuth de Phabricator. //Cette// instance de Phabricator utilise ce nom en interne pour garder trace de l’instance du serveur OAuth de Phabricator, au cas où l’URL change ultérieurement.',
      ...
      'Password and confirmation must match.' => 'Le mot de passe et la confirmation doivent correspondre.',
