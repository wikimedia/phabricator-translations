...
final class ArcanistCoreKoKR
  ...
  'Do not call %s or %s directly on a %s. Instead, call %s or %s.' => '%3$s에서 %s 또는 %s를 직접 호출하지 마십시오. 대신 %4$s 또는 %5$s를 호출하십시오.',
...
' => '    %s %s',
  ...
  'EXCEPTION' => '예외',
  '---' => '---',
  'Failed to write %d bytes to \'%s\'.' => '%d 바이트를 \'%s\'에 쓰기 실패했습니다.',
...
' => '    %s (%s) %s',
  ...
  'Use `%s` instead of `%s`.' => '`%2$s` 대신 `%s`을(를) 사용하십시오.',
  'Array Element' => '배열 요소',
  '%s %s -> %s %s %s' => '%s %s -> %s %s %s',
