...
final class ArcanistCoreKoKR
  ...
  protected function getTranslations() {
    return array(
      ...
      'The "squash" strategy collapses multiple local commits into a single commit when publishing. It produces a linear published history (but discards local checkpoint commits). This is the default strategy.' => '\'스쿼시\' 전략은 게시할 때 여러 로컬 커밋을 단일 커밋으로 병합합니다. 이는 선형 게시 기록을 생성하지만 로컬 체크포인트 커밋은 폐기합니다. 이것이 기본 전략입니다.',
      'Call Conduit API methods.' => 'Conduit API 메서드 호출.',
      'Symbol "%s" does not identify a valid revision.' => '\'%s\' 기호는 유효한 리비전을 식별하지 않습니다.',
      'Do not call %s or %s directly on a %s. Instead, call %s or %s.' => '%3$s에서 %1$s 또는 %2$s를 직접 호출하지 마십시오. 대신 %s 또는 %s를 호출하십시오.',
      'A linter for Composer related files.' => 'Composer 관련 파일을 위한 린터.',
      '"%s" (%s)' => '"%s" (%s)',
      'Saved "%s" as "%s".' => '"%s"을(를) "%s"로 저장합니다.',
      'Night has fallen. The moon overhead is waxing, and provides just enough light that you can make out your surroundings. It is quite cold.' => '밤이 됨. 위의 달은 주변을 볼 수 있을 만큼 충분한 빛을 밝힘. 꽤 추움.',
      '(This message was raised at line %s, but the file only has %s line(s).)' => '(이 메시지는 %s줄에 올렸지만 파일에 %s줄이 있음.)',
      'Not parsing!' => '파싱 안 됨!',
      'Portuguese (Portugal)' => '포르투갈어 (포르투갈)',
      'File Symbol "%s"' => '파일 기호 "%s"',
      'Try running your arc command again.' => 'arc 명령을 다시 실행해주세요.',
      'Local commit "%s" does not merge cleanly into "%s". Rebase or merge local changes so they can merge cleanly.' => '"%s" 로컬 커밋은 "%s"에 깨끗하게 병합되지 않습니다. 로컬 변경사항을 리베이스하거나 병합하면 깨끗하게 병합할 수 있습니다.',
      'CC: %s' => '참조: %s',
      ...
      '**bookmarks**' => '**북마크**',
      'Nowhere to load blob \'%s\' from!' => '\'%s\' blob을 불러올 곳이 없습니다!',
