...
final class PhabricatorSettingsKoKR
  ...
  protected function getTranslations() {
    return array(
      ...
      'If you have difficulty reading the UI, this setting may help.' => '파브리케이터 UI를 읽는 데 어려움이 있을 경우 이 설정을 통해 파브리케이터에 더 쉽게 접근할 수 있을 것 입니다.',
      ...
      'If you change your primary address, %s will send all email to %s.' => '만약 당신이 당신의 기본 주소를 변경한다면, 파브리케이터는 모든 이메일을 %s로 보낼 것입니다.',
      ...
      'No allowed editor protocols are configured.' => '파브리케이터가 편집기 프로토콜을 허용하도록 구성되어 있지 않습니다.',
      ...
      'Your browser timezone (%s) differs from your profile timezone (%s). You can adjust your profile setting to match your browser, or ignore this conflict to keep your current profile setting.' => '브라우저 표준 시간대(%s)가 프로필 표준 시간대(%s)와 다릅니다. 이 충돌을 무시하거나 클라이언트와 일치하도록 프로필 설정을 조정할 수 있습니다.',
      ...
      'Your browser has not yet granted this server permission to send desktop notifications.' => '이 브라우저는 아직 파브리케이터 인스턴스를 위해 데스크톱 알림을 보낼 권한을 부여받지 않았습니다.',
      ...
      'You can opt to receive plain text email instead of HTML email. Plain text email works better with some clients.' => 'HTML 이메일 대신 파브리케이터로부터 일반 텍스트로 이메일을 받는 것을 선택할 수 있습니다.',
      ...
      'Your browser has granted this server permission to send desktop notifications.' => '이 브라우저는 파브리케이터 인스턴스를 위해 데스크톱 알림을 보낼 권한을 부여받았습니다.',
      ...
      'This server can send real-time notifications to your web browser or to your desktop. Select where you want to receive these real-time updates.' => '파브리케이터는 당신의 웹 브라우저나 데스크탑에 실시간 통지를 보낼 수 있습니다. 이러한 실시간 업데이트를 받을 위치를 선택하세요.',
