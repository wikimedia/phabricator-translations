...
final class PhabricatorDrydockCa
  ...
  'Repository Operation %d' => 'Operació del repositori %d',
  ...
  'Drydock Authorization %d' => 'Autorització del Drydock %d',
