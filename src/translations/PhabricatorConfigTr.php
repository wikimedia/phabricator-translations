...
final class PhabricatorConfigTr
  ...
  protected function getTranslations() {
    ...
    İstekler, geçerli bir "Ana Bilgisayar" başlığı içermelidir.',
      ...
      'Phabricator Version Information' => 'Phabricator Sürümü Bilgisi',
    ...
    Ya %s yapılandırma ayarını yapın ya da arka plan pencerelerini yeniden başlatın. Daemonlar, yeniden başlatıldığında uygun kullanıcı olarak çalışmaya çalışmalıdır.',
      ...
      'Phabricator no longer supports global customization of monospaced fonts.' => 'Phabricator artık sabit aralıklı yazı tiplerinin küresel olarak özelleştirilmesini desteklemiyor.',
      '<none>' => '<hiçbiri>',
    ...
    %s',
      ...
      'Phabricator Configuation' => 'Phabricator Yapılandırması',
      ...
      'Phabricator daemons no longer use PID files.' => 'Phabricator arkaplan uygulamaları artık PID dosyalarını kullanmıyor.',
