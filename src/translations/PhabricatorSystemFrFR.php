...
final class PhabricatorSystemFrFR
  ...
  protected function getTranslations() {
    return array(
      'An Administrator has placed this server into read-only mode.' => 'Un administrateur a placé Phabricator en mode de lecture seule.',
      ...
      'Destroying %s **%s**...
    ' => 'Destruction de %s **%s**...',
      'This server has consistently been unable to reach the writable ("master") database while processing recent requests.' => 'Phabricator a été constamment incapable d’atteindre la base de données (« master ») en écriture lors du traitement des demandes récentes.',
      ...
      'This server was unable to connect to the writable ("master") database while handling this request, and automatically degraded into read-only mode.' => 'Phabricator n’a pas pu se connecter à la base de données modifiable (« principale ») lors du traitement de cette requête et a été automatiquement dégradé en mode de lecture seule.',
