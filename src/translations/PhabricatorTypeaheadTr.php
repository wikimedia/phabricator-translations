...
final class PhabricatorTypeaheadTr
  ...
  protected function getTranslations() {
    ...
    Bu belge, belirteçlerin nerede başladığını ve bittiğini netleştirmek için dahili adları kullanır. Özellikle, belgelerde bu şekilde yazılan sorguları bulacaksınız:
    %s
    ...
    %s',
      ...
      'Raw Query' => 'Ham Sorgu',
      'Token Results (%s)' => 'Jeton Sonuçları (%s)',
      'Configured datasource class "%s" must be a valid subclass of "%s".' => 'Yapılandırılmış veri kaynağı sınıfı "%s", "%s" nin geçerli bir alt sınıfı olmalıdır.',
      'Token Name' => 'Belirteç Adı',
      'Reference: Advanced Functions' => 'Referans: Gelişmiş İşlevler',
      'Image URI' => 'Resim URI',
      'Select' => 'Seç',
    ...
    Farklı kontrollerin //farklı// işlevleri (kontrolün ne yaptığına bağlı olarak) desteklediğini, bu nedenle bu belirli işlevlerin her yerde çalışmayabileceğini unutmayın. Bu kontrol için hangi fonksiyonların mevcut olduğunu gözden geçirmek üzere kontrol için yardımı her zaman kontrol edebilirsiniz.',
      'Display Name' => 'Ekran Adı',
      'This table briefly describes available functions for this control. For details on a particular function, see the corresponding section below.' => 'Bu tabloda kısaca bu kontrol için mevcut fonksiyonlar açıklanmaktadır. Belirli bir işleve ilişkin detaylar için aşağıdaki ilgili bölüme bakınız.',
      'This source is not usable directly.' => 'Bu kaynak doğrudan kullanılamaz.',
      'Unable to parse function and arguments for token "%s".' => '"%s" belirteci için işlev ve argümanlar ayrıştırılamıyor.',
      'Token Query' => 'Belirteç Sorgusu',
      ...
      'Sprite' => 'Peri',
      'The HTTP parameter named "parameters" for this request is not a valid JSON parameter. JSON is required. Exception: %s' => 'Bu istek için "parametreler" adlı HTTP parametresi geçerli bir JSON parametresi değil. JSON gereklidir. İstisna: %s',
      'Function Quick Reference' => 'İşlev Hızlı Referansı',
      'Constraints for input "%s".' => '"%s" girişi için kısıtlamalar.',
      'Auto' => 'Otomatik',
