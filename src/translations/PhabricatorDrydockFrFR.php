...
final class PhabricatorDrydockFrFR
  ...
  'Repository Operation %d' => 'Opération de dépôt %d',
  'Failed to acquire slot locks: %s.' => 'Échec d’acquisition de verrous d’emplacement : %s.',
  'Waiting For Reclamation' => 'En attente de remise en état',
  ...
  'No enabled blueprints exist with a blueprint class that can plausibly allocate resources to satisfy the requested lease.' => 'Il n\'existe aucun plan activé avec une classe de plan qui puisse allouer de manière plausible des ressources pour satisfaire le bail demandé.',
  ...
  'Specify one or more resource IDs to update with "%s".' => 'Spécifier au moins un identifiant de ressource à mettre à jour avec « %s ».',
  'Show Only Disabled Blueprints' => 'Afficher uniquement les plans désactivés',
  'Retrieve information about Drydock resources.' => 'Récupérer des informations sur les ressources Drydock.',
  ...
  'Diff ("%s") has wrong revision ID ("%s", expected "%s").' => 'Le diff (« %s ») a un mauvais identifiant de révision (« %s », « %s » attendu).',
  ...
  'Drydock Authorization %d' => 'Autorisation Drydock %d',
  ...
  'Activation complete. Leases are permanent until manually released with:' => 'Activation terminée. Les baux sont permanents jusqu\'à leur libération manuelle avec :',
  'Via:' => 'Via :',
  ...
  'Leases activated in %sms.' => 'Baux activés en %s ms.',
  ...
  'Release all resources. Dangerous!' => 'Libère toutes les ressources. Dangereux !',
  ...
  'Value provided to "--count" must be a nonzero, positive number.' => 'La valeur fournie à « --count » doit être un nombre positif différent de zéro.',
  'Update a resource.' => 'Mettre à jour une ressource.',
  'Waiting For Activation' => 'En attente de l\'activation',
  'Search for resources generated by particular blueprints.' => 'Rechercher des ressources générées par des plans particuliers.',
  'When this diff was generated, it was not pushed to staging for an unknown reason (the status code was "%s"). Changes must be pushed to staging before they can be landed from the web. The server may be running an out-of-date version of this software, and updating may provide more information about this error.' => 'Quand la différence a été générée, elle n’a pas été poussée en zone de mise en place pour une raison inconnue (le code retour était « %s »). Les modifications doivent être poussées en zone de mise en place avant de pouvoir être récupérées depuis le web. Le serveur exécute peut-être une version obsolète de ce logiciel et le mettre à jour pourrait fournir plus d’information sur cette erreur.',
  'Lease has already been released!' => 'Le bail a déjà été relâché !',
  'Lease has been broken!' => 'Le bail a été rompu !',
  'Unable to parse argument to "--until".' => 'Impossible d\'analyser l\'argument de « --until ».',
  ...
  'Specified blueprint "%s" is not capable of satisfying the configured lease.' => 'Le plan spécifié « %s » n’est pas capable de satisfaire le bail configuré.',
  'Lease Released' => 'Bail relâché',
  'No Authorizations' => 'Aucune autorisation',
  'PHID of the leased resource, if any.' => 'PHID de la ressource louée, s’il y a lieu.',
  ...
  'Execute a query with identifiers before getting the identifier map.' => 'Exécutez une requête avec des identifiants pour obtenir la carte des identifiants.',
  ...
  'No leases selected for release.' => 'Aucun bail n\'a été sélectionné pour publication.',
  ...
  'Waiting for reclamation of resources: %s.' => 'En attente de remise en état des ressources : %s.',
  ...
  'Waiting for daemons to activate leases...' => 'En attente que les services en arrière-plan activent les baux...',
  ...
  'Waiting for activation of resources: %s.' => 'En attente de l\'activation des ressources : %s.',
  'Create New Blueprint' => 'Créer un nouveau plan',
  'Resource ID to update.' => 'Identifiant de ressource à mettre à jour.',
  'Allocate Software Resources' => 'Allouer les ressources logicielles',
  'Lease ID to update.' => 'Identifiant du bail à mettre à jour.',
  ...
  'Lease a given number of identical resources.' => 'Louer un nombre donné de ressources identiques.',
  ...
  'Blueprint "%s" could not be loaded. Try a blueprint ID or PHID.' => 'Impossible de charger le plan « %s ». Essayez un ID ou un PHID de plan.',
  ...
  'Lease ID to release.' => 'Identifiant du bail à libérer.',
  ...
  'Can not issue a query with an empty identifier list.' => 'Impossible d\'émettre une requête avec une liste d\'identifiants vide.',
  ...
  'Reading JSON attributes from stdin...' => 'Lecture des attributs JSON depuis le flux d\'entrée standard...',
  ...
  'No resources selected for release.' => 'Aucune ressource sélectionnée pour publication.',
  ...
  'Blueprint "%s" (of type "%s") is not properly implemented: it built a resource of type "%s" to satisfy a lease requesting a resource of type "%s".' => 'Le plan « %s » (de type « %s ») n’est pas correctement mis en œuvre : il construit une ressource de type « %s » pour satisfaire un bail demandant une ressource de type « %s ».',
  ...
  'Type a lease ID (exact match)...' => 'Saisissez un identifiant de bail (correspondance exacte)...',
  'Resource ID to release.' => 'Identifiant de la ressource à libérer.',
  'Started Work' => 'Travail démarré',
  'Reclaimed Resources' => 'Ressources récupérées',
  'Use "--lease" to specify a lease.' => 'Utilisez « --lease » pour spécifier un bail.',
  ...
  'WARNING: There are %s unapproved authorization(s)!' => 'ATTENTION : il y a %s autorisation{{PLURAL:||%1$s||s}} non approuvée{{PLURAL:||%1$s||s}} !',
  'Blueprint "%s" (of type "%s") is not properly implemented: %s must actually allocate the resource it returns.' => 'Le plan « %s » (de type « %s ») n’est pas mis en œuvre correctement : %s doit en fait allouer la ressource qu’il renvoie.',
  ...
  'Attribute "repositories.map" should be a map of repository specifications.' => 'L\'attribut « repositories.map » doit être une carte des spécifications du dépôt.',
  ...
  'Drydock Lease %d' => 'Bail de Drydock %d',
  'Decline Authorization' => 'Refuser l\'autorisation',
  'Specify which resources you want to release. See "--help" for guidance.' => 'Spécifiez les ressources que vous souhaitez libérer. Voir « --help » pour plus d\'informations.',
  'Unable to load diff "%s".' => 'Impossible de charger le diff « %s ».',
  'Blueprint type.' => 'Type de plan',
  'Lease resources from a specific blueprint.' => 'Louer des ressources à partir d\'un plan spécifique.',
  ...
  'Blueprint names can be no longer than %s characters.' => array(
    'Les noms de plans ne peuvent pas dépasser %s caractère.',
    'Les noms de plans ne peuvent pas dépasser %s caractères.',
  ),
  'Working copy lease has invalid attribute "%s".' => 'Le bail de copie de travail a un attribut invalide « %s ».',
  ...
  'Specify one or more lease IDs to update with "%s".' => 'Spécifier au moins un identifiant de bail à mettre à jour avec « %s ».',
  ...
  'JSON file with lease attributes. Use "-" to read attributes from stdin.' => 'Fichier JSON avec les attributs du bail. Utiliser « - » pour lire les attributs depuis le flux d’entrée standard.',
  ...
  'Blueprint %d' => 'Plan %d',
  'Blueprint "%s" (of type "%s") is not properly implemented: it returned from "%s" without activating a lease.' => 'Le plan « %s » (de type « %s ») n’est pas mis en œuvre correctement : il est revenu de « %s » sans activer de bail.',
  ...
  'Information about resource status.' => 'Information sur l’état de la ressource.',
  ...
  'Raw Diff Source' => 'Source de la différence brute',
  ...
  'Release all leases. Dangerous!' => 'Libère tous les baux. Dangereux !',
  'Blueprint "%s" is specified more than once (as "%s" and "%s").' => 'Le plan « %s » est spécifié plus d\'une fois (comme « %s » et « %s »).',
  ...
  'When this diff was generated, the server was running an older version of the software which did not support staging areas for this version control system, so the change was not pushed to staging. Changes must be pushed to staging before they can be landed from the web.' => 'Lorsque cette différence a été générée, le serveur exécutait une ancienne version du logiciel qui ne prenait pas en charge les zones de mise en place pour ce système de contrôle de version. La modification n\'a donc pas été transférée vers la zone de mise en place. Les modifications doivent être transférées vers la zone de mise en place avant de pouvoir être récupérées depuis le web.',
  'Leases queued for activation:' => 'Baux en file d\'attente pour activation :',
  'The blueprint which generated this resource.' => 'Le plan qui a généré cette ressource.',
  ...
  'The diff author used the %s flag to skip pushing this change to staging. Changes must be pushed to staging before they can be landed from the web.' => 'L’auteur de la différence a utilisé le drapeau %s pour sauter l’étape de poussée de cette modification en zone de mise en place. Les modifications doivent être poussées en mise en place avant de pouvoir être récupérées depuis le web.',
  ...
  'Select which leases you want to release. See "--help" for guidance.' => 'Sélectionnez les baux que vous souhaitez libérer. Voir « --help » pour plus d\'informations.',
  ...
  'This revision has already landed.' => 'Cette révision a déjà été récupérée.',
  ...
  'Epoch at which this lease expires, if any.' => 'Époque à laquelle expire le bail, s’il y a lieu.',
  ...
  'Working copy lease is missing required attribute "%s".' => 'Le bail de la copie de travail ne possède pas l\'attribut obligatoire « %s ».',
  ...
  'Drydock Resource %d' => 'Ressource Drydock %d',
  'No Repository Automation' => 'Pas d’automatisation du dépôt',
  'Specify a resource type with "--type".' => 'Spécifiez un type de ressource avec « --type ».',
  ...
  'No known blueprint class can ever allocate the specified lease. Check that the resource type is spelled correctly.' => 'Aucune classe de plan connue ne peut jamais allouer le bail spécifié. Vérifiez que le type de ressource est correctement orthographié.',
