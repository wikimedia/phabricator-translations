...
final class PhabricatorNotificationDeDE
  ...
  protected function getTranslations() {
    ...
    %s' => '(Um den Server zu starten, führe diesen Befehl aus.) %s',
      ...
      'This server is configured to use a notification server, but is not able to connect to it.' => 'Dieser Server ist für die Verwendung eines Benachrichtigungsservers konfiguriert, kann sich aber nicht mit ihm verbinden.',
