...
final class PhabricatorManiphestSrEC
  ...
  '%s added %s commit(s) to %s: %s.' => '%s је додао комит(ова) у %3$s: %4$s.',
  ...
  '%s changed file(s), attached %s: %s; detached %s: %s.' => '%s је изменио датотеке, додао: %3$s; уклонио: %5$s.',
  ...
  '%s removed %s parent task(s): %s.' => '%s је уклонио родитељских задатак(а): %3$s.',
  '%s added %s subtask(s): %s.' => '%s је додао подзадатак(а): %3$s.',
  'Assign a task to a specific user.' => 'Додели задатак одређеном кориснику.',
  'Merged In' => 'Спојено са',
  '%s edited %s commit(s), added %s: %s; removed %s: %s.' => '%s је изменио комит(ова), додао: %4$s; уклонио: %6$s.',
  'Edit Related Tasks...' => 'Уреди сродне задатке…',
  '%s updated the cover image to %s.' => '%s је променио слику на %s.',
  '%s created subtask %s.' => '%s је направио подзадатак %s.',
  'Bulk Edit Selected »' => 'Групна измена је изабрана »',
  ...
  '%s added %s parent task(s): %s.' => '%s је додао родитељски(х) задатак(а): %3$s.',
  'Subtask' => 'Подзадатак',
  'Set priority to' => 'Постави приоритет на',
  'The task description.' => 'Опис задатка.',
  'Filter By Project' => 'Филтрирај по пројекту',
  '%s claimed this task.' => '%s је преузео овај задатак.',
  'Close This Task As a Duplicate Of' => 'Затвори овај задатак као дупликат задатка',
  '%s removed %s subtask(s) for %s: %s.' => '%s је уклонио подзадатак(а) за %3$s: %4$s.',
  'Untitled Task' => 'Ненасловљен задатак',
  '%s edited parent task(s) for %s, added %s: %s; removed %s: %s.' => '%s је изменио родитељске задатке за %s, додао: %4$s; уклонио: %6$s.',
  ...
  '%s created this task.' => '%s је направио/ла овај задатак.',
  'Search...' => 'Претражи...',
  ...
  '%s assigned %s to %s.' => '%s је доделио %s %s.',
  ...
  '%s removed %s parent task(s) for %s: %s.' => '%s је уклонио родитељских задатак(а) задатка за %3$s: %4$s.',
  ...
  'Create New Task' => 'Направи задатак',
  ...
  '%s edited subtask(s), added %s: %s; removed %s: %s.' => '%s је променио подзадатке, додао: %3$s; уклонио: %5$s.',
  '%s removed %s subtask(s): %s.' => '%s је уклонио подзадатка: %3$s.',
