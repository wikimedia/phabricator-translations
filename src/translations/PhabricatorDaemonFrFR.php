...
final class PhabricatorDaemonFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'Leased' => 'Emprunté',
      'Start the standard configured collection of daemons. This is appropriate for most installs. Use **%s** to customize which daemons are launched.' => 'Démarrer la collection configurée standard des services d’arrière-plan. C\'est ce qui convient à la plupart des installations. Utilisez **%s** pour personnaliser les services à lancer.',
      'Starting daemons as %s' => 'Démarrage des services d’arrière-plan en tant que %s',
      'SURVIVED' => 'A SURVÉCU',
    ...
    Les services d’arrière-plan sont configurés pour s\'exécuter en tant que « %s » mais l’utilisateur actuel est « %s ».
    Utilisez `%s` pour exécuter avec un autre utilisateur, passez `%s` pour ignorer cet avertissement ou bien modifiez `%s` pour changer la configuration.',
      ...
      'PID "%d" is not a known daemon PID.' => 'Le PID « %s » n’est pas un PID de service d’arrière-plan connu.',
    ...
    ' => 'ERREUR : la fonction PHP %s est désactivée. Vous devez l’activer pour exécuter des services d’arrière-plan sur cette machine.',
      ...
      'Stop all daemon processes on this host, even if they belong to another instance.' => 'Arrêter tous les processus de services d’arrière-plan sur cet hôte même s’ils appartiennent à une autre instance.',
      ...
      'Task %d' => 'Tâche %s',
      'Manage Daemons' => 'Gérer les services d’arrière-plan',
