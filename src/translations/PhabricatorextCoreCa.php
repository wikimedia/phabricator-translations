...
final class PhabricatorextCoreCa
  ...
  protected function getTranslations() {
    ...
    NOTA: Aquesta funcionalitat la proporciona una extensió mantinguda per Wikimedia, ProjectOpenTasksProfileMenuItemextension. Consulteu la font {rPHEX}.',
      ...
      'This adds a link to the burnup graph of this project.\\n\\nNOTE: This feature is provided by a Wikimedia-maintained extension in ProjectBurnupGraphProfileMenuItem.php. See https://gitlab.wikimedia.org/repos/phabricator/extensions for the source.' => 'Això afegeix un enllaç a maniphest de cerca de tasques obertes etiquetades amb aquest projecte.
