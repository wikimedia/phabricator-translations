...
final class PhabricatorextCoreCa
  ...
  'Merged' => 'Fusionat',
  'Unresolved code review comments: %d' => 'Comentaris de resolució de codi sense resoldre: %d',
  ...
  'If something is serious enough to warrant a rollback then you should bring it to the attention of deployers on the [[ https://www.mediawiki.org/wiki/Special:MyLanguage/MediaWiki_on_IRC | #wikimedia-operations IRC channel ]].' => 'Si alguna cosa és prou greu com per justificar una recuperació, hauríeu de posar-la en coneixement dels desenvolupadors a [[ https://www.mediawiki.org/wiki/Special:MyLanguage/MediaWiki_on_IRC | #wikimedia-operations IRC channel]].',
...
NOTA: Abans que Phabricator pugui autenticar-se amb èxit amb el vostre MediaWiki, un administrador del wiki ha d\'aprovar el registre del consumidor de l\'oauth utilitzant el formulari que es pot trobar a l\'URL següent: %s',
  ...
  'Consumer Token is required' => 'El secret del consumidor és obligatori',
  ...
  'Execute searches for Policies by PHID.' => 'Executeu cerques de polítiques.',
...
In the next step, you will create an OAuth consumer in MediaWiki to be used by Phabricator OAuth.' => '**Pas 1 de 2**: proporcioneu el nom i l\'URI per a la instal·lació de MediaWiki.
