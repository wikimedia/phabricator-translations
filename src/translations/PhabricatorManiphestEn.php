...
final class PhabricatorManiphestEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'This task is closed as a duplicate. Only comment if you think that this task is not a duplicate.' => 'This task is closed as a duplicate. Only comment if you think that this task is not a duplicate.',
      ...
      'Task IDs must be integer numbers.' => 'Task IDs must be integer numbers.',
    ...
    See the example below for a starting point.',
      ...
      'Task title cannot exceed %d characters.' => 'Task title cannot exceed %s characters.',
      ...
      'Acting user\'s projects' => 'Acting user\'s projects',
    ...
    documentation.',
      ...
      '%s removed the point value %s for this task.' => '%s removed the point value %s for this task.',
      'Blocker' => 'Blocker',
    ...
    If you omit the username or the username is not valid, this behaves like `%s` and assigns the task to you instead.',
      ...
      'Oldest open task, excluding those with priority %s' => 'Oldest open task, excluding those with priority %s',
