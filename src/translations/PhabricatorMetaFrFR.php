...
```',
  'Show Enabled Applications' => 'Voir les applications installées',
  'Can\'t set non-public capabilities to public.' => 'Impossible de rendre publiques des politiques non publiques.',
  'Launchable' => 'Lançable',
  'You cannot enable an enabled application.' => 'Vous ne pouvez pas installer une application déjà installée.',
  ...
  'Really Disable Application?' => 'Voulez-vous réellement désinstaller l’application ?',
  'Create New Application' => 'Créer une nouvelle application',
  'Extension' => 'Extension',
  'Validation Failed' => 'La validation a échoué',
  'Really disable the %s application?' => 'Voulez-vous réellement désinstaller l’application %s ?',
  ...
  'Show Disabled Applications' => 'Voir les applications désinstallées',
  ...
  'This application is required and cannot be disabled.' => 'Cette application est indispensable et ne peut pas être désinstallée.',
  ...
  'Are you absolutely certain you want to disable the Home application?' => 'Avez-vous la certitude absolue de vouloir désinstaller l’application Accueil ?',
