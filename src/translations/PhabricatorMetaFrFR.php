...
final class PhabricatorMetaFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      '%s changed the "%s" policy from "%s" to "%s".' => '%s a changé la politique de « %s » de « %s » en « %s ».',
      'Extension' => 'Extension',
    ...
    ```',
      ...
      '%s changed the "%s" policy for application %s from "%s" to "%s".' => '%s a changé la politique de « %s » pour l’application %s de « %s » à « %s ».',
