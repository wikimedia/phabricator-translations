...
final class PhabricatorNotificationFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'Notification server configuration describes an invalid host ("%s", at index "%s") with an unrecognized type ("%s"). Valid types are "%s" or "%s".' => 'La configuration du serveur de notifications décrit un hôte non valide (« %s », à l’index « %s ») avec un type non reconnu (« %s »). Les types valides sont « %s » ou « %s ».',
      'Notification server configuration describes an invalid host ("%s", at index "%s") with an invalid protocol ("%s"). Valid protocols are "%s" or "%s".' => 'La configuration du serveur de notifications décrit un hôte non valide (« %s », à l’index « %s ») avec un protocole non valide (« %s »). Les protocoles valides sont « %s » ou « %s ».',
    ...
    %s',
      ...
      'Notification server configuration has an invalid service specification (at index "%s"): %s.' => 'La configuration du serveur de notifications a une spécification de service non valide (à l’index « %s ») : %s.',
