...
final class PhabricatorNotificationFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'Phabricator is configured to use a notification server, but is not able to connect to it.' => 'Phabricator est configuré pour utiliser un serveur de notifications, mais il ne peut pas s’y connecter.',
