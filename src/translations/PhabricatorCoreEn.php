...
final class PhabricatorCoreEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Path "%s" contains no libraries.' => 'Path "%s" contains no libraries.',
      'Executed %s task(s).' => 'Executed %s task(s).',
      'No visible events.' => 'No visible events.',
    ...
    Briefly:
      ...
      'Unknown field list-item view style \'%s\'; valid styles are \'%s\', \'%s\'and \'%s\'.' => 'Unknown field list-item view style \'%s\'; valid styles are \'%s\', \'%s\'and \'%s\'.',
      ...
      'Request' => 'Request',
      'Saved Global Queries' => 'Saved Global Queries',
      'Points' => 'Points',
      ...
      'Target' => 'Target',
      'No permission to run "SHOW REPLICA STATUS". Grant this user "REPLICATION CLIENT" permission to allow this server to monitor replica health.' => 'No permission to run "SHOW REPLICA STATUS". Grant this user "REPLICATION CLIENT" permission to allow this server to monitor replica health.',
      'Good' => 'Good',
      ...
      'This host has a "replica" role, but is not replicating data from a master (no output from "SHOW REPLICA STATUS").' => 'This host has a "replica" role, but is not replicating data from a master (no output from "SHOW REPLICA STATUS").',
      'Sat' => 'Sat',
    ...
    Some UI elements (like %s) also have methods which will allow you to render links as forms (like %s).',
      ...
      '%s removed %s which was set to %s.' => '%s removed %s which was set to %s.',
    ...
    %s',
      ...
      'Maximum image dimensions: %s pixels.' => 'Maximum image dimensions: %s pixels.',
