...
final class PhabricatorSpacesEl
  ...
  protected function getTranslations() {
    return array(
      ...
      'Spaces' => 'Χώροι',
      'Browse Spaces' => 'Περιήγηση χώρων',
      'Can Create Spaces' => 'Μπορεί να δημιουργήσει χώρους',
      'All Spaces' => 'Όλοι οι χώροι',
      'Create Space' => 'Δημιουργία χώρου',
      'Policy Namespaces' => 'Ονοματοχώροι πολιτικής',
      '%s activated space %s.' => 'Ο %s ενεργοποίησε τον χώρο %s.',
      '%s created this space.' => 'Ο %s δημιούργησε αυτό τον χώρο.',
      'Space %s: %s' => 'Χώρος %s: %s',
      'No Access to Spaces' => 'Χωρίς πρόσβαση στους χώρους',
