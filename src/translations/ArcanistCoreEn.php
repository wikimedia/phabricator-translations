...
final class ArcanistCoreEn
  ...
  protected function getTranslations() {
    ...
    For more information, see instructions in "%s".',
      ...
      'Phage does not target Windows.' => 'Phage does not target Windows.',
      'Pick' => 'Pick',
      ...
      'Basic Checksums' => 'Basic Checksums',
    ...
    Use \'%s\' to choose one, or \'%s\' to create a new revision.',
      ...
      'Basic No Checksums' => 'Basic No Checksums',
    ...
    %s',
      ...
      'Imaginary locale should be unavailable.' => 'Imaginary locale should be unavailable.',
    ...
    than the one created by tools like __cat__.',
      ...
      'Tree hashes in case "%s".' => 'Tree hashes in case "%s".',
      ...
      'Replacement text for "%s".' => 'Replacement text for "%s".',
    ...
    ',
      ...
      'Nonscalar HTTP keys should throw.' => 'Nonscalar HTTP keys should throw.',
      ...
      'HTTP querystring for byte "%s".' => 'HTTP querystring for byte "%s".',
      'copies' => 'copies',
    ...
    about review status.',
      ...
      'Testing locale availability should not change the locale.' => 'Testing locale availability should not change the locale.',
    ...
    about review status.',
      ...
      'Authors in case "%s".' => 'Authors in case "%s".',
      'UPDATE' => 'UPDATE',
    ...
    ',
      ...
      'Glob Magic, Backslash Suffix' => 'Glob Magic, Backslash Suffix',
    ...
    (Technically: the merge-base of the selected revision and HEAD is used to determine the start of the commit range.)',
      ...
      'Glob Magic, Name' => 'Glob Magic, Name',
      'Declaration Formatting' => 'Declaration Formatting',
      'With Name and Suffix' => 'With Name and Suffix',
      'October' => 'October',
      ...
      'Child selection of: %s.' => 'Child selection of: %s.',
      ...
      'Expected read + write to produce the original raw Git commit blob in case "%s".' => 'Expected read + write to produce the original raw Git commit blob in case "%s".',
      ...
      'Message with severity "%s" at "%s:%s"' => 'Message with severity "%s" at "%s:%s"',
      ...
      'System does not have en_US + en_GB to do locale adjustment tests.' => 'System does not have en_US + en_GB to do locale adjustment tests.',
    ...
    Update this revision anyway?',
      ...
      'Topologically sorted tree.' => 'Topologically sorted tree.',
      ...
      'Topologically sorted tree with nesting.' => 'Topologically sorted tree with nesting.',
    ...
    %sYou can use this message, or discard it.',
      ...
      'Slowly reject surrogate: %s' => 'Slowly reject surrogate: %s',
    ...
    ',
      ...
      'CHOOSE' => 'CHOOSE',
      'Unknown HTTPResponseParser test ("%s").' => 'Unknown HTTPResponseParser test ("%s").',
      'Expected: %s
      Actual: %s' => 'Expected: %s
      Actual: %s',
      ...
      'Required "openssl" extension is not installed.' => 'Required "openssl" extension is not installed.',
    ...
    ',
      ...
      'Glob Magic, Name + Suffix' => 'Glob Magic, Name + Suffix',
      ...
      'Jul' => 'Jul',
      'Slowly reject overlong form of: %s' => 'Slowly reject overlong form of: %s',
      'Paste "%s"' => 'Paste "%s"',
      ...
      'Normalized domain for "%s".' => 'Normalized domain for "%s".',
      ...
      'Partition Count for "%s"' => 'Partition Count for "%s"',
    ...
    ',
      ...
      'Test Case "%s" in Mode "%s"' => 'Test Case "%s" in Mode "%s"',
      ...
      'Glob Magic, Literal .t*t' => 'Glob Magic, Literal .t*t',
      ...
      'Halt' => 'Halt',
      'Unknown PHPAST parser test type "%s"!' => 'Unknown PHPAST parser test type "%s"!',
      ...
      'Disjoint Graph, One Head' => 'Disjoint Graph, One Head',
    ...
    ',
      ...
      'Disjoint Graph, Two Heads' => 'Disjoint Graph, Two Heads',
    ...
    Supported in Mercurial 2.2 and newer.',
      ...
      'Unexpected parse result for dangerous URI "%s".' => 'Unexpected parse result for dangerous URI "%s".',
    ...
    %s',
      ...
      'Behavior differs slightly on git < 2.11.0' => 'Behavior differs slightly on git < 2.11.0',
    ...
    ',
      ...
      'Serialization of PHP-object JSON values.' => 'Serialization of PHP-object JSON values.',
    ...
    ',
      ...
      'Result for input "%s".' => 'Result for input "%s".',
      ...
      'The current locale should be available.' => 'The current locale should be available.',
      ...
      'Parents in case "%s".' => 'Parents in case "%s".',
