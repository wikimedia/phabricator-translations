...
final class PhabricatorPeoplePtBR
  ...
  'After you have set a password, you can log in again in the future by going here:' => 'Depois de ter definido uma senha, você pode entrar no Phabricator no futuro, indo aqui:',
  'Bot' => 'Robô',
  ...
  'Remove %s as an administrator? They will no longer be able to perform administrative functions on this server.' => 'Remover %s como administrador? Eles não poderão mais executar funções administrativas na instalação do Phabricator.',
  ...
  '%s renamed this user.' => '%s renomeou este usuário.',
  ...
  '[%s] Email Verification' => '[Phabricator] Verificação de Email',
  ...
  'Disable Account' => 'Desativar usuário',
  ...
  'After you set up your account, you can log in again in the future by going here:' => 'Depois de configurar sua conta, você pode entrar no Phabricator no futuro, indo até aqui:',
  'Disable User Account?' => 'Desativar usuário?',
  'Update Preview' => 'Atualizar pré-visualização',
  'User Account is Disabled' => 'O usuário está desativado',
