...
final class PhabricatorHeraldFrFR
  ...
  'Webhook ID to call' => 'Identifiant de l\'accroche Internet à appeler',
  ...
  '%s changed the URI for this webhook from %s to %s.' => '%s a modifié l’URI de cette accroche Internet de %s en %s.',
  ...
  'Specify a webhook to call with "--id".' => 'Précisez avec « --id » une accroche Internet à appeler.',
  'Matched' => 'Correspondance trouvée',
  'Webhook status "%s" is not valid. Valid statuses are: %s.' => 'L’état de l\'accroche Internet « %s » n’est pas valide. Les états valides sont : %s .',
  'Webhook names can be no longer than %s characters.' => array(
    'Les noms des accroches Internet ne peuvent pas dépasser %s caractère.',
    'Les noms des accroches Internet ne peuvent pas dépasser %s caractères.',
  ),
  ...
  'Test Webhook' => 'Tester l\'accroche Internet',
  ...
  'This engine is used to edit webhooks.' => 'Ce moteur est utilisé pour modifier les accroches Internet.',
  ...
  'Called webhooks: %s.' => 'Accroches Internet appelées : %s.',
  ...
  'This server is running in silent mode, so it will not publish webhooks. To adjust this setting, see @{config:phabricator.silent} in Config.' => 'Ce serveur est configuré en mode silencieux et ne publiera donc aucune accroche Internet. Pour ajuster ce paramètre, regarder @{config:phabricator.silent} dans la configuration.',
  ...
  'Prevent' => 'Empêcher',
  'exists' => 'existe',
  'Regenerate the HMAC key used to sign requests made by this webhook?' => 'Regénérer la clé HMAC utilisée pour signer les requêtes faites par cette accroche Internet ?',
  ...
  'Webhooks must have a URI.' => 'les accroches Internet doivent avoir une URI.',
  'URI for the webhook.' => 'URI de l\'accroche Internet.',
  ...
  'Webhook HMAC Key' => 'Clé HMAC de l\'accroche Internet',
  ...
  'Webhooks must have a name.' => 'Les accroches Internet doivent avoir un nom.',
  ...
  'Webhook URIs can be no longer than %s characters.' => array(
    ...
    'Les URI des accroches Internet ne peuvent pas dépasser %s caractères.',
  ),
  ...
  'Webhook request ("%s", to "%s") failed (%s / %s). The request will be retried.' => 'La requête de l\'accroche Internet (« %s », vers « %s ») a échoué (%s / %s). La requête va être relancée.',
  'Webhook Request %d' => 'Requête de l\'accroche Internet %d',
  ...
  'Unable to load specified webhook ("%s").' => 'Impossible de charger l\'accroche Internet spécifiée (« %s »).',
  ...
  'Webhook request ("%s", to "%s") failed (%s / %s). The request will not be retried.' => 'La requête de l\'accroche Internet (« %s », vers « %s ») a échoué (%s / %s). La requête ne sera pas relancée.',
  ...
  'Webhook Request' => 'Requête de l\'accroche Internet',
  'Unknown Action ("%s")' => 'Action inconnue (« %s »)',
  ...
  'Webhook request ("%s") is not in "%s" status (actual status is "%s"). Declining call to hook.' => 'La requête de l\'accroche Internet (« %s ») n’est pas dans l’état « %s » (l’état réel est « %s »). L’appel à l\'accroche est refusé.',
  'Browse Herald Rules' => 'Parcourir les règles Herald',
  'Edit Webhook' => 'Modifier l\'accroche Internet',
  ...
  'Unable to load webhook request ("%s"). It may have been garbage collected.' => 'Impossible de charger la requête de l\'accroche Internet (« %s »). Elle a pu être recyclée par le ramasse-miettes.',
  ...
  'Queueing webhook calls...' => 'Mise en file d’attente des appels d\'accroches Internet...',
  ...
  'Webhook %d %s' => 'Accroche Internet %d %s',
  ...
  'Can Create Webhooks' => 'Possibilité de créer des accroches Internet',
  ...
  'Browse Webhooks' => 'Afficher les accroches Internet',
  'Field: %s' => 'Champ : %s',
  ...
  'No active Herald rules call this webhook.' => 'Aucune règle active Herald n’appelle cette accroche Internet.',
  'Transcript %d' => 'Transcription %d',
  'Can Manage Global Rules' => 'Peut gérer les règles globales',
  'Called Webhooks' => 'Accroches Internet appelées',
  ...
  'H%d' => 'H%d',
  'User Guide: Webhooks' => 'Guide utilisateur: les accroches Internet',
  'Unable to load object ("%s") for webhook request ("%s").' => 'Impossible de charger l\'objet (« %s ») pour la requête de l\'accroche Internet (« %s »).',
  'Result code "%s" is unknown.' => 'Le code de résultat « %s » est inconnu.',
  'Field Values' => 'Valeurs des champs',
  'contains' => 'contient',
  'Type a webhook name...' => 'Saisissez un nom d\'accroche Internet...',
  'Call a webhook.' => 'Appeler une accroche Internet.',
  ...
  'Calling webhook...' => 'Appel de l\'accroche Internet...',
  ...
  'Do nothing' => 'Ne rien faire',
  '%s %s %s' => '%s %s %s',
  '%s created this webhook.' => '%s a créé cette accroche Internet.',
  '<Unknown Field "%s">' => '<Champ inconnu "%s">',
  ...
  'Herald Webhooks' => 'Accroches Internet Herald',
  ...
  'is any of' => 'est un de',
  'is not' => 'n’est pas',
  'Success, got HTTP %s from webhook.' => 'Succès, l\'accroche Internet a fourni HTTP %s.',
  ...
  'Edit Webhook Configurations' => 'Modifier les configurations des accroches Internet',
  ...
  'Unknown condition \'%s\'.' => 'Condition inconnue « %s ».',
  'Associated hook ("%s") for webhook request ("%s") is disabled.' => 'L\'accroche ("%s") associée à la requête d\'accroche Internet ("%s") est désactivée.',
  ...
  'No webhooks found.' => 'Aucune accroche Internet trouvée.',
  ...
  'You do not have permission to create webhooks.' => 'Vous n’avez pas la permission de créer des accroches Internet.',
  ...
  'This rule was created with a newer version of Herald. You can not view or edit it in this older version. Upgrade your software.' => 'Cette règle a été créée avec une version plus récente d’Herald. Vous ne pouvez pas la voir ou la modifier dans cette version. Mettez à jour votre logiciel.',
