...
final class PhabricatorHeraldFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'This server is running in silent mode, so it will not publish webhooks. To adjust this setting, see @{config:phabricator.silent} in Config.' => 'Ce serveur est configuré en mode silencieux et ne publiera donc aucun point d’ancrage web. Pour ajuster ce paramètre, regarder @{config:phabricator.silent} dans la configuration.',
