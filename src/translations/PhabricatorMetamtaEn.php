...
final class PhabricatorMetamtaEn
  ...
  protected function getTranslations() {
    ...
    Accepting receivers: %s.',
      ...
      'Mailer ("%s") is not configured to support outbound mail.' => 'Mailer ("%s") is not configured to support outbound mail.',
      ...
      'Address: %s' => 'Address: %s',
      'Mailer key ("%s") is not configured. Available keys are: %s.' => 'Mailer key ("%s") is not configured. Available keys are: %s.',
