...
final class PhabricatorSubscriptionsTr
  ...
  'View All %d Subscriber(s)' => 'Tüm %d Üyeyi Gör',
  ...
  'Unmute' => 'Sesi aç',
  'All %d subscribers removed by %s' => '%d abonelerin tümü %s tarafından kaldırıldı',
  ...
  'All %d subscribers added by %s' => '%d abonelerin tümü %s tarafından eklendi',
