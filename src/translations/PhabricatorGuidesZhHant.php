...
final class PhabricatorGuidesZhHant
  ...
  protected function getTranslations() {
    return array(
      'Learn how to configure mail and other options in Phabricator.' => '了解如何在 Phabricator 設置電子郵件與其它選項。',
      ...
      'Customize the default homepage layout and items.' => '自定義預設首頁佈局與項目。',
      ...
      'If you\'re new to Phabricator, these optional steps can help you learn the basics. Conceptually, Phabricator is structured as a graph, and repositories, tasks, and projects are all independent from each other. Feel free to set up Phabricator for how you work best, and explore these features at your own pace.' => '若您是 Phabricator 新手，這些可選步驟能協助您了解基本內容。從概念上來說，Phabricator 是以圖形、版本庫、任務作為架構，且所有專案皆彼此獨立。您可隨時為您的工作方式來設定 Phabricator，並依照自己的進度來探索這些功能。',
      ...
      'You\'ve created at least one dashboard.' => '您已建立至少一個功能面板。',
      'Short Tutorials' => '簡短教程',
      'Invite the rest of your team to get started on Phabricator.' => '邀請您團隊裡的其他成員來開始使用 Phabricator。',
      'Phabricator can deliver notifications in real-time with WebSockets.' => 'Phabricator 能以 WebSockets 來即時傳遞通知。',
      ...
      'See all the applications included in Phabricator.' => '查看所有包含在 Phabricator 的應用程式。',
      'Build a Dashboard' => '建置功能面版',
      ...
      'Authentication providers allow users to register accounts and log in to Phabricator.' => '認證提供方允許使用者註冊帳號且登入到 Phabricator。',
