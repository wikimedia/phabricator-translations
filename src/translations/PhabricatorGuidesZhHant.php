...
final class PhabricatorGuidesZhHant
  ...
  'Guides' => '指南',
  'Learn how to configure mail and other options.' => '了解如何配置電子郵件與其它選項。',
  'Invite the rest of your team to get started.' => '邀請您團隊裡的其他成員來開始使用。',
  'User Account Settings' => '使用者帳號設定',
  'If you\'re new to %s, these optional steps can help you learn the basics. Feel free to set things up for how you work best and explore these features at your own pace.' => '若您是該軟體的新手，這些可選步驟能協助您了解基本內容。您可隨時為您的工作方式來設定，並依照自己的進度來探索這些功能。',
  'You\'ve adjusted at least one setting on your account.' => '您已在您的帳號調整至少一個設定。',
  'Real-time notifications can be delivered with WebSockets.' => '即時通知可以透過 WebSocket 傳送。',
  ...
  'Authentication providers allow users to register accounts and log in.' => '認證提供方允許使用者註冊帳號且登入。',
