...
I just talked to @alincoln, and he showed me that he fixed this.
```',
  'Show Enabled Applications' => 'Mostra les aplicacions instal·lades',
  'Can\'t set non-public capabilities to public.' => 'No pot posar polítiques no públiques a públic.',
  'Launchable' => 'Llançable',
  'You cannot enable an enabled application.' => 'No pots instal·lar una aplicació instal·lada.',
  ...
  'Really Disable Application?' => 'Voleu desinstal·lar l\'aplicació?',
  'Create New Application' => 'Crea una Aplicació Nova',
  'Extension' => 'Extensió',
  'Validation Failed' => 'La validació va Fallar',
  'Really disable the %s application?' => 'Voleu desinstal·lar l’aplicació %s?',
  ...
  'Show Disabled Applications' => 'Mostra les aplicacions desinstal·lades',
  ...
  'This application is required and cannot be disabled.' => 'Aquesta aplicació no es pot desinstal·lar, perquè és necessària perquè funcioni Phabricator.',
  ...
  'Are you absolutely certain you want to disable the Home application?' => 'Esteu absolutament segur de voler desinstal·lar l\'aplicació Home?',
