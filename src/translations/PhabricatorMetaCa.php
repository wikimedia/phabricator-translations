...
final class PhabricatorMetaCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'Capability "%s" is not editable for this application.' => 'La capacitat "%s" no es pot editar per a aquesta aplicació.',
      'Configure' => 'Configura',
      ...
      'Show Released Applications' => 'Mostra aplicacions alliberades',
    ...
    ```',
      ...
      'Type an application name...' => 'Escriviu un nom d\'aplicació...',
