...
final class PhabricatorManiphestNl
  ...
  '%s added %s commit(s) to %s: %s.' => array(
    ...
    array(
      '%s heeft een commit toegevoegd aan %3$s: %4$s.',
      '%s heeft commits toegevoegd aan %3$s: %4$s.',
    ),
  ),
  ...
  '%s changed file(s), attached %s: %s; detached %s: %s.' => '%s heeft bestanden gewijzigd: bijgevoegd: %3$s; verwijderd: %5$s.',
...
Zie het onderstaande voorbeeld als startpunt.',
  ...
  '%s detached %s file(s): %s.' => array(
    ...
    array(
      '%s heeft een bestand verwijderd: %3$s.',
      '%s heeft bestanden verwijderd: %3$s.',
    ),
  ),
  ...
  '%s removed %s parent task(s): %s.' => array(
    ...
    array(
      '%s heeft een bovenliggende taak verwijderd: %3$s.',
      '%s heeft bovenliggende taken verwijderd: %3$s.',
    ),
  ),
  '%s added %s subtask(s): %s.' => array(
    
    array(
      '%s heeft een subtaak toegevoegd: %3$s.',
      '%s heeft subtaken toegevoegd: %3$s.',
    ),
  ),
  ...
  '%s edited %s commit(s), added %s: %s; removed %s: %s.' => '%s heeft commits bewerkt; toegevoegd: %4$s; verwijderd: %6$s.',
  ...
  '%s added %s parent task(s): %s.' => array(
    ...
    array(
      ...
      '%s heeft bovenliggende taken toegevoegd: %3$s.',
    ),
  ),
  ...
  '%s removed %s subtask(s) for %s: %s.' => array(
    ...
    array(
      '%s heeft een subtaak  verwijderd voor %3$s: %4$s.',
      '%s heeft subtaken  verwijderd voor %3$s: %4$s.',
    ),
  ),
  'Untitled Task' => 'Naamloze taak',
  '%s edited parent task(s) for %s, added %s: %s; removed %s: %s.' => '%s heeft bovenliggende taken voor %s bewerkt; toegevoegd: %4$s; verwijderd: %6$s.',
  ...
  'Get tasks which depend on a task.' => 'Haal taken op die afhankelijk zijn van een bepaalde taak.',
...
Als u een ongeldige prioriteit opgeeft, wordt de opdracht genegeerd. Deze opdracht heeft geen effect als u geen prioriteit opgeeft.',
  '%s edited %s revision(s), added %s: %s; removed %s: %s.' => '%s heeft versies bewerkt, toegevoegd: %4$s; verwijderd: %6$s.',
  ...
  'Burnup / Burndown Rate' => 'Burnup / Verbrandingssnelheid',
  '%s added %s revision(s) to %s: %s.' => array(
    
    array(
      '%s heeft %s versie toegevoegd aan %s: %s.',
      '%s heeft %s versies toegevoegd aan %s: %s.',
    ),
  ),
  ...
  '%s attached %d file(s) of %s: %s' => array(
    ...
    array(
      '%s heeft een bestand van %3$s gekoppeld: %4$s',
      '%s heeft bestanden van %3$s gekoppeld: %4$s',
    ),
  ),
  ...
  '%s edited subtask(s) for %s, added %s: %s; removed %s: %s.' => '%s heeft subtaken voor %s bewerkt; toegevoegd: %4$s; verwijderd: %6$s.',
  ...
  '%s removed %s mock(s) for %s: %s.' => array(
    ...
    array(
      '%s heeft een mock verwijderd voor %3$s: %4$s.',
      '%s heeft mock verwijderd voor %3$s: %4$s.',
    ),
  ),
...
"maniphest.default-priority".',
  ...
  '%s removed %s mock(s): %s.' => array(
    ...
    array(
      '%s heeft een mock verwijderd: %3$s.',
      '%s heeft mocks verwijderd: %3$s.',
    ),
  ),
  '%s edited mock(s), added %s: %s; removed %s: %s.' => '%s heeft mocks bewerkt; toegevoegd: %3$s; verwijderd: %5$s.',
...
Zie [[ %s | %s ]] in de documentatie voor details over het toevoegen van aangepaste velden aan Maniphest.',
  ...
  'Parameter "%s" is no longer supported. Use method "%s" with the "%s" constraint instead.' => 'Parameter "%s" wordt niet meer ondersteund. Gebruik in plaats daarvan de methode "%s" met de beperking "%s".',
  ...
  'This task is directly connected to more than %s other tasks, which is too many tasks to display. Use %s to browse parents or subtasks.' => 'Deze taak is direct verbonden met meer dan %s andere taken, wat te veel taken zijn om weer te geven. Gebruik %s om door bovenliggende taken of subtaken te bladeren.',
  ...
  '%s merged %s task(s) %s into %s.' => array(
    ...
    array(
      '%s heeft %3$s samengevoegd in %4$s.',
      '%s heeft taken %3$s samengevoegd in %4$s.',
    ),
  ),
  'No tasks.' => 'Geen taken.',
  ...
  'Get tasks on which a task depends.' => 'Haal de taken op waarvan een bepaalde taak afhankelijk is.',
  ...
  '%s added %s subtask(s) for %s: %s.' => array(
    ...
    array(
      '%s heeft een subtaak  toegevoegd voor %3$s: %4$s.',
      '%s heeft subtaken  toegevoegd voor %3$s: %4$s.',
    ),
  ),
...
Als u de gebruikersnaam weglaat of de gebruikersnaam niet correct is, gedraagt dit zich als `%s` en wordt de taak in plaats daarvan aan u toegewezen.',
  ...
  'This task is directly connected to more than %s other tasks. Use %s to browse parents or subtasks, or %s to show more of the graph.' => 'Deze taak is direct verbonden met meer dan %s andere taken. Gebruik %s om door bovenliggende taken of subtaken te bladeren, of %s om meer van de grafiek weer te geven.',
  'Comma-separated list of task monograms.' => 'Kommagescheiden lijst met taakmonogrammen.',
  '%s edited %s commit(s) for %s, added %s: %s; removed %s: %s.' => '%s heeft commits voor %3$s bewerkt; toegevoegd: %5$s; verwijderd: %7$s.',
  ...
  '%s added %s mock(s) for %s: %s.' => array(
    ...
    array(
      '%s heeft een mock toegevoegd voor %3$s: %4$s.',
      '%s heeft mocks toegevoegd voor %3$s: %4$s.',
    ),
  ),
  ...
  '%s added %s mock(s): %s.' => array(
    ...
    array(
      '%s heeft een mock toegevoegd: %3$s.',
      '%s heeft mocks toegevoegd: %3$s.',
    ),
  ),
...
Zie `%s` om snel een taak te sluiten.',
  ...
  'Must pass an array of integer task IDs for parameter "%s".' => 'Voor parameter "%s" moet een array met integer taak-ID\'s worden doorgegeven.',
  'Task Unassigned' => 'Taak niet toegewezen',
  'Reassign the task.' => 'De taak opnieuw toewijzen.',
  '%s changed file(s) for %s, attached %d: %s; detached %d: %s' => '%s heeft bestanden voor %s gewijzigd; bijgevoegd: %4$s; verwijderd: %6$s',
  ...
  '%s detached %d file(s) of %s: %s' => array(
    ...
    array(
      '%s heeft een bestand van %3$s verwijderd: %4$s',
      '%s heeft bestanden van %3$s verwijderd: %4$s',
    ),
  ),
  'Change subtype to "%s."' => 'Subtype wijzigen naar "%s."',
  ...
  '%s removed %s parent task(s) for %s: %s.' => array(
    ...
    array(
      '%s heeft een bovenliggende taak verwijderd voor %3$s: %4$s.',
      '%s heeft bovenliggende subtaken verwijderd voor %3$s: %4$s.',
    ),
  ),
  ...
  '%s edited %s revision(s) for %s, added %s: %s; removed %s: %s.' => '%s heeft versies voor %3$s bewerkt, toegevoegd: %5$s; verwijderd: %7$s.',
  ...
  '%s added %s parent task(s) for %s: %s.' => array(
    ...
    array(
      '%s heeft een bovenliggende taak toegevoegd voor %3$s: %4$s.',
      '%s heeft bovenliggende subtaken toegevoegd voor %3$s: %4$s.',
    ),
  ),
  ...
  'This task is connected to more than %s other tasks. Only direct parents and subtasks are shown here.' => 'Deze taak is verbonden met meer dan %s andere taken. Alleen directe bovenliggende taken en subtaken worden hier weergegeven.',
  ...
  '%s edited parent task(s), added %s: %s; removed %s: %s.' => '%s heeft bovenliggende taken bewerkt; toegevoegd: %3$s; verwijderd: %5$s.',
  '%s removed %s revision(s) from %s: %s.' => array(
    
    array(
      '%s heeft %s versie verwijderd van %s: %s.',
      '%s heeft %s versies verwijderd van %s: %s.',
    ),
  ),
  '%s merged %s task(s): %s.' => array(
    
    array(
      '%s heeft een taak samengevoegd: %3$s.',
      '%s heeft taken samengevoegd: %3$s.',
    ),
  ),
  '%s edited mock(s) for %s, added %s: %s; removed %s: %s.' => '%s heeft mocks voor %s bewerkt; toegevoegd: %4$s; verwijderd: %6$s.',
  '%s reassigned this task from %s to %s.' => '%s heeft deze taak opnieuw toegewezen van %s aan %s.',
  'Triaged' => 'Geprioriteerd',
  ...
  '%s removed %s commit(s) from %s: %s.' => array(
    ...
    array(
      '%s heeft een commit verwijderd van %3$s: %4$s.',
      '%s heeft commits verwijderd van %3$s: %4$s.',
    ),
  ),
  'Task Owner' => 'Taakeigenaar',
  'By Project' => 'Per project',
  '%s triaged %s as %s priority.' => '%s heeft de prioriteit van %s ingesteld op %s.',
...
vrij tussen subtypen worden geconverteerd met de Bulkeditor of API.',
  ...
  '%s edited subtask(s), added %s: %s; removed %s: %s.' => '%s heeft subtaken bewerkt toegevoegd: %3$s; verwijderd: %5$s.',
  ...
  '%s removed %s subtask(s): %s.' => array(
    ...
    array(
      '%s heeft een subtaak verwijderd: %3$s.',
      '%s heeft subtaken verwijderd: %3$s.',
    ),
  ),
  ...
  '%s triaged this task as %s priority.' => '%s heeft de prioriteit van deze taak ingesteld op %s.',
