...
final class PhabricatorSubscriptionsRu
  ...
  protected function getTranslations() {
    return array(
      ...
      'Remove me as a subscriber' => 'Удалите меня как подписчик',
      'Remove subscribers.' => 'Удалить подписчиков.',
      'Set subscribers, overwriting current value.' => 'Установите подписчиков, перепишите текущее значение.',
      'Support for Subscriptions' => 'Поддержка подписки',
      'Automatically Subscribed' => 'Автоматически подписано',
      '%d other(s)' => '%s другой (ие)',
      'You are automatically subscribed to this object.' => 'Вы автоматически подписываетесь на этот объект.',
      'Add subscribers' => 'Добавить подписчиков',
      'Remove yourself as a subscriber.' => 'Удалите себя как подписчик.',
