...
final class PhabricatorSubscriptionsRu
  ...
  'All %d subscribers removed by %s' => 'Все %d подписчиков, удалённых %s',
  ...
  'All %d subscribers added by %s' => 'Все %d подписчиков, добавлено %s',
