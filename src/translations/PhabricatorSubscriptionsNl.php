...
final class PhabricatorSubscriptionsNl
  ...
  'All %d subscribers removed by %s' => array(
    'Abonnee verwijderd door %2$s',
    'Alle %d abonnees verwijderd door %s',
  ),
  ...
  'Declined to resubscribe %s target(s) because they previously unsubscribed: %s.' => array(
    '%s doel opnieuw abonneren is mislukt omdat die zich eerder had afgemeld: %s.',
    '%s doelen opnieuw abonneren is mislukt omdat die zich eerder hadden afgemeld: %s.',
  ),
  'Removed %s subscriber(s): %s.' => array(
    'Abonnee verwijderd: %2$s.',
    '%s abonnees verwijderd: %s.',
  ),
  ...
  'All %d subscribers added by %s' => array(
    'Abonnee toegevoegd door %2$s',
    'Alle %d abonnees toegevoegd door %s',
  ),
  ...
  '%s automatically subscribed target(s) were not affected: %s.' => array(
    '%s automatisch geabonneerd doel is niet beïnvloed: %s.',
    '%s automatisch geabonneerd doelen zijn niet beïnvloed: %s.',
  ),
  ...
  'This object is temporary and cannot be subscribed to.' => 'Dit object is tijdelijk en er kan niet op geabonneerd worden.',
...
Gebruikers die in de CC van de e-mail zelf staan, worden ook automatisch geabonneerd als hun e-mailadressen gekoppeld zijn aan een bekend account.',
  ...
  'Added %s subscriber(s): %s.' => array(
    '%s abonnee toegevoegd: %s.',
    '%s abonnees toegevoegd: %s.',
  ),
