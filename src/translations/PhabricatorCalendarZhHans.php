...
final class PhabricatorCalendarZhHans
  ...
  'Found unexpected property at ICS document root.' => '在ICS文档根目录发现意外属性。',
  ...
  'Movie' => '电影',
  'Imported events can not be edited.' => '导入的事件无法编辑。',
  'Official Business' => '官方商务',
  'Show invites the current viewer is invited to. This function includes events the user is invited to because a project they are a member of is invited.' => '显示当前查看者受邀参加的邀请。此功能包含用户受邀参加的活动，因为用户所属的项目也受邀参加。',
  'End date and time of the event.' => '活动的结束日期和时间。',
  'Edit This And All Later Events' => '编辑此事件及所有后续事件',
  ...
  'Found malformed property in ICS document.' => '在ICS文档中发现格式错误的属性。',
  'Start time of the event.' => '活动的开始时间。',
  'Invitee "%s" identifies an object that does not exist or which you do not have permission to view.' => '受邀者“%s”标识了一个不存在的对象或您没有权限查看的对象。',
  'Event icon.' => '活动图标。',
  'Too Frequent' => '过于频繁',
  'Cancel this event?' => '取消此活动？',
  'Unable to decode base64 data: %s' => '无法解码base64数据：%s',
  'You can not attach an ICS URI to an import type other than an ICS URI import (type is "%s").' => '您不能附加ICS文件至任何除ICS导入以外的导入类型（类型为“%s”）。',
  'This event is an instance of %s, and repeats every year.' => '此事件是%s的一个实例，每年重复发生。',
  'Uses Import Policy' => '使用导入方针',
  'Weekly' => '每周',
  'Anyone who knows the URI for this export can view all event details as though they were logged in with your account.' => '任何知道此导出的URI的人都可以查看所有事件详细信息，就像他们使用您的帐户登录一样。',
  'Recurring event range queries must have an end date, a limit, or both.' => '重复事件范围查询必须有结束日期、限制或两者。',
  'To RSVP to the event, specify the desired RSVP, like `!rsvp yes`. This table shows the configured names for rsvp\'s.

%s

If you specify an invalid rsvp, the command is ignored. This command has no effect if you do not specify an rsvp.' => '要回复活动回复，请指定所需的回复方式，例如“!rsvp yes”。下表显示了已配置的回复方式名称。

%s 

如果您指定的回复方式无效，则该命令将被忽略。如果您未指定回复方式，则该命令无效。',
  ...
  'Expected "PhutilCalendarDuration" object or ISO8601 duration string.' => '预期为“PhutilCalendarDuration”对象或ISO8601持续时间字符串。',
  ...
  '%s updated the event description for %s.' => '%s更新了%s事件描述。',
  '.ics URI' => '.ics URI',
  'Travel' => '旅行',
