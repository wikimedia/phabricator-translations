...
final class PhabricatorPeopleKo
  ...
  protected function getTranslations() {
    return array(
      ...
      'Generate default profile images.' => '기본 프로파일 그림을 생성합니다.',
      ...
      '"%s" is not a valid username.' => '"%s"은(는) 유효한 사용자 이름이 아닙니다.',
      ...
      'IP' => 'IP',
      'Add/Remove Mailing List' => '메일링 리스트 추가/제거',
      'Unapproved' => '미승인',
