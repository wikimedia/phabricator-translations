...
final class PhabricatorProjectFrFR
  ...
  '%s changed project member(s), added %d: %s; removed %d: %s.' => '%s a changé un ou plusieurs membres du projet ; en a ajouté %d : %s ; en a retiré %d : %s.',
  ...
  '%s added %d project hashtag(s): %s.' => array(
    ...
    array(
      '%s a ajouté %d balise de projet : %s.',
      '%s a ajouté %d balises de projet : %s.',
    ),
  ),
  ...
  '%s changed %s hashtag(s), added %d: %s; removed %d: %s.' => '%s a changé %s mot(s)-dièse ; en a ajouté %d : %s ; en a retiré %d : %s.',
...
Consultez le [[ %s | Guide d’utilisation des projets ]] dans la documentation pour plus de détails. Ce processus ne peut pas être annulé.',
  ...
  'You must select at least one user or project tag to remove.' => 'Vous devez sélectionner au moins un utilisateur ou balise de projet à retirer.',
...
Cela exclura les résultats avec toute autre balise de projet.',
  ...
  'Remove subscribers rule value should be a list, but is not (value is "%s").' => 'La valeur de la règle de retirage d’abonnés doit être une liste, mais ce n’est pas le cas (la valeur est « %s »).',
...
> ios, not(bug)',
  ...
  '%s added %d project member(s): %s.' => array(
    ...
    array(
      '%s a ajouté %d membre de projet: %s.',
      '%s a ajouté %d membres de projet: %s.',
    ),
  ),
  'Column: %s' => 'Colonne: %s',
  ...
  'Project tags incl their milestones (only use with Include None Of!)' => 'Balises de projet, y compris leurs jalons (à utiliser uniquement avec None)',
  ...
  'Workload: All %d open tasks are unassigned.' => 'Charge de travail : toutes les %d tâches ouvertes ne sont affectées à personne.',
...
%s',
  ...
  'Search for objects with specific project PHIDs.' => 'Rechercher des objets avec des identifiants PHID de projets spécifiques.',
...
Vous pouvez consulter la configuration par défaut ci-dessous pour un exemple de configuration valide.',
  ...
  '%s removed %d project hashtag(s): %s.' => array(
    ...
    array(
      '%s a retiré %d balise de projet : %s.',
      '%s a retiré %d balises de projet : %s.',
    ),
  ),
...
%s',
  ...
  '%s added %d %s hashtag(s): %s.' => array(
    ...
    array(
      '%s a ajouté %d balise à %s : %s.',
      '%s a ajouté %d balises à %s : %s.',
    ),
  ),
  ...
  'Workload: %d of %d open tasks are assigned to %d people.' => 'Charge de travail : %d des %d tâches ouvertes sont affectées à %d personnes.',
  ...
  'Workload: All %d open tasks are assigned to %d people.' => 'Charge de travail : toutes les %d tâches ouvertes sont affectées à %d personnes.',
...
Cela signifie normalement //vos// projets, mais si vous enregistrez une requête à l’aide de cette fonction et l’envoyez à quelqu’un d’autre, cela signifiera //leurs// projets lorsqu’ils l’exécuteront (ils deviendront le visiteur en cours). Cela peut être utile pour créer des panneaux de tableau de bord.',
  ...
  '%s changed project hashtag(s), added %d: %s; removed %d: %s.' => '%s a changé un ou plusieurs mots-dièse ; en a ajouté %d : %s ; en a retiré %d : %s.',
...
Pour plus de détails sur l\'ajout de nouveaux champs, voir [[ %s | %s ]] dans la documentation.',
  ...
  'Add project rule value should be a list, but is not (value is "%s").' => 'La valeur de la règle d’ajout de projet doit être une liste, mais ce n’est pas le cas (la valeur est « %s »).',
  ...
  '%s removed %d project member(s): %s.' => array(
    ...
    array(
      '%s a retiré %d membre de projet : %s.',
      '%s a retiré %d membres de projet : %s.',
    ),
  ),
  ...
  'You must select at least one user or project tag to add.' => 'Vous devez sélectionner au moins un utilisateur ou balise de projet à ajouter.',
  ...
  '%s removed %d %s hashtag(s): %s.' => array(
    ...
    array(
      '%s a retiré %d balise de %s : %s.',
      '%s a retiré %d balises de %s : %s.',
    ),
  ),
