...
final class PhabricatorProjectFrFR
  ...
  protected function getTranslations() {
    ...
    > ios, not(bug)',
      ...
      'Workload: All %d open tasks are unassigned.' => 'Charge de travail : toutes les %s tâches ouvertes ne sont affectées à personne.',
    ...
    Pour plus de détails sur l\'ajout de nouveaux champs, voir [[ %s | %s ]] dans la documentation.',
      ...
      'Week' => 'Semaine',
      'Slugs' => 'Tuyaux',
      'Tasks resolved this %s: %d' => 'Tâches résolues ce %s : %s',
