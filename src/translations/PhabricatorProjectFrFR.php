...
final class PhabricatorProjectFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      '%s changed %s hashtag(s), added %d: %s; removed %d: %s.' => '%s a modifié %s balise(s), ajouté %s : %s; retiré %s : %s.',
    ...
    Consultez le [[%s|Guide d’utilisation des projets]] dans la documentation pour plus de détails. Ce processus ne peut pas être défait.',
      ...
      'You will no longer receive email or notifications about every object associated with this project.' => 'Vous ne recevrez plus d’e-mails ou de notifications concernant chaque objet associé à ce projet.',
      ...
      '%s changed the trigger for this column from %s to %s.' => '%s a modifié le déclencheur pour cette colonne de %s vers %s.',
      ...
      'Trigger names must not be longer than %s characters.' => 'Les noms des déclencheurs ne doivent pas dépasser %s caractères.',
      'Members: ...' => 'Membres: ...',
    ...
    %s',
      ...
      '%s removed %d %s hashtag(s): %s.' => array(
        array(
          '%s a supprimé %s balise à %s : %s.',
          '%s a supprimé %s balises à %s : %s.',
        ),
      ),
