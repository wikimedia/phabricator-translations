...
final class PhabricatorProjectFrFR
  ...
  protected function getTranslations() {
    ...
    Consultez le [[%s|Guide d’utilisation des projets]] dans la documentation pour plus de détails. Ce processus ne peut pas être défait.',
      ...
      'Choose a column on the %s workboard to move tasks to:' => 'Choisissez une colonne du tableau de bord %s pour y déplacer des tâches :',
      ...
      'Choose a valid column on the target workboard to move tasks to.' => 'Choisissez une colonne valide sur le tableau de bord cible afin d’y déplacer des tâches.',
    ...
    %s',
      ...
      '%s marked this column visible.' => '%s a marqué cette colonne comme visible.',
      ...
      'Unable to find object "%s" in column "%s" on board "%s".' => 'Impossible de trouver l’objet « %s » dans la colonne « %s » du tableau « %s ».',
