...
final class PhabricatorextCoreNl
  ...
  'Escalate' => 'Escaleren',
  'Next: %s' => 'Volgende: %s',
  'Standard Phabricator.' => 'Standaard Phabricator.',
...
OPMERKING: Voordat Phabricator zich succesvol kan authenticeren bij uw MediaWiki, moet een wiki-beheerder de OAuth-gebruikersregistratie goedkeuren via het formulier dat u kunt vinden op de volgende url: %s',
  'Deny' => 'Weigeren',
  'Invalid' => 'Onjuist',
  ...
  'Enable expert mode to reveal additional "advanced" options in the Phabricator UI.' => 'Schakel de expertmodus in om extra "gevorderde" opties in de Phabricator-gebruikersinterface weer te geven.',
...
In de volgende stap maakt u een OAuth-consumer aan in MediaWiki die door Phabricator OAuth gebruikt kan worden.',
  ...
  'Create custom access control policy objects.' => 'Maak aangepaste toegangsbeheerbeleidsobjecten aan.',
...
`mediawiki`, `mediawiki.mycompany` of `mediawiki.engineering` zijn geschikte namen.',
  ...
  'Changed Subtype' => 'Heeft subtype gewijzigd',
