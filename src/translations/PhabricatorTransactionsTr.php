...
final class PhabricatorTransactionsTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'The selected %s policy excludes you. Choose a %s policy which allows you to %s the object.' => 'Seçilen %s politika sizi kapsam dışı bırakıyor. Nesneyi %3$s olarak ayarlamanızı sağlayan %2$s bir politika seçin.',
      'All users are already subscribed to this %s.' => 'Tüm kullanıcılar zaten bu %s\'a abone oldu.',
      ...
      'The %s action(s) you are taking have no effect:' => 'Aldığınız %s işlem(ler) etkisizdir:',
      '%s removed %s subscriber(s) for %s: %s.' => '%s, %3$s karşılığında %2$s abonesini kaldırdı: %s.',
      'Engine: Editor' => 'Motor: Editör',
      '%s moved %s to %s on the %s board.' => '%s, %4$s panosuna %2$s\'ı %3$s\'a taşıdı.',
      ...
      '%s marked %s inline comment(s) as done.' => '%s, yapıldığı gibi %s satır içi yorum(lar) olarak işaretlendi.',
      ...
      '%s edited subscriber(s), added %s: %s; removed %s: %s.' => '%s düzenlenen abone(ler), %s eklendi: %s; %s kaldırıldı: %s.',
      'Take Action' => 'Harekete Geç',
      'Use "--output <path>" to specify an output file, or "--output -" to print to stdout.' => 'Bir çıktı dosyası belirtmek için "--output <path>" ya da stdout\'a yazdırmak için "--output -" kullanın.',
      'Form Disabled' => 'Form Devre Dışı',
      'Failed to serialize() value for key "%s".' => '"%s" anahtarının() değeri seri hale getirilemedi.',
      '%s marked %s inline comment(s) as not done.' => '%s, yapılmadığı gibi %s satır içi yorum(lar) olarak işaretlendi.',
      ...
      '%s moved %s on %s board(s): %s.' => '%s, %3$s\'lık panolara %2$s\'a taşındı: %s.',
      'Transactions' => 'İşlemler',
      'Export format.' => 'İhracat formatı',
      ...
      'You are editing the default values for this form.' => 'Bu form için varsayılan değerleri düzenliyorsunuz.',
      ...
      'Mark this form as an edit form? Users who can view it will be able to use it to edit objects.' => 'Bu formu düzenleme formu olarak işaretlesin mi? Onu görüntüleyebilen kullanıcılar nesneleri düzenlemek için kullanabilecekler.',
      ...
      '%s rescinded a token.' => '%s bir jetonu iptal etti.',
      '%s awarded a token.' => '%s jetonu aldı.',
      'Mentioned or subscribed users will not be notified.' => 'Bahsedilen veya abone olunan kullanıcılar bilgilendirilmeyecek.',
      'New object subtype key.' => 'Yeni nesne alt türü anahtarı.',
      'Acting User' => 'Kullanıcı Vekili',
      '%s added a comment to %s.' => '%s, %s\'a yorum yaptı.',
      ...
      '%s removed %d subscriber(s): %s.' => '%s, %s abone sayısını kaldırdı: %s.',
      ...
      'Change how forms in other applications are created and edited. Advanced!' => 'Diğer uygulamalardaki formların nasıl oluşturulduğunu ve düzenlendiğini değiştirin. İleri!',
      'Form Order' => 'Form Siparişi',
      'Mention In' => 'Bahseden',
      ...
      'Transaction must have a PHID before calling %s!' => '%s\'i aramadan önce işlemin bir PHID\'si olmalı!',
      ...
      'No MFA' => 'MFA yok',
      '%s removed %s contributor(s) for %s: %s.' => '%s, %3$s karşılığında %2$s katkıcı(ları) kaldırdı: %s',
      'Export format ("%s") is not enabled.' => 'Dışa aktarma biçimi ("%s") etkin değil.',
      'This method is new and experimental.' => 'Bu yöntem yeni ve deneysel.',
      ...
      '%s edited a custom field on %s.' => '%s, %s\'da özel bir alanı düzenledi.',
      'Mention' => 'Bahsetme',
      'export' => 'dışa aktar',
      ...
      '%s moved this task to %s on the %s board.' => '%s, bu görevi %3$s kartında %2$s\'a taşıdı.',
      ...
      '%s removed %s contributor(s): %s.' => '%s, %s katkı(ları) kaldırdı: %s.',
      ...
      'Subtype configuration is invalid: subtype with key "%s" specifies both child subtypes and child forms. Specify one or the other, but not both.' => 'Alt tip konfigürasyonu geçersiz: "%s" anahtarlı alt tip hem alt tip hem de alt formları belirtir. Birini veya diğerini belirtin, ancak ikisini birden değil.',
      ...
      'No object "%s" exists.' => '"%s" nesnesi yok.',
      ...
      'Save Edit Order' => 'Düzenleme Siparişini Kaydet',
      '%s created this form configuration.' => '%s bu form yapılandırmasını oluşturdu.',
      '%s removed %s unsubscriber(s): %s.' => '%s, %s abone sayısını kaldırdı: %s.',
      'EMAIL PREFERENCES' => 'E-POSTA TERCİHLERİ',
      '%s edited this object (transaction type "%s").' => '%s bu nesneyi düzenledi (işlem türü "%s").',
      'Mark as "Edit" Form' => '"Düzenleme" Formu Olarak İşaretle',
      '%s edited watcher(s) for %s, added %s: %s; removed %s: %s.' => '%s için %s düzenlenmiş izleyici(ler), ekledi %s: %s; kaldırıldı %s: %s.',
      ...
      '%s removed %s file(s) for %s: %s.' => '%s, %3$s için %2$s\'lık dosyayı kaldırdı: %s.',
      ...
      'This is a draft revision that will not publish any notifications until the author requests review.' => 'Bu, yazar inceleme talebinde bulunmadan hiçbir bildirim yayınlamayacak bir taslak revizyondur.',
      ...
      '%s removed %s watcher(s) for %s: %s.' => '%s, %3$s karşılığında %2$s izleyici adlı kullanıcıyı kaldırdı: %s',
      '%s moved %s from %s to %s on the %s board.' => '%s, %5$s panosunda %2$s\'ı %3$s\'dan %4$s\'a taşıdı.',
      ...
      '%s edited unsubscriber(s) for %s, added %s: %s; removed %s: %s.' => '%s, abonelikten ayrılanları %s için düzenledi, %s: %s; %s kaldırıldı: %s',
      ...
      'Subtype configuration is invalid: subtype with key "%s" has no name. Subtypes must have a name.' => 'Alt tip konfigürasyonu geçersiz: "%s" anahtarlı alt tipin adı yoktur. Alt türlerin bir adı olmalı.',
      'Comment to add, formatted as remarkup.' => 'Eklemek, yorum olarak biçimlendirilmiş yorum.',
      ...
      'This %s already has that join policy.' => 'Bu %s\'ın zaten birleştirme politikası var.',
      ...
      '%s moved this task on %s board(s): %s.' => '%s, bu görevi %s\'lık panolara taşıdı: %s.',
      ...
      'Save Create Order' => 'Sipariş Oluştur',
      '%s updated subscribers of %s.' => '%s, %s aboneyi güncelledi.',
      '%s created this object.' => '%s bu nesneyi oluşturdu.',
      '%s removed %s file(s): %s.' => '%s, %s\'ı kaldırıldı: %s.',
      ...
      '%s edited contributor(s) for %s, added %s: %s; removed %s: %s.' => '%s için düzenlenmiş %s katkı(lar) yapan kişi, %s: %s; %s kaldırıldı: %s.',
      ...
      '%s edited subscriber(s) for %s, added %s: %s; removed %s: %s.' => '%s için %s düzenlenen abone(ler), %s: %s; %s kaldırıldı: %s',
      ...
      '%s added %s unsubscriber(s): %s.' => '%s, %s abonelikten ayrıldı: %s.',
      ...
      '%s edited this %s.' => '%s, bu %s\'ı düzenledi.',
      ...
      'If the output file already exists, overwrite it instead of raising an error.' => 'Çıktı dosyası zaten varsa, bir hata oluşturmak yerine üzerine yazın.',
      ...
      'Exported data to "%s".' => 'Veriler "%s"\'e aktarıldı.',
      '%s edited subscriber(s), added %d: %s; removed %d: %s.' => '%s düzenlenen abone(ler), %s eklendi: %s; %s kaldırıldı: %s.',
      ...
      '%s mentioned this in %s.' => '%s, %s içinde belirtti.',
      '%s created this object with join policy "%s".' => '%s bu nesneyi "%s" ile birleştirdi.',
      'Subtype configuration is invalid: it must be a list of subtype specifications.' => 'Alt tip konfigürasyonu geçersiz: alt tip özelliklerinin bir listesi olmalıdır.',
      'Use Form' => 'Formu Kullan',
      'The command "!%s" is not a supported mail command. Valid commands for this object are: %s.' => '"!%s" komutu desteklenen bir posta komutu değil. Bu nesne için geçerli komutlar: %s.',
      ...
      'Custom field transaction \'%s\' does not implement integration for %s.' => '\'%s\' özel alan işlemi %s\'a entegrasyon uygulamıyor.',
      ...
      '%s changed the join policy from "%s" to "%s".' => '%s, katılım politikasını "%s" den "%s" e değiştirdi.',
      '%s updated subscribers...' => '%s güncellenmiş abone...',
      'Remove Comment' => 'Yorumu Sil',
      'Transaction (of type "%s") has no effect.' => 'İşlemin ("%s" tipinde) etkisi yoktur.',
      'Make Builtin Editable' => 'Yerleşiki Düzenlenebilir Yap',
      ...
      '%s edited file(s), added %s: %s; removed %s: %s.' => '%s düzenlenmiş dosya(lar), %s ekledi: %s; %s kaldırıldı: %s.',
      ...
      '%s added %s contributor(s): %s.' => '%s, %s katkıcı(ları) ekledi: %s.',
      '%s removed %s watcher(s): %s.' => '%s, %s izleyici(leri) kaldırdı: %s.',
      ...
      'Object "%s" does not implement "%s", so transactions can not be loaded for it.' => '"%s" nesnesi "%s" uygulamıyor, bu yüzden bunun için işlemler yüklenemiyor.',
      '%s added %s watcher(s): %s.' => '%s, %s izleyici(leri) eklendi: %s.',
      ...
      'Flag "--overwrite" has no effect when outputting to stdout.' => '"--overwrite" bayrağının stdout çıktısı alındığında hiçbir etkisi yoktur.',
      ...
      '%s edited file(s) for %s, added %s: %s; removed %s: %s.' => '%s için %s düzenlenmiş dosya(lar), ekledi %s: %s; kaldırıldı %s: %s.',
      ...
      '%s shifted %s from the %s space to the %s space.' => '%s, %s\'ı %s alanından %s alanına kaydırdı.',
      '%s named this form "%s".' => '%s bu formu "%s" olarak adlandırdı.',
      'Warning: Unexpected Effects' => 'Uyarı: Beklenmeyen Etkiler',
      ...
      'Add Another Action' => 'Başka Bir İşlem Ekle',
      ...
      '%s marked %s inline comment(s) as done and %s inline comment(s) as not done.' => '%s, yapıldığı gibi %s satır içi yorum(lar) ve yapılmadığı gibi %s satır içi yorum(lar) olarak işaretlendi.',
      '!%s (or %s)' => '!%s (veya %s)',
      ...
      '%s renamed this form from "%s" to "%s".' => '%s, bu formu "%s" den "%s" e değiştirdi.',
      ...
      '%s Action(s) With No Effect' => '%s Etkili Olmayan Eylem(ler)',
      ...
      'If no rules match, %s all other users.' => 'Kurallar eşleşmezse, diğer tüm kullanıcılar %s.',
      ...
      '%s changed the default value for field "%s".' => '%s, "%s" alanı için varsayılan değeri değiştirdi.',
      ...
      '%s Action(s) Have No Effect' => '%s İşlem(ler) Etkisi Yok',
      '%s changed the subtype of this form from "%s" to "%s".' => '%s, bu formun alt türünü "%s" den "%s" e değiştirdi.',
      ...
      '%s edited watcher(s), added %s: %s; removed %s: %s.' => '%s düzenlenmiş izleyici(ler), %s ekledi: %s; %s kaldırıldı: %s.',
      '%s edited unsubscriber(s), added %s: %s; removed %s: %s.' => '%s, abone olmayan(ları) düzenledi, %s eklendi: %s; %s kaldırıldı: %s.',
      ...
      '%s updated a token.' => '%s bir jetonu güncelledi.',
      'Form Preview' => 'Form Önizle',
      ...
      '%s edited contributor(s), added %s: %s; removed %s: %s.' => '%s, katkı(lar) düzenlendi, %s eklendi: %s; %s kaldırıldı: %s.',
      ...
      '%s added %s contributor(s) for %s: %s.' => '%s, %3$s için %2$s katkı(ları) eklendi: %s',
      '%s changed the edit policy from "%s" to "%s".' => '%s, düzenleme politikasını "%s" den "%s" e değiştirdi.',
      ...
      'When calling "transaction.search", you must provide an object to retrieve transactions for.' => '"transaction.search" işlevini çağırırken, işlemlerin alınacağı bir nesne sağlamalısınız.',
      '%s changed the visibility from "%s" to "%s".' => '%s görünürlük değerini "%s" den "%s" e değiştirdi.',
