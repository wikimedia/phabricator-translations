...
final class PhabricatorHarbormasterCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'Retrieve information about Harbormaster build targets.' => 'Recupereu informació sobre els objectius de construcció de Harbormaster.',
      ...
      'Choose a build target to attach the log to with "--target".' => 'Trieu un objectiu de construcció al qual connectar el registre amb \'--target\'.',
      ...
      'Unable to determine how to fetch changes: this buildable does not identify a commit or a staging ref. You may need to configure a repository staging area.' => 'No es pot determinar com obtenir els canvis: aquesta referència construïble no identifica cap validació ni cap ref. És possible que hàgiu de configurar una àrea de prova del repositori.',
      ...
      'Abort Older Builds' => 'Avorta les construccions més antigues',
      'Pause Build' => 'Pausa la construcció',
      'Interacting with External Build Systems' => 'Interacció amb sistemes de construcció externs',
      'Progress on this build will be discarded. Really abort build?' => 'Es descartaran els avenços en aquesta construcció. Realment interrompre la construcció?',
      'Artifact %d' => 'Artefacte %s',
      'Path to the file containing the lint message, from the project root.' => 'Camí al fitxer que conté el missatge del lint, des de l\'arrel del projecte.',
      ...
      'Invalid buildable PHID "%s".' => 'PHID construïble \'%s\' no vàlid.',
      ...
      'Build target this log is attached to.' => 'Objectiu de construcció al qual està unit aquest registre.',
      ...
      'Standalone Log Fragment' => 'Fragment de registre autònom',
      ...
      'Drydock lease PHID "%s" does not correspond to a valid lease.' => 'L\'arrendament de Drydock PHID "%s" no correspon a un arrendament vàlid.',
      ...
      'Object ("%s") claims "%s" is a GitHub repository URI, but the path ("%s") does not have enough components (expected at least two).' => 'L\'objecte ("%s") afirma que "%s" és un URI del repositori GitHub, però el camí d\'accés ("%s") no té prou components (s\'espera almenys dos).',
    ...
    Si el funcionament de la construcció té un efecte secundari com el desplegament de codi, poden forçar el desplegament d\'una versió vulnerable i després intensificar-se en un atac contra el servei desplegat.',
      ...
      'Really restart build?' => 'Realment reiniciar la construcció?',
      ...
      'You can not process build log chunks unless the log lock is held.' => 'No podeu processar trossos de registre de construcció tret que es mantingui el bloqueig de registre.',
      'No buildables found.' => 'No s\'ha trobat cap construïble.',
      'Invalid build log PHID "%s".' => 'Registre de construcció PHID \'%s\' no vàlid.',
      'References a host lease from Drydock.' => 'Fa referència a un arrendament d’amfitrió de Drydock.',
      'Type a build status name...' => 'Escriu un nom d\'estat de construcció...',
      ...
      'No active Herald rules trigger this build.' => 'No hi ha regles actives del Herald que activin aquesta construcció.',
      ...
      'Type a build plan name...' => 'Escriviu un nom de pla de construcció...',
      ...
      'Build Target PHID' => 'Construeix el PHID objectiu',
      ...
      'Publish a buildable. This is primarily useful for developing and debugging applications which have buildable objects.' => 'Publiqueu una versió construïble. Això és útil sobretot per desenvolupar i depurar aplicacions que tinguin objectes construïbles.',
    ...
    Si voleu evitar que es reiniciï una construcció, podeu canviar quan es pot reiniciar ajustant aquest comportament. Això pot ser útil per prevenir accidents on una construcció amb un efecte lateral perillós (com el desplegament) es reinicia de manera inadequada.',
      ...
      'Unable to determine how to clone the repository for this buildable: it is not associated with a tracked repository.' => 'No es pot determinar com clonar el repositori per a aquesta versió construïble: no està associat amb un repositori rastrejat.',
      ...
      'Really abort builds?' => 'Realment interrompre les construccions?',
      ...
      'Really abort build?' => 'Realment interrompre la construcció?',
      'Browse Build Plans' => 'Consulteu els plans de construcció',
      'The PHID of the user or Object that initiated the build, if applicable.' => 'El PHID de l\'usuari o objecte que va iniciar la construcció, si escau.',
      ...
      'Retrieve information about Harbormaster build plans.' => 'Recupereu informació sobre els plans de construcció de Harbormaster.',
      ...
      'Standalone Fragment' => 'Fragment autònom',
      ...
      'Search for artifacts attached to particular build targets.' => 'Cerqueu artefactes units a objectius de construcció concrets.',
      ...
      'PHID of the object containing this buildable.' => 'PHID de l\'objecte que conté aquest construïble.',
      ...
      'Type another build step name...' => 'Escriu un altre nom d\'etapa de construcció...',
      ...
      'PHID of the build plan being run.' => 'PHID del pla de construcció que s\'està executant.',
    ...
    La intenció general d\'aquest flux de treball és assegurar-se que els revisors només estan passant temps en la revisió una vegada els canvis sobrevisquin a les proves automatitzades. Si un canvi no passa les proves, normalment no està realment llest per a ser revisat. 
    ...
    Si seleccioneu **Accepta per al missatge**, el pla de construcció es posarà en pausa indefinidament una vegada que aquest pas acabi.  Per reprendre la construcció, un sistema extern ha de trucar. `harbormaster.sendmessage` amb el PHID de la construcció, i `"pass"` o `"fail"`per indicar el resultat d\'aquest pas. Després de registrar el resultat, el pla de construcció es reprendrà.',
      ...
      'You are viewing an older run of this build. %s' => 'Esteu veient una versió més antiga d\'aquesta construcció.  %s',
    ...
    Aquest ajustament també afecta l\'avís que es publica a les revisions quan es valida la terra amb construccions en curs o fallides.',
