...
final class PhabricatorAuditCa
  ...
  'Unknown Audit Request Status ("%s")' => 'Estat desconegut de la sol·licitud d\'auditoria («%s»)',
  ...
  'Find or exclude permanent commits which are ancestors of any permanent branch, tag, or ref.' => 'Cerca o exclou les comissions permanents que són avantpassats de qualsevol branca permanent, etiqueta o ref.',
  ...
  '(This commit affected more than %d files. Only %d are shown here and additional ones are truncated.)' => '(Aquesta validació ha afectat més de %d fitxers. Només es mostren %d aquí i es trunquen els addicionals.)',
  ...
  'Diffusion Raw Commits' => 'Publicacions de validacions en brut',
  ...
  'Hide Permanent Commits' => 'Amaga les validacions permanents',
  ...
  'Deleting audit %d...' => 'Eliminant l\'auditoria %d...',
  'A commit has a concern raised against it.' => 'Una validació té un comentari en contra.',
  ...
  'Show Only Permanent Commits' => 'Mostra només les validacions permanents',
