...
final class PhabricatorSlowvoteEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Option ("%s") is not a valid poll option. You may only vote for valid options.' => 'Option ("%s") is not a valid poll option. You may only vote for valid options.',
      '%s made %s responses appear in a random order.' => '%s made %s responses appear in a random order.',
      'Create Slowvote' => 'Create Slowvote',
      '%s changed the voting method of %s from %s to %s.' => '%s changed the voting method of %s from %s to %s.',
      'No such poll exists.' => 'No such poll exists.',
      '%s changed the voting method from %s to %s.' => '%s changed the voting method from %s to %s.',
      'Edit Poll' => 'Edit Poll',
      ...
      'Read information about polls.' => 'Read information about polls.',
      'Voters' => 'Voters',
      'The name of the poll.' => 'The name of the poll.',
      'You must vote to see the results.' => 'You must vote to see the results.',
      'Edit Poll: %s' => 'Edit Poll: %s',
      'You must vote for at least one option.' => 'You must vote for at least one option.',
      ...
      '%s changed the status of this poll from %s to %s.' => '%s changed the status of this poll from %s to %s.',
      ...
      'Approval' => 'Approval',
      'You must vote for something.' => 'You must vote for something.',
      ...
      'Anyone can see the responses' => 'Anyone can see the responses',
      ...
      '%s changed who can see the responses from %s to %s.' => '%s changed who can see the responses from %s to %s.',
      'In this poll, you may only vote for one option.' => 'In this poll, you may only vote for one option.',
      '%s changed who can see the responses of %s from %s to %s.' => '%s changed who can see the responses of %s from %s to %s.',
      'Voting improves cardiovascular endurance.' => 'Voting improves cardiovascular endurance.',
      'Stand For Something' => 'Stand For Something',
      'The author of the poll.' => 'The author of the poll.',
      'Plurality (Single Choice)' => 'Plurality (Single Choice)',
      'Replaced by "slowvote.poll.search".' => 'Replaced by "slowvote.poll.search".',
      'Response %d' => 'Response %s',
      'Only the poll owner can see the responses' => 'Only the poll owner can see the responses',
