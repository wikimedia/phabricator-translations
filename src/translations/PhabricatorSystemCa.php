...
final class PhabricatorSystemCa
  ...
  protected function getTranslations() {
    ...
    ' => 'Destruint %s **%s**...',
      ...
      'This request was served from a replica database. Replica databases may lag behind the master, so very recent activity may not be reflected in the UI. This data will be restored if the master database is restored, but may have been lost if the master database has been reduced to a pile of ash.' => 'Aquesta sol·licitud s\'ha servit des d\'una base de dades de rèpliques. Les bases de dades de rèpliques poden quedar enrere del mestre, de manera que és possible que l’activitat molt recent no es reflecteixi a la interfície d’usuari. Aquestes dades es restauraran si es restaura la base de dades mestra, però es poden haver perdut si la base de dades mestra s\'ha reduït a un munt de cendres.',
    ...
    These tattered edges are an expected consequence of destroying objects, and the Phabricator upstream will not help you fix them. We strongly recommend disabling or archiving objects instead.' => 'La destrucció d\'objectes pot fer que els objectes relacionats deixin de funcionar i poden deixar referències disperses a objectes que ja no existeixen. En la majoria dels casos, és molt millor desactivar o arxivar objectes en lloc de destruir-los. 
    Aquest risc és més gran en suprimir objectes complexos o altament connectats com repositoris, projectes i usuaris. Aquestes vores esglaonades són una conseqüència esperada de destruir objectes i el Phabricator aigües amunt no us ajudarà a solucionar-los. En el seu lloc, es recomana desactivar o arxivar objectes.',
      'IMPORTANT' => 'IMPORTANT',
      'Quite Unsettling' => 'Molt inestable',
      'Destruction Logs' => 'Destrucció de logs',
      ...
      'Objects will be permanently destroyed. There is no way to undo this operation or ever retrieve this data unless you maintain external backups.' => 'Els objectes seran destruïts permanentment. No hi ha manera de desfer aquesta operació ni de recuperar mai aquestes dades tret que mantingueu còpies de seguretat externes.',
      ...
      'Cache engine extension "%s" returned object (of class "%s") with no PHID.' => 'L\'extensió del motor de memòria cau "%s" ha retornat l\'objecte (de la classe "%s") sense PHID.',
      'System' => 'Sistema',
      'You are performing too many actions too quickly.' => 'Esteu realitzant massa accions massa ràpidament.',
      'Phabricator will periodically retry the connection and recover once service is restored. Most causes of persistent service interruption will require administrative intervention in order to restore service.' => 'Phabricator tornarà a provar periòdicament la connexió i es recuperarà un cop restaurat el servei. La majoria de les causes de la interrupció persistent del servei requeriran una intervenció administrativa per restaurar el servei.',
      ...
      'Cache engine extension "%s" did not return a list of linked objects.' => 'L\'extensió del motor de memòria cau "%s" no ha retornat cap llista d\'objectes enllaçats.',
