...
final class PhabricatorAuditTr
  ...
  'Find or exclude permanent commits which are ancestors of any permanent branch, tag, or ref.' => '',
  ...
  '(This commit affected more than %d files. Only %d are shown here and additional ones are truncated.)' => '(Bu işlem %d\'den fazla dosyayı etkiledi. Burada yalnızca %d gösteriliyor ve ek dosyalar kesiliyor.)',
  ...
  'Deleting audit %d...' => 'Denetim %d siliniyor...',
  'A commit has a concern raised against it.' => 'Bir taahhüdün buna karşı bir endişesi vardır.',
