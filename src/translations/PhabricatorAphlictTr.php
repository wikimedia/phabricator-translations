...
final class PhabricatorAphlictTr
  ...
  'No `%s` or `%s` binary was found in %s. You must install Node.js to start the Aphlict server.' => '%3$s içinde `%s` veya `%s` ikili bulunmadı. Aphlict sunucusunu başlatmak için Node.js\'yi yüklemelisiniz.',
  ...
  'Configuration file specifies cluster peer ("%s", at index "%s") with an invalid protocol, "%s". Valid protocols are "%s" or "%s".' => 'Yapılandırma dosyası, geçersiz bir protokol olan "%3$s" ile küme eşini ("%s", "%s" dizininde) belirtir. Geçerli protokoller "%4$s" veya "%5$s".',
