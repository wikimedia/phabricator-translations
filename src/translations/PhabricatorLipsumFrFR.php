...
final class PhabricatorLipsumFrFR
  ...
  protected function getTranslations() {
    return array(
      ...
      'Choose which type or types of test data you want to generate, or select "%s".' => 'Choisissez quel(s) type(s) de données de test vous voulez générer, ou bien sélectionnez « %s ».',
      ...
      'Are you sure you want to generate piles of garbage?' => 'Êtes-vous sûr(e) de vouloir générer des tas de déchets ?',
    );
  }
