...
Not every type of object has an editable view policy, edit policy, or owner, so not all modes will work with all objects. ' => '',
  ...
  'Interact Policy' => 'Etkileşim Politikası',
...
Bu ayar devre dışı bırakıldığında, "Genel" politikası kullanılamaz ve en açık politika "Tüm Kullanıcılar"\'dır (bu, kullanıcıların hesaplara sahip olması ve bir şeyleri görüntülemek için giriş yapmış olması gerektiği anlamına gelir).',
  ...
  'Controls who can interact with the object.' => 'Nesneyle kimin etkileşim kurabileceğini kontrol eder.',
  ...
  'Testing for capability "%s" on an object ("%s") which does not support that capability.' => 'Bu yeteneği desteklemeyen bir nesnede ("%2$s") "%s" yeteneğinin test edilmesi.',
  'Change the owner of an object to the specified user.' => 'Change the sahip of an nesne to the specified kullanıcı.',
  'Deny' => 'Reddet',
  ...
  'UNLOCKING' => 'KİLİDİ AÇILIYOR',
  'Members of a particular project can take this action. (You can not see this object, so the name of this project is restricted.)' => 'Bu işlemi belirli bir birimin üyeleri yapabilir. (Bu nesneyi göremiyorsunuz, bu nedenle birimin adı gizlidir.)',
  ...
  'Unable to perform capability tests on an object (of class "%s") with no PHID.' => '',
  ...
  'The space this object is in has a more restrictive view policy ("%s") than the object does ("%s"), so the space\'s view policy is shown as a hint instead of the object policy.' => 'Bu nesnenin bulunduğu alan, nesnenin ("%2$s") öğesinden daha kısıtlayıcı bir görünüm ilkesine ("%s") sahiptir, bu nedenle alanın görünüm ilkesi, nesne ilkesi yerine ipucu olarak gösterilir.',
  ...
  'Change the interaction policy of the object.' => 'Nesnenin etkileşim politikasını değiştir.',
);
  }
