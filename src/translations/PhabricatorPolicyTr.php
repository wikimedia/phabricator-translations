...
final class PhabricatorPolicyTr
  ...
  protected function getTranslations() {
    ...
    Bu ayar, bu politikaların "kilitlenmesini" sağlar, böylece politika başına başka düzenleme yapılamaz.',
      ...
      'Lock Create User Policy To Admins' => 'Yöneticilere Kullanıcı İlkesi Oluşturma Kilidi',
      ...
      'is waxing' => 'azalıyor',
      'Saved application.' => 'Uygulama kaydedildi',
      ...
      'Only User: %s' => 'Sadece Kullanıcı: %s',
      'Limits work.' => 'Limitler çalışıyor.',
      'Invalid action \'%s\'!' => 'Geçersiz eylem \'%s\'!',
      'Admin Policy' => 'Yönetici Politikası',
      ...
      'Application class \'%s\' for query \'%s\'.' => '\'%2$s\' sorgusu için \'%1$s\' uygulama sınıfı.',
    ...
    Bu ayar devre dışı bırakıldığında, "Genel" politikası kullanılamaz ve en açık politika "Tüm Kullanıcılar" dır (bu, kullanıcıların hesaplara sahip olması ve bir şeyleri görüntülemek için giriş yapmış olması gerektiği anlamına gelir).',
      ...
      'Public Policy (Enabled in Config)' => 'Genel Politika (Konfigürasyonda Etkin)',
      ...
      '%s all other users.' => 'Diğer tüm kullanıcılar %s.',
      ...
      'Spaces Documentation' => 'Boşluk Belgeleri',
