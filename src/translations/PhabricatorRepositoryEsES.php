...
final class PhabricatorRepositoryEsES
  ...
  'Move' => 'Trasladar',
  '%s changed the assigned user for this identity from %s to %s.' => '%s cambió el usuario asignado para esta identidad de %s a %s.',
  ...
  'DETAILS' => 'DETALLES',
  '%s renamed this repository from %s to %s.' => '%s renombró este repositorio de %s a %s.',
