...
final class PhabricatorAlmanacTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'Defines a database service for use in a cluster.' => 'Bir Phabricator kümesinde kullanılacak veritabanı hizmetini tanımlar.',
      ...
      'Reset' => 'Sıfırla',
      'Cluster: Repository' => 'Phabricator Kümesi: Depo',
      ...
      'This is an advanced feature which should normally be used only when building a cluster. This feature is very dangerous if misused.' => 'Bu normalde yalnızca bir Phabricator kümesi oluşturulurken kullanılması gereken gelişmiş bir özelliktir. Bu özellik yanlış kullanıldığında çok tehlikelidir.',
      ...
      'Cluster: Database' => 'Phabricator Kümesi: Veritabanı',
      ...
      'Defines a repository service for use in a cluster.' => 'Bir Phabricator kümesinde kullanılacak bir depo hizmetini tanımlar.',
