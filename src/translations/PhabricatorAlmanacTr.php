...
final class PhabricatorAlmanacTr
  ...
  'Defines a database service for use in a cluster.' => 'Bir kümede kullanılacak veritabanı hizmetini tanımlar.',
  ...
  'You can not bind a nonexistent or restricted service.' => 'Var olmayan veya kısıtlanmış bir hizmeti bağlayamazsınız.',
  ...
  'Trusting a public key gives anyone holding the corresponding private key complete, unrestricted access to all data. The private key will be able to sign requests that bypass policy and security checks.' => 'Genel bir anahtara güvenmek, ilgili özel anahtarı elinde bulunduran herkese tüm verilere tam ve sınırsız erişim sağlar. Özel anahtar, politika ve güvenlik kontrollerini atlatan istekleri imzalayabilir.',
  ...
  'Remove interface %s on device %s?' => '%2$s cihazındaki arayüz %s kaldırılsın mı?',
  ...
  'Search for devices with given statuses.' => '',
  ...
  'This is an advanced feature which should normally be used only when building a cluster. This feature is very dangerous if misused.' => 'Bu, normalde yalnızca küme oluştururken kullanılması gereken gelişmiş bir özelliktir. Bu özellik, kötüye kullanıldığında çok tehlikelidir.',
  ...
  'Invalid Property' => 'Geçersiz Özellik',
  ...
  'Almanac' => 'Almanak',
  'The public key corresponding to the given private key is unknown. Associate the public key with an Almanac device in the web interface before registering hosts with it.' => 'Verilen özel anahtara karşılık gelen ortak anahtar bilinmiyor. Ana anahtarı, ana bilgisayarlara kaydetmeden önce web arabirimindeki bir Almanak cihazıyla ilişkilendirin.',
  ...
  'Defines a repository service for use in a cluster.' => 'Bir kümede kullanılacak bir depolama hizmetini tanımlar.',
  ...
  'You can not put an interface on a nonexistent or restricted network.' => 'Var olmayan veya kısıtlı bir ağa arabirim koyamazsınız.',
  ...
  'True if device is disabled.' => 'True if device devre dışı.',
