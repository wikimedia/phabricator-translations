...
final class PhabricatorPholioZhHant
  ...
  '%s replaced %s with %s.' => '%s 以%3$s替換了%s。',
  'Edit Mock: %s' => '編輯畫面模型：%s',
  'View Mock' => '檢視畫面模型',
  'Review Mocks and Design' => '檢閱畫面模型與設計',
  '%s added %d image(s): %s.' => '%s 添加了 %d 張圖片：%s。',
  'Close Mock' => '關閉畫面模型',
  ...
  '%s removed %s task(s) for %s: %s.' => '%s 移除了 %s 個對於%s的工單：%s。',
  '%s created this mock.' => '%s建立了此畫面模型。',
  'Pholio Mocks' => 'Pholio 畫面模型',
  '%s removed %d image(s): %s.' => '%s 移除了 %d 張圖片：%s。',
  'Mock image titles must not be longer than %s character(s).' => '畫面模型圖片的名稱不可超過 %s 個字元。',
  '%s edited task(s) for %s, added %s: %s; removed %s: %s.' => '%s 編輯了對於%s的工單，已添加%s：%s，已移除%s：%s。',
  'Undo' => '還原',
  ...
  '%s edited task(s), added %s: %s; removed %s: %s.' => '%s 編輯了工單，已添加%s：%s，已移除%s：%s。',
  ...
  '%s added %s task(s) for %s: %s.' => '%s 添加了 %s 個對於%s的工單：%s。',
  ...
  '%s edited image(s), added %d: %s; removed %d: %s.' => '%s 編輯了圖片，已添加%d：%s，已移除%d：%s。',
