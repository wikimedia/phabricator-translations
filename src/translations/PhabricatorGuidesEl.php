...
final class PhabricatorGuidesEl
  ...
  protected function getTranslations() {
    return array(
      'Learn how to configure mail and other options in Phabricator.' => 'Μάθετε πώς να ορίζετε ρυθμίσεις μηνυμάτων και άλλες ρυθμίσεις στο Phabricator.',
