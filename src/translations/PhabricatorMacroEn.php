...
final class PhabricatorMacroEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Macro name "%s" be at least three characters long and contain only lowercase letters, digits, hyphens, colons and underscores.' => 'Macro name "%s" be at least three characters long and contain only lowercase letters, digits, hyphens, colons and underscores.',
