...
Ce point de terminaison d’API prend en charge les contraintes suivantes :',
  ...
  'Use the application-specific Advanced Search for better results and additional search criteria: %s, %s. (%s)' => 'Utilisez la recherche avancée spécifique à l\'application pour définir des critères de recherche supplémentaires : %s, %s. (%s)',
...
Voici les champs disponibles sur ce type d’objet :',
  ...
  'You cannot add more than %d objects to the relationship.' => 'Vous ne pouvez pas ajouter plus de %d objets à la relation.',
...
Les pièces jointes suivantes sont disponibles :',
  ...
  'Minimum page size for Conduit API method calls is 1, but this call specified %s.' => 'La taille de page minimale pour les recherches d\'API est 1, mais cet appel a spécifié %s.',
