...
final class PhabricatorSearchFrFR
  ...
  protected function getTranslations() {
    ...
    Ce point de terminaison d’API prend en charge les contraintes suivantes :',
      ...
      'WMF T346876 Debug: User: %s' => 'Débogage de WMF T346876 : Utilisateur : %s',
    ...
    Voici les champs disponibles sur ce type d’objet :',
      ...
      'Too many relationships (%s, of type "%s"). Must be less than %s.' => 'Trop de relations (%s, de type « %s »). Doit être inférieur à %s.',
      ...
      'You cannot add more than %d objects to the relationship.' => 'Vous ne pouvez pas ajouter plus de %s objets à la relation.',
      ...
      'WMF T346876 Debug: Viewer: %s' => 'Débogage de WMF T346876 : Observateur : %s',
      ...
      'Prebuilt Queries' => 'Requêtes prédéfinies',
    ...
    Les pièces jointes suivantes sont disponibles :',
      ...
      'WMF T346876 Debug: RequestURI: %s' => 'Débogage de WMF T346876 : Lien vers la requête : %s',
    ...
    Les ordres intégrés suivants sont disponibles :',
      ...
      'WMF T346876 Debug: Path: %s' => 'Débogage de WMF T346876 : Chemin : %s',
      ...
      'Use the application-specific Advanced Search to set additional search criteria: %s, %s. (%s)' => 'Utilisez la recherche avancée spécifique à l\'application pour définir des critères de recherche supplémentaires : %s, %s. (%s)',
