...
final class PhabricatorOauthserverEnGB
  ...
  protected function getTranslations() {
    return array(
      ...
      'Do you want to authorize the external application "%s" to access your %s account data, including your primary email address?' => 'Do you want to authorise the external application "%s" to access your Phabricator account data, including your primary email address?',
      ...
      'This application ("%s") is authorized to use your %s credentials. Continue to complete the authentication workflow.' => 'This application ("%s") is authorised to use your Phabricator credentials. Continue to complete the authentication workflow.',
