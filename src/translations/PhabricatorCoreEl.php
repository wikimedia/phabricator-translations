...
final class PhabricatorCoreEl
  ...
  'Summary' => 'Σύνοψη',
  'Failed to write %d byte(s) to "%s".' => 'Αποτυχία για την συγγραφή %d μπάιτ προς το "%s".',
  'Duration' => 'Διάρκεια',
  'Meme' => 'Μιμίδιο',
  '(%s -> %s @ %s) %s' => '(%s -> %s @ %s) %s',
  ...
  'Failed to write %d byte(s) to file "%s".' => 'Αποτυχία για την συγγραφή %d μπάιτ προς το αρχείο "%s".',
  ...
  '%s updated %s for %s, added %d: %s.' => 'Ο %s ενημέρωσε το %s για το %s, πρόσθεσε τα: %d, %s.',
