...
final class PhabricatorCoreEl
  ...
  'Path "%s" contains no libraries.' => 'Η διαδρομή "%s" δεν περιέχει βιβλιοθήκες.',
  'Favorites' => 'Αγαπημένα',
  ...
  'Too many calls to %s!' => 'Πάρα πολλές κλήσεις στο %s!',
  'Inactive' => 'Ανενεργό',
  ...
  'Parents' => 'Γονείς',
  'Task %d failed!' => 'Η εργασία %d απέτυχε!',
  'Object' => 'Αντικείμενο',
  ...
  'Failed to write %s byte(s) to "%s".' => 'Αποτυχία για την συγγραφή %s μπάιτ προς το "%s".',
  ...
  '%s got test event at %d' => 'Ο %s έλαβε δοκιμαστικό συμβάν στο %d',
  'Login' => 'Σύνδεση',
  'Log Out' => 'Αποσύνδεση',
  'Owners' => 'Ιδιοκτήτες',
  'Memory Usage: %s KB' => 'Χρήση μνήμης: %s KB',
  'Current' => 'Τρέχον',
  ...
  'Analysis' => 'Ανάλυση',
  'Working on task %d (%s)...' => 'Εργάζεται στην εργασία %d (%s)...',
  'Phriction' => 'Phriction',
  ...
  'Analyzed %d table(s).' => 'Αναλύθηκαν %d πίνακας(-ες).',
  'Count' => 'Μέτρηση',
  ...
  'Mail receiver is not a %s.' => 'Ο παραλήπτης του μηνύματος δεν είναι ένας %s.',
  'Tags' => 'Ετικέτες',
  'Process exited with error %s.' => 'Η διαδικασία τελείωσε με το σφάλμα %s.',
  ...
  'Console' => 'Κονσόλα',
  'User' => 'Χρήστης',
  'Starting process.' => 'Διαδικασία αρχής.',
  'Goal' => 'Στόχος',
  '%s us' => '%s εμάς',
  ...
  '%s updated %s for %s, added %s: %s.' => 'Ο %s ενημέρωσε το %s για το %s, πρόσθεσε τα: %s, %s.',
  'Applied' => 'Εφαρμοσμένο',
  ...
  'Fri' => 'Πα',
  'Failed to write %s byte(s) to file "%s".' => 'Αποτυχία για την συγγραφή %s μπάιτ προς το αρχείο "%s".',
);
  }
