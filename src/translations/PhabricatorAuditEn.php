...
final class PhabricatorAuditEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Really delete these %d audit(s)? They will be permanently deleted and can not be recovered.' => 'Really delete these %s audit(s)? They will be permanently deleted and can not be recovered.',
      ...
      'No changes for "%s".' => 'No changes for "%s".',
      'Auditor' => 'Auditor',
      ...
      'Update audit status for commits.' => 'Update audit status for commits.',
      'Audits' => 'Audits',
