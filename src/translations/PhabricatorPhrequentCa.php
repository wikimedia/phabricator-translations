...
final class PhabricatorPhrequentCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'Unknown order "%s".' => 'Ordre «%s» desconeguda.',
      ...
      'Start tracking time on an object by pushing it on the tracking stack.' => 'Comença el temps de seguiment en un objecte prement-lo a la pila de seguiment.',
