...
final class PhabricatorSettingsNl
  ...
  'Show Older Inlines' => 'Oudere inline weergeven',
...
Dit kan e-mail nuttiger maken, maar sommige e-mailclients hebben moeite met het ordenen van deze berichten. Het uitschakelen van deze optie kan het ordenen verbeteren, maar dit gaat ten koste van de bruikbaarheid van de onderwerpregels.',
  ...
  'Are you sure you want to delete this address? You will no longer be able to use it to login.' => 'Weet u zeker dat je dit adres wilt verwijderen? U kunt het dan niet meer gebruiken om aan te melden.',
  ...
  'Display Preferences' => 'Voorkeuren weergeven',
