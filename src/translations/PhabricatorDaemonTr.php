...
final class PhabricatorDaemonTr
  ...
  'Terminating process %d...' => 'İşlem %d sona erdiriliyor ...',
...
Farklı bir kullanıcı olarak çalıştırmak için `%s` kullanın, bu uyarıyı yoksaymak için `%s` iletin veya yapılandırmayı değiştirmek için `%s` düzenleyin.',
  ...
  'Reloading process %d...' => 'İşlem %d yeniden yükleniyor...',
  ...
  'There are no running daemons.' => '',
  'Stopped PID %d ("%s")' => 'PID %d ("%s") durduruldu',
...
' => 'HATA: %s PHP işlevi devre dışı. Bu makinede arka plan programları çalıştırmak için etkinleştirmeniz gerekir.',
  ...
  'Stop all daemon processes on this host, even if they belong to another instance.' => '',
  ...
  'Killing process %d...' => 'İşlem %d öldürülüyor...',
  ...
  'Interrupting process %d...' => 'İşlem %d durduruluyor...',
  ...
  'PPID' => 'PPID',
  '%s s' => '%s s',
  'RUNNING DAEMONS' => 'ÇALIŞAN ARKA PLAN HİZMETLERİ',
  ...
  'Process %d exited.' => '%d işleminden çıkıldı.',
...
%s' => 'Arka plan programları "%2$s" yapılandırma seçeneğinde "%s" kullanıcısı olarak çalışacak şekilde yapılandırıldı, ancak geçerli kullanıcı "%3$s" ve `phd` `sudo` ile doğru kullanıcıya geçemedi. Komut çıkışı:

%4$s',
  'There are no running daemon processes for the current instance ("%s").' => '',
  'No log records exist for any daemons.' => 'Herhangi bir arka plan programı için günlük kaydı yok.',
  'Unable to stop PID %d ("%s").' => 'PID %d durdurulamadı ("%s").',
  ...
  'NO DAEMONS' => 'ARKAPLAN SÜRECİ YOK',
