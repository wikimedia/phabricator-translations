...
final class PhabricatorBaseNl
  ...
  'Request includes restricted parameter "%s", but this controller ("%s") does not whitelist it. Refusing to serve this request because it might be part of a redirection attack.' => 'Het verzoek bevat de beperkte parameter "%s", maar deze staat voor deze controller ("%s") niet op de toelatingslijst. Dit verzoek wordt niet gehonoreerd omdat het onderdeel kan zijn van een doorverwijzingsaanval.',
  'Unknown capability \'%s\'!' => 'Onbekende mogelijkheid ‘%s’!',
  'Unable to find transaction query for object of class "%s".' => 'Kan geen transactiezoekopdracht vinden voor object van klasse “%s”.',
);
  }
