...
final class PhabricatorPhrictionRu
  ...
  protected function getTranslations() {
    return array(
      ...
      'This document was moved from %s.' => 'Эта страница была перемещена из %s.',
      ...
      'This document was moved from elsewhere.' => 'Эта страница была перемещена извне.',
      'More...' => 'Больше...',
      ...
      '%s moved this document from %s' => 'Пользователь %s переместил эту страницу из %s.',
      'Hierarchy' => 'Иерархия',
