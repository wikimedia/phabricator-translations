...
final class PhabricatorSearchCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'Run this workflow with "%s" to queue tasks for the daemon workers.' => 'Executeu aquest flux de treball amb \'%s\' per posar a la cua les tasques dels treballadors del dimoni.',
