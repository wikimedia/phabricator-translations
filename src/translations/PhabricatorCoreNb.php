...
final class PhabricatorCoreNb
  ...
  protected function getTranslations() {
    return array(
      ...
      'Limit the total number of tasks to act on.' => 'Begrens totalt antall oppgaver det skal handles på.',
      ...
      'Revoke' => 'Tilbakekall',
      'No task exists with id "%s"!' => 'Ingen oppgave finnes med ID-en «%s»!',
      ...
      'Normalization of \'%s\'' => 'Normalisering av «%s»',
      ...
      'Tasks with a lower priority should be scheduled first.' => 'Oppgaver med lavere prioritet burde planlegges først.',
