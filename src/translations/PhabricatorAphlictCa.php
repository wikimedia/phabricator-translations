...
final class PhabricatorAphlictCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'The notification server should not be run as root.' => 'El servidor de notificacions no s\'ha d\'executat com a arrel.',
      ...
      'Stop the notification server.' => 'Atura el servidor de notificacions.',
      ...
      'A specified server (at index "%s", on port "%s") has an invalid type ("%s"). Valid types are: admin, client.' => 'Un servidor especificat (a l\'índex «%s», al port «%s») té un tipus no vàlid («%s»).  Els tipus vàlids són: administrador, client.',
