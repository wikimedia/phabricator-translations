...
final class PhabricatorRepositoryEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Unable to read device public key while attempting to make authenticated method call within the cluster. Use `%s` to register keys for this device. Exception: %s' => 'Unable to read device public key while attempting to make authenticated method call within the cluster. Use `%s` to register keys for this device. Exception: %s',
      ...
      'You do not have permission to create or edit identities.' => 'You do not have permission to create or edit identities.',
    ...
    %s',
      ...
      'Specified version control system must be a VCS recognized by this software. Valid systems are: %s.' => 'Specified version control system must be a VCS recognized by this software. Valid systems are: %s.',
      'Unable to read device private key while attempting to make authenticated method call within the cluster. Use `%s` to register keys for this device. Exception: %s' => 'Unable to read device private key while attempting to make authenticated method call within the cluster. Use `%s` to register keys for this device. Exception: %s',
      'branch' => 'branch',
      'Can Edit and View Identities' => 'Can Edit and View Identities',
      'Pulling "%s"...' => 'Pulling "%s"...',
    ...
    %s',
      ...
      'A copy of any changes will be pushed to this URI.' => 'A copy of any changes will be pushed to this URI.',
      ...
      'Repositories are now locked. You may begin maintenance in another terminal window. Keep this process running until you complete the maintenance, then confirm that you are ready to release the locks.' => 'Repositories are now locked. You may begin maintenance in another terminal window. Keep this process running until you complete the maintenance, then confirm that you are ready to release the locks.',
      ...
      'A read-only copy of the repository will be served from this URI.' => 'A read-only copy of the repository will be served from this URI.',
      ...
      'The default location in which to store working copies and other data about repositories. %s will control and manage data here, so you should **not** choose an existing directory full of data you care about.' => 'The default location in which to store working copies and other data about repositories. %s will control and manage data here, so you should **not** choose an existing directory full of data you care about.',
    ...
    ',
      ...
      'A read/write copy of the repository will be served from this URI.' => 'A read/write copy of the repository will be served from this URI.',
      ...
      'This software is running in silent mode; declining to mirror.' => 'This software is running in silent mode; declining to mirror.',
    ...
    ',
      ...
      '%s changed the I/O type for this URI from "%s" to "%s".' => '%s changed the I/O type for this URI from "%s" to "%s".',
    ...
    Phabricator will run any executables in this directory after running its own checks, as though they were normal hook scripts.',
      ...
      'These repositories will be locked:' => 'These repositories will be locked:',
      ...
      'Only Git and Mercurial repositories are supported, unable to operate on this repository ("%s").' => 'Only Git and Mercurial repositories are supported, unable to operate on this repository ("%s").',
      ...
      'Unable to lock repository "%s": only hosted repositories may be locked.' => 'Unable to lock repository "%s": only hosted repositories may be locked.',
      ...
      'Unable to lock repository "%s": only repositories that support clustering may be locked.' => 'Unable to lock repository "%s": only repositories that support clustering may be locked.',
      ...
      'No changes will be pushed or pulled from this URI.' => 'No changes will be pushed or pulled from this URI.',
      ...
      'Specify one or more repositories to lock.' => 'Specify one or more repositories to lock.',
      ...
      'Lock repositories and begin maintenance?' => 'Lock repositories and begin maintenance?',
    ...
    %s',
      ...
      'Changes to this URI will be observed and pulled.' => 'Changes to this URI will be observed and pulled.',
      ...
      '%s commit(s)' => '%s commit(s)',
      'Path "%s" is not unknown.' => 'Path "%s" is not unknown.',
      ...
      'Unable to lock repository "%s": only clustered repositories may be locked.' => 'Unable to lock repository "%s": only clustered repositories may be locked.',
      '[Push]' => '[Push]',
      'BRANCHES' => 'BRANCHES',
      'Expected %s or %s, got %s.' => 'Expected %s or %s, got %s.',
      'Rejected: Broken' => 'Rejected: Broken',
      'Take repositories out of maintenance mode, returning them to normal service.' => 'Take repositories out of maintenance mode, returning them to normal service.',
      ...
      'Temporarily lock clustered repositories to perform maintenance.' => 'Temporarily lock clustered repositories to perform maintenance.',
