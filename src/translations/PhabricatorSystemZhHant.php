...
' => '正在銷毀%s**%s**…',
  ...
  'Choose a syntax highlighting to use.' => '選擇要使用的語法醒目標示。',
  '%d / hour' => '%d/時',
...
這些邊緣破損是銷毀物件的預期結果，上游會無法幫助您修復它們。我們強烈建議以停用或歸檔物件的方式來取代。',
  ...
  'This mode is active because no database has a "%s" role in the configuration option "%s".' => '此模式目前有效，因為在設置選項「%2$s」中沒有資料庫具有「%s」身分。',
  ...
  'Select Syntax Highlighting' => '選擇語法醒目標示',
