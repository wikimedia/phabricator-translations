...
and encryption, see **[[ %s | Configuring Encryption ]]**.' => 'B sẽn da maand n paasd kode wã, b ra tara kode. Y sã n dat sõngre, bɩ y ges "%s" sẽn dat n sõng ne loogr la loogrã.',
  'The \'%s\' extension is not installed. Without \'%s\', this server may not be able to determine the MIME types of uploaded files.' => '\'%s\' paasgo pa be ye. Sã n pa tar \'%s\', sõngre, program kãngã pa tõe n bãng MIME faay nins sẽn tall-bã ye.',
