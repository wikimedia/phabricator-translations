...
final class PhabricatorAuditZhHant
  ...
  '(This commit affected more than %d files. Only %d are shown here and additional ones are truncated.)' => '（此提交影響超過 %d 個檔案。在此僅顯示出%d，其餘的皆被截斷。）',
  ...
  'Specify either a list of objects to affect or "--all", but not both.' => '指定要影響的物件清單或用「--all」，不能兩者兼選。',
  ...
  'Deleting audit %d...' => '正在刪除稽查%d…',
  'A commit has a concern raised against it.' => '有提交被引起關注。',
