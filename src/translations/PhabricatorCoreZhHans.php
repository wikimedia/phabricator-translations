...
final class PhabricatorCoreZhHans
  ...
  'Query (of class "%s") overheated: examined more than %s raw rows without finding %s visible objects.' => '查询（类“%s”）过载：检查了超过%s原始行，但没有找到%s可见对象。',
  'Move Document' => '移动文档',
  'Started new daemon overseer (with PID "%s").' => '启动了新的守护进程监督者（PID为“%s”）。',
  'Maximum must be larger than minimum.' => '最大值必须大于最小值。',
  'User "%s" is not a valid user.' => '用户“%s”不是一个有效的用户。',
  'Type a user, project, package name or function...' => '输入用户、项目、包名称或函数……',
  'Authored' => '创作的',
  ...
  'Minus' => '减去',
  'OPTIMIZE' => '最优化',
  'Database "%s" is unknown. This script can only dump databases known to the current version of this software. Valid databases are: %s.' => '数据库“%s”未知。此脚本只能转储当前软件版本已知的数据库。有效数据库为：%s 。',
  'Capability "%s"' => '性能“%s”',
  'DESTROY' => '破坏',
  'Browse Viewer' => '浏览查看器',
  'Editor pattern "%s" is invalid: the pattern must begin with a valid editor protocol, but begins with a variable. This is very sneaky and also very forbidden.' => '编辑器模式“ %s ”无效：该模式必须以有效的编辑器协议开头，但却以变量开头。这种行为极其隐蔽，也极其被禁止。',
  'Expected "newExternalCursorStringForResult()"  in class "%s" to return a string, but got "%s".' => '类“%s”中的“newExternalCursorStringForResult()”预期返回字符串，但得到的却是“%s”。',
  'The callsign of the repository.' => '储存库的呼号。',
  'Show patch application status.' => '显示补丁应用状态。',
  'Acquired' => '已获得的',
  'Raised Concern' => '已提高关心',
  'Waking pool "%s" (triggered by overseer module "%s").' => '唤醒池“%s”（由监督模块“%s”触发）。',
  ...
  '%s added %s task(s): %s.' => '%s添加了%s项任务：%s。',
  'Editor pattern token list can not be converted into a string: it still contains a non-literal token ("%s", of type "%s").' => '编辑器模式标记列表无法转换为字符串：它仍然包含非文字标记（“%s”，类型为“%s”）。',
  'No tasks selected to retry.' => '未选择要重试的任务。',
  'Curtain extension ("%s", of class "%s") did not return an application from method "%s". This method must return an object of class "%s".' => '窗帘扩展程序（“%s”，属于类“%s”）未通过方法“%s”返回应用程序。此方法必须返回类“%s”的对象。',
  'You must specify at least one daemon to start!' => '您必须指定至少一个要启动的守护进程！',
  ...
  'Object "%s" is specified more than once. Specify only unique objects.' => '对象“%s”指定了多次。请仅指定唯一的对象。',
  'Reopened' => '已重启',
  'Autoscale pool "%s" has not been busy long enough to scale up (busy for %s of %s seconds).' => '自动缩放池“%s”的繁忙时间还不够长，无法进行扩展（繁忙时间持续了%3$s秒中的%s秒）。',
  '%s Before' => '%s之前',
  'Untitled Document' => '无标题文档',
  'Worker has invalid actor PHID ("%s").' => '工作者有无效的操作者 PHID (“%s”)。',
  'Path "%s" contains no libraries.' => '路径“%s”中不包含任何库文件。',
  'Executed %s task(s).' => '已执行%s任务。',
  'No visible events.' => '没有可见的事件。',
  ...
  'Restoring "%s" to the default retention policy.' => '将“%s”恢复为默认保留策略。',
  'Orange' => '橙色',
  'Failed' => '失败',
  'Upload Picture' => '上传图片',
  'Map returned by "newPagingMapFromCursorObject()" in class "%s" omits required key "%s".' => '由类“%s”中的“newPagingMapFromCursorObject()”方法返回的映射对象缺少必需的键“%s”。',
  'Unknown signal "%s" ("%d").' => '未知信号“%s”（“%d”）。',
  'Find results with any closed status.' => '查找任何已关闭状态的结果。',
  'Packages' => '程序包',
  'This file %s component \'%s\', but it does not exist. You may need to rebuild the Celerity map.' => '此文件包含%s组件‘%s’，但该组件不存在。您可能需要重新构建Celerity地图。',
  'Deprecated call to setIcon(), use setImageIcon() instead.' => '不推荐使用 setIcon() 调用，而应使用 setImageIcon() 代替。',
  ...
  'Administrators' => '管理员',
  'Can not merge parts of dissimilar types!' => '无法合并不相似的类型！',
  ...
  'Trying to %s with a lock!' => '尝试使用锁%s！',
  'Publishing Disabled' => '发布已被禁用',
  'Give Token' => '提供令牌',
  'Overview' => '概述',
  'Example' => '示例',
  ...
  '%s confirmed this job.' => '%s确认了此工作。',
  'NULL value "%s" is invalid. Valid values are "head" and "tail".' => '空值“%s”无效。有效值为“标头”和“结尾”。',
  'Invalid token \'%s\' in grammar.' => '语法上无效的令牌‘%s’。',
  'Changes discarded.' => '修改已撤销。',
  ...
  'Current Tasks' => '当前任务',
  'Summary' => '摘要',
  'Unknown edit string "%s"!' => '未知的编辑字符串“%s”！',
  'Duration' => '期限',
  'Change status to' => '更改状态到',
  'Meme' => '梗图',
  '(%s -> %s @ %s) %s' => '(%s -> %s @ %s) %s',
  'Paths' => '路径',
  'Custom Fields' => '自定义字段',
  ...
  'Changes made by bulk update.' => '使用批量更新进行的更改。',
  'Tomorrow' => '明天',
  'Variable' => '变量',
  'Bold' => '粗体',
  'Commit' => '提交',
  ...
  'November' => '11月',
  'Any Value' => '任意值',
  'Failed to write %s byte(s) to "%s".' => '无法写入%s字节到“%s”。',
  ...
  'No' => '否',
  'Maniphest Tasks' => 'Maniphest任务',
  'Tags' => '标签',
  'Account' => '账号',
  'Mentions' => '提及',
  'You must pass the user to %s.' => '您必须传递用户到 %s。',
  '[Diffusion]' => '[Diffusion]',
  'Select active tasks.' => '选择活跃任务。',
