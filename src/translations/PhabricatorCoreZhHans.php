...
final class PhabricatorCoreZhHans
  ...
  protected function getTranslations() {
    return array(
      ...
      'Reopened' => '已重启',
      'Autoscale pool "%s" has not been busy long enough to scale up (busy for %s of %s seconds).' => '自动缩放池“%s”的繁忙时间还不够长，无法进行扩展（繁忙时间持续了%3$s秒中的%2$s秒）。',
      '%s Before' => '%s之前',
      ...
      'Failed to write %d byte(s) to "%s".' => '无法写入%s字节到“%s”。',
      'Duration' => '期限',
