...
final class PhabricatorCelerityFrFR
  ...
  'Done generating sprites - updating map...' => 'Génération de sprites terminée - mise à jour de la carte...',
  ...
  'Do not invoke `%s` after updating sprites' => 'N\'invoquez pas `%s` après la mise à jour des sprites',
  'Found %d binary resources.' => '%d ressources binaires trouvées.',
  ...
  'Rebuilding %s resource source(s).' => 'Reconstruction de %s source(s) de ressources.',
  ...
  'Sprites will not be optimized! Install `%s`!' => 'Les sprites ne seront pas optimisés ! Installez `%s` !',
  'Resource "%s" must %s at most one Celerity target.' => 'La ressource « %s » doit %s à au moins une cible de Célérité.',
  'Rebuild CSS sprite sheets.' => 'Reconstruisez les feuilles de sprite CSS.',
  ...
  'Force regeneration even no sources have changed.' => 'Forcer la régénération même si aucune source n\'a changé.',
  'Optimizing...' => 'Optimisation...',
  'Found %d text resources.' => '%d ressources de texte trouvées.',
