...
final class PhabricatorProjectEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Month' => 'Month',
      'True if this column is hidden.' => 'True if this column is hidden.',
      ...
      'Assign task to user moving the task.' => 'Assign task to user moving the task.',
    ...
    See [[ %s | Projects User Guide ]] in the documentation for details. This process can not be undone.',
      ...
      'Maximum number of tasks allowed in the column.' => 'Maximum number of tasks allowed in the column.',
      ...
      'Owner rule value is required. Specify a user to assign tasks to, the token "viewer()" to assign to the user moving tasks, or the token "none()" to unassign tasks.' => 'Owner rule value is required. Specify a user to assign tasks to, the token "viewer()" to assign to the user moving tasks, or the token "none()" to unassign tasks.',
      ...
      'You must select at least one user or project tag to remove.' => 'You must select at least one user or project tag to remove.',
    ...
    This will omit results with any other project tag.',
      ...
      'No open tasks in this project.' => 'No open tasks in this project.',
      ...
      'Add subscribers rule value should be a list, but is not (value is "%s").' => 'Add subscribers rule value should be a list, but is not (value is "%s").',
      ...
      'Remove subscribers rule value should be a list, but is not (value is "%s").' => 'Remove subscribers rule value should be a list, but is not (value is "%s").',
    ...
    > ios, not(bug)',
      ...
      'Workload: All %d open tasks are unassigned.' => 'Workload: All %s open tasks are unassigned.',
    ...
    > bug, any(ios), any(android)',
      ...
      'Project tags incl their milestones (use with None only)' => 'Project tags incl their milestones (use with None only)',
    ...
    documentation.' => 'List of custom fields for project tags.
    For details on adding new fields, see [[ %s | %s ]] in the
    documentation.',
      ...
      'True if this is the default column.' => 'True if this is the default column.',
      ...
      'Week' => 'Week',
      'Slugs' => 'Slugs',
      'Tasks resolved this %s: %d' => 'Tasks resolved this %s: %s',
      'Milestone Name' => 'Milestone Name',
      'Move Tasks' => 'Move Tasks',
      '%s set the icon for %s to %s.' => '%s set the icon for %s to %s.',
      'You must select at least one user or project tag to add.' => 'You must select at least one user or project tag to add.',
