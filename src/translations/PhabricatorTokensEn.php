...
final class PhabricatorTokensEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'All Tokens Given' => 'All Tokens Given',
      ...
      'Type a Token name...' => 'Type a Token name...',
