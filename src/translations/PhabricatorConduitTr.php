...
final class PhabricatorConduitTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'This request originates from outside of the Phabricator cluster address range. Requests signed with cluster API tokens must originate from within the cluster.' => 'Bu istek, Phabricator küme adres aralığının dışından kaynaklanır. Küme API anahtarlarıyla imzalanan isteklerin, küme içinden kaynaklanması gerekir.',
      ...
      'Show old methods which will be deleted in a future version of Phabricator.' => 'Phabricator\'ın gelecekteki bir sürümünde silinecek eski yöntemleri göster.',
      ...
      'Your \'%s\' client version is \'%d\', which is newer than the server version, \'%d\'. Upgrade your Phabricator install.' => '\'%s\' istemci sürümünüz \'%3$s\' adlı sunucu sürümünden daha yeni olan \'%2$s\'. Phabricator kurulumunuzu yükseltin.',
      ...
      'This request originates from outside of the Phabricator cluster address range. Requests signed with trusted device keys must originate from within the cluster.' => 'Bu istek, Phabricator küme adres aralığının dışından kaynaklanır. Güvenilen aygıt anahtarlarıyla imzalanan isteklerin kümeden gelmesi gerekir.',
      'A boolean.' => 'Boole.',
