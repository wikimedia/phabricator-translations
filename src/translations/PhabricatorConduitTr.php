...
final class PhabricatorConduitTr
  ...
  'Caller' => 'Çağrı',
  'This request originates from outside of the cluster address range. Requests signed with cluster API tokens must originate from within the cluster.' => 'Bu istek, küme adres aralığının dışından kaynaklanır. Küme API anahtarlarıyla imzalanan isteklerin, küme içinden kaynaklanması gerekir.',
  ...
  'Your \'%s\' client version is \'%d\', which is newer than the server version, \'%d\'. Upgrade your server.' => '\'%s\' istemci sürümünüz \'%3$d\' adlı sunucu sürümünden daha yeni olan \'%d\'. Sunucunuzu yükseltin.',
  ...
  'A new version of arc is available! You need to upgrade to connect to this server (you are running version %d, the server is running version %d).' => 'Yeni bir yay sürümü mevcut! Bu sunucuya bağlanmak için yükseltmeniz gerekiyor (%d sürümünü çalıştırıyorsunuz, sunucu %d sürümünü çalıştırıyor).',
  ...
  'This request originates from outside of the cluster address range. Requests signed with trusted device keys must originate from within the cluster.' => 'Bu istek, küme adres aralığının dışından kaynaklanır. Güvenilen aygıt anahtarlarıyla imzalanan isteklerin kümeden gelmesi gerekir.',
  ...
  'Epoch timestamp must be larger than 0, got %d.' => 'Dönem zaman damgası 0\'dan büyük olmalı, %d var.',
  ...
  'Show old methods which will be deleted in a future version of this software.' => 'Bu yazılımın gelecekteki bir sürümünde silinecek eski yöntemleri göster.',
);
  }
