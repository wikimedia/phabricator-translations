...
final class PhabricatorConduitTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'Your \'%s\' client version is \'%d\', which is newer than the server version, \'%d\'. Upgrade your server.' => '\'%s\' istemci sürümünüz \'%3$s\' adlı sunucu sürümünden daha yeni olan \'%2$s\'. Sunucunuzu yükseltin.',
