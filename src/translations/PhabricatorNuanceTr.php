...
final class PhabricatorNuanceTr
  ...
  protected function getTranslations() {
    return array(
      ...
      'Ref %s' => 'Ref %s',
      'This key has %s remaining API request(s), limit resets in %s second(s).' => 'Bu anahtarın %s kalan API isteği var, limit %s içinde sıfırlanıyor.',
      ...
      '%s renamed this queue from %s to %s.' => '%s, bu sırayı %s ile %s yeniden adlandırdı.',
      ...
      'Tag %s' => 'Etiket %s',
      'Source %d' => 'Kaynak %s',
      '%s renamed this source from %s to %s.' => '%s, bu kaynağı %s ile %s yeniden adlandırdı.',
