...
final class PhabricatorNuanceTr
  ...
  'Nuance Item %d Task' => 'Nuance Öğesi %d Görev',
  ...
  'Source "%s" (of class "%s") returned two cursors from method "%s" with the same key ("%s"). Each cursor must have a unique key.' => '"%2$s" sınıfındaki "%s" kaynağı, aynı anahtarla ("%4$s") "%3$s" yönteminden iki imleç döndürdü. Her imlecin benzersiz bir anahtarı olmalıdır.',
  'Pushed: %s' => 'İtti: %s',
  ...
  'This item type ("%s", of class "%s") can not update items.' => 'Bu öğe türü ("%2$s" sınıfındaki "%s") öğeleri güncelleyemez.',
