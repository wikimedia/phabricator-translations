...
final class PhabricatorSystemTr
  ...
  protected function getTranslations() {
    ...
    These tattered edges are an expected consequence of destroying objects, and the Phabricator upstream will not help you fix them. We strongly recommend disabling or archiving objects instead.' => 'Nesnelerin yok edilmesi, ilgili nesnelerin çalışmamasına neden olabilir ve artık bulunmayan nesnelere dağılmış kaynaklar bırakabilir. Çoğu durumda, nesneleri yok etmek yerine devre dışı bırakmak veya arşivlemek çok daha iyidir. Bu risk, depolar, projeler ve kullanıcılar gibi karmaşık veya yüksek oranda birbirine bağlı nesneleri silerken en fazladır.
