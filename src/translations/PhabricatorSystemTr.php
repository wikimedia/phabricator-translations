...
final class PhabricatorSystemTr
  ...
  protected function getTranslations() {
    return array(
  'An Administrator has placed this server into read-only mode.' => 'Bir Yönetici bu sunucuyu salt okunur moduna geçirdi.',
  ...
  'Panic!' => 'Panik!',
  'View Handle' => 'Tutamacı Görüntüle',
  'No Writable Database' => 'Yazılabilir Veritabanı Yok',
  'Destroying %s **%s**...
' => '%s **%s** yok ediliyor...',
  'This server has consistently been unable to reach the writable ("master") database while processing recent requests.' => 'Bu sunucu sürekli olarak son istekleri işleme koyarken yazılabilir ("master") veritabanına ulaşamadı.',
  ...
  'This server was unable to connect to the writable ("master") database while handling this request, and automatically degraded into read-only mode.' => 'Bu sunucu, bu isteği yerine getirirken yazılabilir ("master") veritabanına bağlanamadı ve otomatik olarak salt okunur moda düşürüldü.',
  'Severed From Master' => 'Ustadan Kesilmiş',
  'Cluster Database Status' => 'Küme Veritabanı Durumu',
...
Bu yırtık kenarlar, nesnelerin kaldırmasının beklenen bir sonucudur ve yukarı akış bunları düzeltmenize yardımcı olmaz. Bunun yerine nesneleri devre dışı bırakmanızı veya arşivlemenizi şiddetle tavsiye ederiz.',
  'IMPORTANT' => 'ÖNEMLİ',
