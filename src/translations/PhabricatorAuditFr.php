...
final class PhabricatorAuditFr
  ...
  protected function getTranslations() {
    return array(
      ...
      'Really delete these %d audit(s)? They will be permanently deleted and can not be recovered.' => 'Vraiment supprimer ces %s audit(s) ? Ils le seront définitivement et ne pourront pas être récupérés.',
      ...
      'Updating "%s": "%s" -> "%s".' => 'Mise à jour de « %s » : « %s » -> « %s ».',
      ...
      'No changes for "%s".' => 'Pas de modifications pour "%s".',
      'Auditor' => 'Auditeur',
      'Audit Required' => 'Besoin d\'auditer',
      ...
      'Update audit status for commits.' => 'Mettre à jour l’état d’audit pour les validations.',
      'Audits' => 'Audits',
