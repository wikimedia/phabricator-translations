...
final class PhabricatorAlmanacFr
  ...
  protected function getTranslations() {
    return array(
      ...
      'When creating a new Almanac interface via the Conduit API, you must provide a "device" transaction to select a device.' => 'En créant une nouvelle interface d’Almanac via l’API Conduit, vous devez fournir une transaction « appareil » pour sélectionner un appareil.',
      ...
      '%s changed the network for this interface from %s to %s.' => '%s a modifié le réseau pour cette interface de %s en %s.',
      ...
      'You can not attach an interface to a nonexistent or restricted device.' => 'Vous ne pouvez pas attacher une interface à un appareil inexistant ou restreint.',
      ...
      'Interface to bind the service to.' => 'Interface à laquelle lier le service.',
      ...
      'Apply transactions to create a new interface or edit an existing one.' => 'Appliquer des transactions de création d’interface ou de modification d’interfaces existantes.',
      ...
      'Interfaces must have a unique combination of network, device, address, and port.' => 'Les interfaces doivent être identifiées par une combinaison unique de réseau, appareil, adresse, et port.',
      ...
      'You can not put an interface on a nonexistent or restricted network.' => 'Vous ne pouvez pas ajouter une interface vers un réseau inexistant ou restreint.',
      ...
      'You can not attach an interface to a device which you do not have permission to edit.' => 'Vous ne pouvez pas attacher une interface à un service que vous n’avez pas le droit de modifier.',
      ...
      'Transaction value when deleting Almanac properties must be a list of property names.' => 'La valeur de la transaction lors d\'une supression de propriétés Almanac doit être une liste de noms de propriétés.',
