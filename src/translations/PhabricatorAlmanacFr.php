...
final class PhabricatorAlmanacFr
  ...
  protected function getTranslations() {
    return array(
      ...
      'Almanac service, device, property and namespace names must begin and end with a letter or number.' => 'Les noms du service d’almanach, de l’appareil, de la propriété et de l’espace de nom doivent commencer et se terminer par une lettre ou un nombre.',
      ...
      'Unable to load interface!' => 'Impossible de charger l’interface !',
      ...
      'Almanac service, device, property and namespace names may only contain lowercase letters, numbers, hyphens, and periods.' => 'Les noms du service d’almanach, de l’appareil, de la propriété et de l’espace de noms ne peuvent contenir que des lettres minuscules, des nombres, des tirets et des points.',
      ...
      'Almanac service, device, property and namespace names may not be more than 100 characters long.' => 'Les noms du service d’almanach, de l’appareil, de la propriété et de l’espace de noms ne peuvent pas dépasser 100 caractères.',
      ...
      'Service name is required.' => 'Le nom de service est obligatoire.',
      ...
      'Almanac service, device, property and namespace names may not have any segments containing only digits.' => 'Les noms du service d’almanach, de l’appareil, de la propriété et de l’espace de noms ne doivent pas avoir de segment contenant seulement des chiffres.',
      ...
      'Almanac service, device, property and namespace names must be at least 3 characters long.' => 'Les noms du service d’almanach, de l’appareil, de la propriété et de l’espace de noms doivent faire au moins 3 caractères.',
      ...
      'You can not edit an interface which belongs to a nonexistent or restricted network.' => 'Vous ne pouvez pas modifier une interface qui appartient à un réseau inexistant ou restreint.',
      ...
      'Precomputed interface PHIDs must be of type AlmanacInterfacePHIDType.' => 'Les PHID d’interface précalculés doivent être de type AlmanacInterfacePHIDType.',
      ...
      'You can not delete an interface which is still in use.' => 'Vous ne pouvez pas supprimer une interface qui est encore utilisée.',
      ...
      '%s removed the interface %s from this device.' => '%s a supprimé l’interface %s de cet appareil.',
      'Service Types' => 'Types de service',
      'Almanac Bindings' => 'Liaison d’almanach',
      'User aborted workflow.' => 'L’utilisateur a annulé le processus de travail.',
      ...
      '%s changed interface %s on this device to %s.' => '%s a modifié l’interface %s sur cet appareil en %s.',
      ...
      '%s locked this service.' => '%s a verrouillé ce service.',
      ...
      'IMPORTANT!' => 'IMPORTANT !',
      'Almanac service, device, property and namespace names may not contain multiple consecutive hyphens.' => 'Les noms du service d’almanach, de l’appareil, de la propriété et de l’espace de noms ne peuvent pas contenir plusieurs tirets consécutifs.',
      'You can not add an interface on a nonexistent or restricted network.' => 'Vous ne pouvez pas ajouter une interface sur un réseau inexistant ou restreint.',
      '%s created this device.' => '%s a créé cet appareil.',
      'Almanac User Guide' => 'Guide utilisateur de l’almanach',
      'Almanac service, device, property and namespace names may not contain hyphens adjacent to periods.' => 'Les noms du service d’almanach, de l’appareil, de la propriété et de l’espace de noms ne doivent pas contenir de tiret adjacent à un point.',
      ...
      '%s added the interface %s to this device.' => '%s a ajouté l’interface %s à cet appareil.',
      ...
      'You can not edit an invalid or restricted interface.' => 'Vous ne pouvez pas modifier une interface non valide ou restreinte.',
      ...
      'Almanac service, device, property and namespace names may not contain multiple consecutive periods.' => 'Les noms du service d’almanach, de l’appareil, de la propriété et de l’espace de noms ne doivent pas contenir plusieurs points consécutifs.',
      'All Services' => 'Tous les services',
      '%s changed this binding from %s to %s.' => '%s a modifié cette liaison de %s en %s.',
      ...
      'Interfaces must have a port.' => 'Les interfaces doivent avoir un port.',
      ...
      '%s unlocked this service.' => '%s a déverrouillé ce service.',
      ...
      '%s deleted the property "%s".' => '%s a supprimé la propriété « %s ».',
