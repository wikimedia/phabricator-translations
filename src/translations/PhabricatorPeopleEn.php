...
final class PhabricatorPeopleEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'This workflow will send this user ("%s") a copy of the "Welcome to %s" email that users normally receive when their accounts are created by an administrator.' => 'This workflow will send this user ("%s") a copy of the "Welcome to %s" email that users normally receive when their accounts are created by an administrator.',
      ...
      'User account "%s" is already approved. You can only approve accounts that are not yet approved.' => 'User account "%s" is already approved. You can only approve accounts that are not yet approved.',
    ...
    ',
      ...
      '[%s] Account Login Link' => '[%s] Account Login Link',
    ...
    ',
      ...
      '[%s] Username Changed' => '[%s] Username Changed',
      'Create Mailing List User' => 'Create Mailing List User',
      '[%s] Primary Address Changed' => '[%s] Primary Address Changed',
    ...
    %s',
      ...
      'After you have set a password, you can log in again in the future by going here:' => 'After you have set a password, you can log in again in the future by going here:',
      ...
      'Send "Welcome to %s" email with login instructions.' => 'Send "Welcome to %s" email with login instructions.',
    ...
    However, if you save a query using this function and send it to someone else, it will work like //their// username was the one that was typed. This can be useful for building dashboard panels that always show relevant information to the user who is looking at them.',
      ...
      'Enable %s? They will be able to access this server and receive email again.' => 'Enable %s? They will be able to access this server and receive email again.',
    ...
    ',
      ...
      'Disable User' => 'Disable User',
      'To log in, follow this link and set a password:' => 'To log in, follow this link and set a password:',
      'Remove %s as an administrator? They will no longer be able to perform administrative functions on this server.' => 'Remove %s as an administrator? They will no longer be able to perform administrative functions on this server.',
      ...
      'Approved user account "%s".' => 'Approved user account "%s".',
      ...
      'message' => 'message',
      'This email address (%s) is no longer your primary email address. Going forward, all email will be sent to your new primary email address (%s).' => 'This email address (%s) is no longer your primary email address. Going forward, all email will be sent to your new primary email address (%s).',
      ...
      'Executive' => 'Executive',
      '%s removed the administrator role from this user.' => '%s removed the administrator role from this user.',
      ...
      'This is now your primary email address (%s). Going forward, all email will be sent here.' => 'This is now your primary email address (%s). Going forward, all email will be sent here.',
    ...
    ',
      ...
      'Your %s account (%s) has been approved by %s. You can login here:' => 'Your %s account (%s) has been approved by %s. You can login here:',
      ...
      'To invite users, enter their email addresses below. Separate addresses with commas or newlines.' => 'To invite users, enter their email addresses below. Separate addresses with commas or newlines.',
    ...
    %s',
      ...
      '%s removed the administrator role from %s.' => '%s removed the administrator role from %s.',
      ...
      'Allow %s to access this server?' => 'Allow %s to access this server?',
      ...
      'Create a standard user account. These users can log in, use the web interface and API, and receive email.' => 'Create a standard user account. These users can log in, use the web interface and API, and receive email.',
    ...
    documentation.' => 'List of custom fields for user profiles.
    For details on adding new fields, see [[ %s | %s ]] in the
    documentation.',
      ...
      'Logout' => 'Logout',
      'After you set up your account, you can log in again in the future by going here:' => 'After you set up your account, you can log in again in the future by going here:',
    ...
    %s',
      ...
      'Disable %s? They will no longer be able to access this server or receive email.' => 'Disable %s? They will no longer be able to access this server or receive email.',
      'Invites' => 'Invites',
      ...
      '%s (%s) has changed your %s username.' => '%s (%s) has changed your %s username.',
