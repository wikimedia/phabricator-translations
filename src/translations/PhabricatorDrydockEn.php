...
final class PhabricatorDrydockEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Failed to reload lease.' => 'Failed to reload lease.',
      ...
      'Trying to activate lease on a dead resource (in status "%s").' => 'Trying to activate lease on a dead resource (in status "%s").',
      ...
      'You must choose a name for this blueprint.' => 'You must choose a name for this blueprint.',
      ...
      'Activated lease "%s".' => 'Activated lease "%s".',
      'Release Lease' => 'Release Lease',
