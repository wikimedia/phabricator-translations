...
final class PhabricatorDifferentialEn
  ...
  protected function getTranslations() {
    ...
    ',
      ...
      'This diff is very large and affects %s files. You may load each file individually or ' => 'This diff is very large and affects %s files. You may load each file individually or ',
      ...
      'Load File' => 'Load File',
      'You can not commandeer a draft revision.' => 'You can not commandeer a draft revision.',
      ...
      'Very Large Diff' => 'Very Large Diff',
      'Conflicts' => 'Conflicts',
      ...
      '%s edited dependencie(s), added %s: %s; removed %s: %s.' => '%s edited dependencie(s), added %s: %s; removed %s: %s.',
      'Unsaved' => 'Unsaved',
      ...
      '%s edited dependent revision(s) for %s, added %s: %s; removed %s: %s.' => '%s edited dependent revision(s) for %s, added %s: %s; removed %s: %s.',
      'Mail Body' => 'Mail Body',
      ...
      'The raw diff you have submitted is too large to parse (it affects more than %s paths and hunks). Differential should only be used for changes which are small enough to receive detailed human review. See "Differential User Guide: Large Changes" in the documentation for more information.' => 'The raw diff you have submitted is too large to parse (it affects more than %s paths and hunks). Differential should only be used for changes which are small enough to receive detailed human review. See "Differential User Guide: Large Changes" in the documentation for more information.',
      ...
      '%s added %s dependencie(s): %s.' => '%s added %s dependencie(s): %s.',
      ...
      'Specify a hunk storage engine with --to.' => 'Specify a hunk storage engine with --to.',
      ...
      'Diff is already attached to another revision. You lost a race?' => 'Diff is already attached to another revision. You lost a race?',
      ...
      '%s edited dependent revision(s), added %s: %s; removed %s: %s.' => '%s edited dependent revision(s), added %s: %s; removed %s: %s.',
      '%s-%s' => '%s-%s',
      ...
      'Integrity check failed: new file data differs fom old data!' => 'Integrity check failed: new file data differs fom old data!',
    ...
    Revision rules can send email, flag revisions, add reviewers, and run build plans.',
      ...
      'Reviewers' => 'Reviewers',
      'Specify a hunk to migrate with --id.' => 'Specify a hunk to migrate with --id.',
    ...
    This sort of workflow is very unusual. Very few installs should need to change this option.',
      ...
      '%s added %s dependencie(s) for %s: %s.' => '%s added %s dependencie(s) for %s: %s.',
    ...
    NOTE: This feature is under active development and subject to change.',
      ...
      'Convereted hunk to file storage.' => 'Convereted hunk to file storage.',
      ...
      '%s added %s dependent revision(s) for %s: %s.' => '%s added %s dependent revision(s) for %s: %s.',
    ...
    Reason: %s',
      ...
      '%s removed %s dependent revision(s) for %s: %s.' => '%s removed %s dependent revision(s) for %s: %s.',
    ...
    These rules can reject diffs before they are written to permanent storage, to prevent users from accidentally uploading private keys or other sensitive information.',
      ...
      '%s removed %s dependencie(s) for %s: %s.' => '%s removed %s dependencie(s) for %s: %s.',
      ...
      'Convereted hunk to text storage.' => 'Convereted hunk to text storage.',
      ...
      '%s removed %s dependencie(s): %s.' => '%s removed %s dependencie(s): %s.',
    ...
    If you want updates to always require re-review, you can disable the "stickiness" of the "Accepted" status with this option. This may make the process for minor changes much more burdensome to both authors and reviewers.',
      ...
      'You can not resign from a draft revision.' => 'You can not resign from a draft revision.',
      ...
      '%s edited dependencie(s) for %s, added %s: %s; removed %s: %s.' => '%s edited dependencie(s) for %s, added %s: %s; removed %s: %s.',
      ...
      'You can not update this revision to the specified diff, because the diff is already attached to another revision.' => 'You can not update this revision to the specified diff, because the diff is already attached to another revision.',
    ...
    ',
      ...
      '%s added %s dependent revision(s): %s.' => '%s added %s dependent revision(s): %s.',
      ...
      '%s removed %s dependent revision(s): %s.' => '%s removed %s dependent revision(s): %s.',
