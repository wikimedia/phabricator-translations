...
final class PhabricatorConfigEnGB
  ...
  protected function getTranslations() {
    return array(
      ...
      'Configure the UI, including colors.' => 'Configure the Phabricator UI, including colours.',
    ...
    ' => 'Customise the logo image and text which appears in the main site header:
      ...
      'Customized settings for applications.' => 'Customised settings for Phabricator applications.',
      'Sets the default color scheme.' => 'Sets the default colour scheme of Phabricator.',
