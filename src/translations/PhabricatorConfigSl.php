...
Za namestitev orodja Pygments obiščite stran [[ https://pygments.org/ | pygments.org ]] in se ravnajte po navodilih za prenos in namestitev.
...
Ta možnost določa seznam omrežnih blokiranj, s katerimi bo Phabricator zavrnil povezavo. Na splošno bi morali tukaj navesti ves zasebni IP-prostor.',
  ...
  '%d related link(s):' => '%d povezana(ih) povezav(a):',
