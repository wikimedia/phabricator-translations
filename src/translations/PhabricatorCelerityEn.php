...
final class PhabricatorCelerityEn
  ...
  protected function getTranslations() {
    return array(
      ...
      'Done generating sprites - updating map...' => 'Done generating sprites - updating map...',
      ...
      'Do not invoke `%s` after updating sprites' => 'Do not invoke `%s` after updating sprites',
      ...
      '`%s` not found in PATH.' => '`%s` not found in PATH.',
      ...
      'Sprites will not be optimized! Install `%s`!' => 'Sprites will not be optimized! Install `%s`!',
      ...
      'Force regeneration even no sources have changed.' => 'Force regeneration even no sources have changed.',
