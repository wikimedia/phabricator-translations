...
final class PhabricatorOauthserverCa
  ...
  protected function getTranslations() {
    return array(
      ...
      'This application will no longer be able to access Phabricator on your behalf.' => 'Aquesta aplicació ja no serà capaç d\'accedir Phabricator en el seu nom.',
      ...
      'Validation of redirect URI \'%s\'' => 'Validació de l\'URI de redirecció "%s"',
      ...
      'Validation of secondary redirect URI \'%s\' relative to \'%s\'' => 'Validació de l\'URI de redirecció secundari "%s" en relació amb "%s"',
      ...
      'Log In with Phabricator' => 'Iniciar sessió amb Phabricator',
      ...
      'Validation (https): %s' => 'Validació (https): %s',
      'Authorize Application?' => 'Autoritzar l\'aplicació?',
      ...
      'This application ("%s") is authorized to use your Phabricator credentials. Continue to complete the authentication workflow.' => 'Aquesta aplicació (\'%s\') està autoritzada per utilitzar les vostres credencials de Phabricator. Continueu completant el flux de treball d\'autenticació.',
      ...
      'Validation of redirect URI \'%s\' relative to \'%s\'' => 'Validació de l\'URI de redirecció "%s" en relació amb "%s"',
      ...
      'Validation (params): %s' => 'Validació (paràmetres): %s',
      'Do you want to authorize the external application "%s" to access your Phabricator account data, including your primary email address?' => 'Voleu autoritzar l\'aplicació externa "%s" per accedir a les dades del vostre compte de Phabricator, inclosa la vostra adreça electrònica principal?',
      'Alas!' => 'Ai!',
