...
final class PhabricatorOauthserverCa
  ...
  'Using the %s OAuth Server' => 'Utilitzar el servidor OAuth de Phabricator',
  ...
  'Client with %s %s not found.' => 'No s\'ha trobat el client amb %2$s %s.',
