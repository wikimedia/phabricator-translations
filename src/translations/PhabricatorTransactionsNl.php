...
final class PhabricatorTransactionsNl
  ...
  '%s changed the edit policy to "%s".' => '%s heeft het bewerkingsbeleid gewijzigd naar "%s".',
  ...
  'Welcome to Wikimedia Phabricator. Please do not add comments that you claim or work on this: %s. Please do not add comments that you submitted a patch in Gerrit but follow the %s to create an automatic notification here about your patch instead. If you apply for an %s, read the participant instructions and ask general questions in our Zulip chat first. Thank you!' => 'Welkom bij Wikimedia Phabricator. Voeg geen opmerkingen toe dat u dit claimt of eraan werkt: %s. Voeg ook geen opmerkingen toe dat u een patch hebt ingediend in Gerrit, maar volg de %s op om hier automatisch een melding over uw patch achter te laten. Als u een %s aanvraagt, lees dan eerst de instructies voor deelnemers en stel algemene vragen in onze Zulip-chat. Alvast bedankt!',
  ...
  'Outreach Program' => 'Outreach-programma',
...
Dit formulier ondersteunt deze velden:',
  ...
  'Commit Message Guidelines' => 'Richtlijnen voor commitberichten',
  ...
  '%s changed the visibility to "%s".' => '%s heeft de zichtbaarheid gewijzigd in "%s".',
...
Bij gebruik van `template` worden deze velden gekopieerd:',
  ...
  'Find out what to do instead' => 'Zoek uit wat u wel kunt doen',
