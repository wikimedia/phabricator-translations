...
final class PhabricatorTransactionsPtBR
  ...
  protected function getTranslations() {
    return array(
      ...
      'Mentioned or subscribed users will not be notified.' => 'Usuários mencionados ou assinantes não serão notificados.',
      ...
      '%s removed %d subscriber(s): %s.' => '%s removido de %s inscritos: %s.',
      ...
      '%s added %d subscriber(s): %s.' => '%s adicionaram %s inscrito(s): %s.',
      'This is a draft revision that will not publish any notifications until the author requests review.' => 'Esta é uma revisão de rascunho que não publicará nenhuma notificação até que o autor solicite a revisão.',
      ...
      'Warning: Unexpected Effects' => 'Aviso: efeitos inesperados',
      ...
      '%s changed the default value for field "%s".' => '%s mudou o valor padrão do campo "%s".',
      '%s changed the subtype of this form from "%s" to "%s".' => '%s mudou o subtipo deste formulário de "%s" para "%s".',
