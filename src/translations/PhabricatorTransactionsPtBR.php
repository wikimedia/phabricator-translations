...
final class PhabricatorTransactionsPtBR
  ...
  '%s updated the preamble for this form.' => '%s atualizou o preâmbulo desse formulário.',
  '%s changed the default value for field %s.' => '%s alterou o valor padrão do campo %s.',
  ...
  '%s removed %d subscriber(s): %s.' => '%s removeu %d inscritos: %s.',
  ...
  'No Manage Permission' => 'Sem permissão de gerenciamento',
  ...
  'You do not have permission to configure forms for this application.' => 'Você não tem permissão para configurar formulários para este aplicativo.',
  'User Guide: Customizing Forms' => 'Guia do Usuário: personalização de formulários',
  'Duplicate Form' => 'Duplicar formulário',
  '%s added %d subscriber(s): %s.' => '%s adicionou %d inscrito(s): %s.',
  ...
  '%s created this object.' => '%s criou esse objeto.',
  ...
  '%s edited subscriber(s), added %d: %s; removed %d: %s.' => '%s inscrito(s) editado(s), adicionado %d: %s; removido %d: %s.',
